package com.X.recosinjector.util

import com.X.frigate.common.base.TweetUtil
import com.X.gizmoduck.thriftscala.User
import com.X.recos.util.Action.Action
...
case class TweetDetails(tweet: Tweet) {
  ...
  // Details: https://groups.google.com/a/X.com/d/msg/eng/BhK1XAcSSWE/F8Gc4_5uDwAJ
