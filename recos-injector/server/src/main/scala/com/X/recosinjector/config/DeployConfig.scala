...
import com.X.frigate.common.util.Finagle._
import com.X.frigate.common.util.{UrlInfo, UrlInfoInjection, UrlResolver}
import com.X.gizmoduck.thriftscala.{LookupContext, QueryFields, User, UserService}
import com.X.hermit.store.common.{ObservedCachedReadableStore, ObservedMemcachedReadableStore}
import com.X.hermit.store.gizmoduck.GizmoduckUserStore
import com.X.hermit.store.tweetypie.TweetyPieStore
import com.X.logging.Logger
import com.X.pink_floyd.thriftscala.{ClientIdentifier, Storer}
import com.X.socialgraph.thriftscala.{IdsRequest, SocialGraphService}
...
import com.X.storage.client.manhattan.kv.{
  ManhattanKVClient,
  ManhattanKVClientMtlsParams,
  ManhattanKVEndpointBuilder
}
import com.X.storehaus.ReadableStore
import com.X.tweetypie.thriftscala.{GetTweetOptions, TweetService}
...
trait DeployConfig extends Config with CacheConfig {
   ...
   * More info is here:
   * https://cgit.X.biz/source/tree/src/thrift/com/X/spam/rtf/safety_level.thrift
   */
