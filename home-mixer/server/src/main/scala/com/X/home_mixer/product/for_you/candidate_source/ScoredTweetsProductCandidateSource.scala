package com.X.home_mixer.product.for_you.candidate_source
...
import com.X.product_mixer.core.functional_component.candidate_source.product_pipeline.ProductPipelineCandidateSource
...
import com.X.timelines.render.{thriftscala => tl}
