package com.X.home_mixer.util.earlybird

import com.X.conversions.DurationOps._
import com.X.search.common.query.thriftjava.{thriftscala => scq}
import com.X.search.common.ranking.{thriftscala => scr}
import com.X.search.earlybird.{thriftscala => eb}
import com.X.timelines.clients.relevance_search.SearchClient.TweetFeatures
import com.X.timelines.clients.relevance_search.SearchClient.TweetTypes
import com.X.timelines.clients.relevance_search.SearchQueryBuilder
import com.X.timelines.clients.relevance_search.SearchQueryBuilder.QueryWithNamedDisjunctions
