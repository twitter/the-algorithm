...
import com.X.mediaservices.commons.tweetmedia.{thriftscala => mt}
...
import com.X.timelines.conversation_features.{thriftscala => cvt}
import com.X.timelinescorer.common.scoredtweetcandidate.{thriftscala => stc}
