...
import com.X.timelinemixer.injection.repository.uss.VersionedAggregateFeaturesDecoder
import com.X.ml.api.DataRecord
import com.X.timelines.aggregate_interactions.thriftjava.UserAggregateInteractions
import com.X.timelines.aggregate_interactions.v17.thriftjava.{
  UserAggregateInteractions => V17UserAggregateInteractions
}
import com.X.timelines.aggregate_interactions.v1.thriftjava.{
  UserAggregateInteractions => V1UserAggregateInteractions
}
import com.X.timelines.suggests.common.dense_data_record.thriftjava.DenseCompactDataRecord
...
private[offline_aggregates] case class AggregateFeaturesToDecodeWithMetadata(
  ...
  def userXListAggregates = extract(_.user_list_aggregates)
