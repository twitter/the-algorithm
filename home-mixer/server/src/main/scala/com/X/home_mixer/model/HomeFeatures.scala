...
import com.X.product_mixer.core.feature.datarecord.BoolDataRecordCompatible
import com.X.product_mixer.core.feature.datarecord.DataRecordFeature
...
import com.X.product_mixer.core.feature.datarecord.LongDiscreteDataRecordCompatible
import com.X.product_mixer.core.model.marshalling.response.urt.metadata.TopicContextFunctionalityType
import com.X.product_mixer.core.pipeline.PipelineQuery
import com.X.search.common.features.{thriftscala => sc}
...
import com.X.timelinemixer.injection.model.candidate.AudioSpaceMetaData
import com.X.timelines.conversation_features.v1.thriftscala.ConversationFeatures
import com.X.timelines.impression.{thriftscala => imp}
...
object HomeFeatures {
  ...
  object XListIdFeature extends Feature[TweetCandidate, Option[Long]]
