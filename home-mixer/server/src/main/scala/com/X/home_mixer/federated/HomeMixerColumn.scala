package com.X.home_mixer.federated

import com.X.gizmoduck.{thriftscala => gd}
...
import com.X.home_mixer.{thriftscala => hm}
...
import com.X.product_mixer.core.{thriftscala => pm}
...
import com.X.strato.data._
import com.X.strato.fed.StratoFed
import com.X.strato.generated.client.auth_context.AuditIpClientColumn
import com.X.strato.generated.client.gizmoduck.CompositeOnUserClientColumn
import com.X.strato.graphql.timelines.{thriftscala => gql}
import com.X.strato.thrift.ScroogeConv
import com.X.timelines.render.{thriftscala => tr}
    ...
    val populateUserRolesAndIp: Arrow[(Key, View), (Option[Set[String]], Option[String])] = {
      ...
      val populateUserRoles = Arrow
        .flatMap[(Key, View), Option[Set[String]]] { _ =>
          Stitch.collect {
            CallContext.XUserId.map { userId =>
