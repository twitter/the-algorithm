...
import com.X.home_mixer.product.scored_tweets.feature_hydrator.RealGraphViewerAuthorFeatureHydrator.getCombinedRealGraphFeatures
...
import com.X.timelines.prediction.adapters.real_graph.RealGraphEdgeFeaturesCombineAdapter
import com.X.timelines.prediction.adapters.real_graph.RealGraphFeaturesAdapter
import com.X.timelines.real_graph.v1.{thriftscala => v1}
