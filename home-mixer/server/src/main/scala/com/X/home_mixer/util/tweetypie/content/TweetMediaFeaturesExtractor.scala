...
import com.X.mediaservices.commons.mediainformation.{thriftscala => mi}
import com.X.mediaservices.commons.tweetmedia.{thriftscala => tm}
import com.X.mediaservices.commons.{thriftscala => ms}
