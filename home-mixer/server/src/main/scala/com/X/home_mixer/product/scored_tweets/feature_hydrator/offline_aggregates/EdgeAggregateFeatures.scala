...
import com.X.home_mixer.product.scored_tweets.feature_hydrator.adapters.offline_aggregates.PassThroughAdapter
import com.X.home_mixer.product.scored_tweets.feature_hydrator.adapters.offline_aggregates.SparseAggregatesToDenseAdapter
...
import com.X.home_mixer.product.scored_tweets.feature_hydrator.TSPInferredTopicFeature
...
import com.X.timelines.prediction.common.aggregates.TimelinesAggregationConfig.CombineCountPolicies
  ...
  object UserAuthorAggregateFeature
      extends BaseEdgeAggregateFeature(
        aggregateGroups = TimelinesAggregationConfig.userAuthorAggregatesV2 ++ Set(
          ...
          TimelinesAggregationConfig.XWideUserAuthorAggregates
        ),
