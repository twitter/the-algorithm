...
import com.X.home_mixer.param.HomeMixerInjectionNames.TopicEngagementCache
import com.X.home_mixer.param.HomeMixerInjectionNames.TweetCountryEngagementCache
import com.X.home_mixer.param.HomeMixerInjectionNames.TweetEngagementCache
...
import com.X.home_mixer.param.HomeMixerInjectionNames.UserEngagementCache
import com.X.home_mixer.param.HomeMixerInjectionNames.UserTopicEngagementForNewUserCache
import com.X.home_mixer.util.InjectionTransformerImplicits._
import com.X.inject.XModule
import com.X.ml.api.DataRecord
import com.X.ml.api.Feature
import com.X.ml.{api => ml}
import com.X.servo.cache.KeyValueTransformingReadCache
import com.X.servo.cache.Memcache
import com.X.servo.cache.ReadCache
import com.X.servo.util.Transformer
import com.X.storehaus_internal.memcache.MemcacheHelper
...
object RealtimeAggregateFeatureRepositoryModule
  ...
  @Provides
  @Singleton
  @Named(XListEngagementCache)
  def providesXListEngagementCache(
    @Named(TimelinesRealTimeAggregateClient) client: Memcache
