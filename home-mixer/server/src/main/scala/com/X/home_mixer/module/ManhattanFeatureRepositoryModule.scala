...
import com.X.bijection.thrift.ThriftCodec
import com.X.conversions.DurationOps._
import com.X.finagle.mtls.authentication.ServiceIdentifier
import com.X.home_mixer.param.HomeMixerInjectionNames._
import com.X.home_mixer.util.InjectionTransformerImplicits._
import com.X.home_mixer.util.LanguageUtil
import com.X.home_mixer.util.TensorFlowUtil
import com.X.inject.XModule
import com.X.manhattan.v1.{thriftscala => mh}
import com.X.ml.api.{thriftscala => ml}
import com.X.ml.featurestore.lib.UserId
import com.X.ml.featurestore.{thriftscala => fs}
import com.X.onboarding.relevance.features.{thriftjava => rf}
import com.X.product_mixer.shared_library.manhattan_client.ManhattanClientBuilder
...
import com.X.service.metastore.gen.{thriftscala => smg}
import com.X.servo.cache._
import com.X.servo.manhattan.ManhattanKeyValueRepository
...
import com.X.timelines.suggests.common.dense_data_record.{thriftscala => ddr}
import com.X.user_session_store.{thriftscala => uss_scala}
import com.X.user_session_store.{thriftjava => uss}
...
object ManhattanFeatureRepositoryModule extends XModule {
