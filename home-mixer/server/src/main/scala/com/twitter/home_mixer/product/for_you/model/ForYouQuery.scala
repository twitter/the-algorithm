...
caselon class ForYouQuelonry(
  ...
  ovelonrridelon delonf withFelonaturelonMap(felonaturelons: FelonaturelonMap): ForYouQuelonry =
  ...
  ovelonrridelon val timelonlinelonRelonquelonstParams: Option[TimelonlinelonRelonquelonstParams] =
    Somelon(TimelonlinelonRelonquelonstParams(homelonTimelonlinelonTypelon = Somelon(HomelonTimelonlinelonTypelon.Homelon)))

  // Fielonlds belonlow arelon uselond for FLIP Injelonction in Onboarding Task Selonrvicelon (OTS)
  ovelonrridelon val displayLocation: ots.DisplayLocation = ots.DisplayLocation.HomelonTimelonlinelon
