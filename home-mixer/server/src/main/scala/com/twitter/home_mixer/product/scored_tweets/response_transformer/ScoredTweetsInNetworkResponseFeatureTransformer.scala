...
objelonct ScorelondTwelonelontsInNelontworkRelonsponselonFelonaturelonTransformelonr
  ...
  ovelonrridelon val idelonntifielonr: TransformelonrIdelonntifielonr =
    TransformelonrIdelonntifielonr("ScorelondTwelonelontsInNelontworkRelonsponselon")
  ...
  ovelonrridelon delonf transform(candidatelon: tlr.CandidatelonTwelonelont): FelonaturelonMap = {
    ...
    val felonaturelons = FelonaturelonMapBuildelonr()
      .add(CandidatelonSourcelonIdFelonaturelon, Somelon(cts.CandidatelonTwelonelontSourcelonId.ReloncyclelondTwelonelont))
      .add(FromInNelontworkSourcelonFelonaturelon, truelon)
      .add(SuggelonstTypelonFelonaturelon, Somelon(st.SuggelonstTypelon.ReloncyclelondTwelonelontInlinelon))
      .build()
