...
@Singlelonton
class ForYouTimelonlinelonScorelonrMixelonrPipelonlinelonConfig @Injelonct() (
  ...
  manhattanTwelonelontImprelonssionsQuelonryFelonaturelonHydrator: TwelonelontImprelonssionsQuelonryFelonaturelonHydrator[ForYouQuelonry],
  ...
  updatelonLastNonPollingTimelonSidelonelonffelonct: UpdatelonLastNonPollingTimelonSidelonelonffelonct[ForYouQuelonry, Timelonlinelon],
  ...
  ovelonrridelon val idelonntifielonr: MixelonrPipelonlinelonIdelonntifielonr = MixelonrPipelonlinelonIdelonntifielonr("ForYouTimelonlinelonScorelonr")
  ...
  ovelonrridelon delonf felontchQuelonryFelonaturelons: Selonq[QuelonryFelonaturelonHydrator[ForYouQuelonry]] = Selonq(
    ...
    AsyncQuelonryFelonaturelonHydrator(relonsultSelonlelonctorsStelonp, manhattanTwelonelontImprelonssionsQuelonryFelonaturelonHydrator),
    AsyncQuelonryFelonaturelonHydrator(relonsultSelonlelonctorsStelonp, melonmcachelonTwelonelontImprelonssionsQuelonryFelonaturelonHydrator)
  )
  ...
  ovelonrridelon val candidatelonPipelonlinelons: Selonq[CandidatelonPipelonlinelonConfig[ForYouQuelonry, _, _, _]] = Selonq(
    forYouTimelonlinelonScorelonrCandidatelonPipelonlinelonConfig,
  ...
  ovelonrridelon val failOpelonnPolicielons: Map[CandidatelonPipelonlinelonIdelonntifielonr, FailOpelonnPolicy] = Map(
    forYouTimelonlinelonScorelonrCandidatelonPipelonlinelonConfig.idelonntifielonr -> FailOpelonnPolicy.Always,
  ...
  ovelonrridelon val relonsultSelonlelonctors: Selonq[Selonlelonctor[ForYouQuelonry]] = Selonq(
    ...
    UpdatelonSortCandidatelons(
      ...
      candidatelonPipelonlinelon = forYouTimelonlinelonScorelonrCandidatelonPipelonlinelonConfig.idelonntifielonr
    ),
    ...
    DelonbunchCandidatelons(
      pipelonlinelonScopelon = SpeloncificPipelonlinelon(forYouTimelonlinelonScorelonrCandidatelonPipelonlinelonConfig.idelonntifielonr),
      mustDelonbunch = {
    ...
    // Add Convelonrsation Selonrvicelon twelonelonts to relonsults only if thelon scorelond pipelonlinelon doelonsn't relonturn any
    SelonlelonctConditionally(
      selonlelonctor = InselonrtAppelonndRelonsults(
        candidatelonPipelonlinelon = forYouConvelonrsationSelonrvicelonCandidatelonPipelonlinelonConfig.idelonntifielonr),
      includelonSelonlelonctor = (_, candidatelons, _) =>
        !candidatelons.elonxists(candidatelon =>
          forYouTimelonlinelonScorelonrCandidatelonPipelonlinelonConfig.idelonntifielonr == candidatelon.sourcelon)
    ),
    InselonrtAppelonndRelonsults(candidatelonPipelonlinelon = forYouTimelonlinelonScorelonrCandidatelonPipelonlinelonConfig.idelonntifielonr),
  ...
  privatelon val selonrvelondCandidatelonKelonysKafkaSidelonelonffelonct =
    selonrvelondCandidatelonKelonysKafkaSidelonelonffelonctBuildelonr.build(
      Selont(forYouTimelonlinelonScorelonrCandidatelonPipelonlinelonConfig.idelonntifielonr))
      ...
      scribelonConfigBuildelonr = Somelon(
        StaticTimelonlinelonScribelonConfigBuildelonr(
          TimelonlinelonScribelonConfig(
            pagelon = Somelon("for_you_timelonlinelon_scorelonr"),
            selonction = Nonelon,
