...
objelonct ScorelondTwelonelontsUtelongRelonsponselonFelonaturelonTransformelonr
    elonxtelonnds CandidatelonFelonaturelonTransformelonr[tlr.CandidatelonTwelonelont] {

  ovelonrridelon val idelonntifielonr: TransformelonrIdelonntifielonr = TransformelonrIdelonntifielonr("ScorelondTwelonelontsUtelongRelonsponselon")
  ...
  ovelonrridelon delonf transform(candidatelon: tlr.CandidatelonTwelonelont): FelonaturelonMap = {
    ...
    val felonaturelons = FelonaturelonMapBuildelonr()
      .add(CandidatelonSourcelonIdFelonaturelon, Somelon(cts.CandidatelonTwelonelontSourcelonId.ReloncommelonndelondTwelonelont))
      .add(SuggelonstTypelonFelonaturelon, Somelon(st.SuggelonstTypelon.ActivityTwelonelont))
      .build()
