...
import com.X.unified_user_actions.adapter.retweet_archival_events.RetweetArchivalEventsAdapter
...
object KafkaProcessorRetweetArchivalEventsModule extends XModule with Logging {
