...
import com.X.unified_user_actions.adapter.favorite_archival_events.FavoriteArchivalEventsAdapter
...
object KafkaProcessorFavoriteArchivalEventsModule extends XModule with Logging {
