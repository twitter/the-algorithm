...
enum SourceLineage {
  ...
  /**
  * Gizmoduck's User Modification events https://docbird.X.biz/gizmoduck/user_modifications.html
  **/
...
/*
 * ClientEvent's namespaces. See https://docbird.X.biz/client_events/client-event-namespaces.html
 *
...
struct EventMetadata {
   ...
   *
   *  - ClientEvents && BehavioralClientEvents: Client UI language or from Gizmoduck which is what user set in X App.
   *      Please see more at https://sourcegraph.X.biz/git.X.biz/source/-/blob/finatra-internal/international/src/main/scala/com/X/finatra/international/LanguageIdentifier.scala
   ...
   *      see https://sourcegraph.X.biz/git.X.biz/source/-/blob/finatra-internal/international/src/main/scala/com/X/finatra/international/CountryIdentifier.scala
   *      The format should be ISO_3166-1_alpha-2.
   *  - ServerTlsFavs: From the request (user’s current location),
   *      see https://sourcegraph.X.biz/git.X.biz/source/-/blob/src/thrift/com/X/context/viewer.thrift?L54
   *      The format should be ISO_3166-1_alpha-2.
   *  - ServerTweetypieEvents:
   *      UUA sets this to be consistent with IESource to meet existing use requirement.
   *      see https://sourcegraph.X.biz/git.X.biz/source/-/blob/src/thrift/com/X/tweetypie/tweet.thrift?L1001.
