...
include "com/X/unified_user_actions/metadata.thrift"
include "com/X/search/common/constants/query.thrift"
include "com/X/search/common/constants/result.thrift"
...
struct SearchResultsPageInfo {
  ...
  // see http://go/sgb/src/thrift/com/X/search/common/constants/query.thrift for details
  ...
  // see http://go/sgb/src/thrift/com/X/search/common/constants/result.thrift for details
