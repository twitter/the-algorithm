...
include "com/X/clientapp/gen/client_app.thrift"
include "com/X/reportflow/report_flow_logs.thrift"
include "com/X/socialgraph/social_graph_service_write_log.thrift"
include "com/X/gizmoduck/user_service.thrift"
...
enum ActionType {
  ...
  // See https://confluence.X.biz/pages/viewpage.action?spaceKey=HEALTH&title=Understanding+ReportDetails
  ...
  /*
   * This is triggered when a user exits the X platform. The amount of the time spent on the
   ...
   *
   * For definitions, please refer to https://sourcegraph.X.biz/git.X.biz/source/-/blob/common-internal/analytics/client-event-util/src/main/java/com/X/common_internal/analytics/client_event_util/TweetImpressionUtils.java?L14&subtree=true
   */
  ...
  */
   ...
   * at least 1 second.
   *
   * See https://confluence.X.biz/display/REVENUE/dwell_short for more details.
   */
   ...
   * at least 2 seconds.
   *
   * See https://confluence.X.biz/display/REVENUE/dwell_medium for more details.
   */
   ...
   * at least 10 seconds.
   *
   * See https://confluence.X.biz/display/REVENUE/dwell_long for more details.
   */
   ...
   * in the Explore tab and “What’s Happening” module on X.com. For more information, check go/ads-takeover.
...
struct ClientTweetReport {
   ...
   * https://confluence.X.biz/pages/viewpage.action?spaceKey=HEALTH&title=Understanding+ReportDetails
   */
...
struct ServerTweetReport {
   ...
   * Reference: https://confluence.X.biz/pages/viewpage.action?spaceKey=HEALTH&title=Understanding+ReportDetails
   */
