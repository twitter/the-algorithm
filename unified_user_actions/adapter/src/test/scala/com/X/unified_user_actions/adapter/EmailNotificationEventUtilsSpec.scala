...
import com.X.unified_user_actions.adapter.email_notification_event.EmailNotificationEventUtils
...
class EmailNotificationEventUtilsSpec extends Test {
  ...
  test("Extract TweetId from pageUrl") {
    new EmailNotificationEventFixture {
      ...
      val invalidDomain = "https://X.app.link/addressbook/"
      val numericHandle =
        "https://X.com/1234/status/12345?cxt=HBwWgsDTgY3tp&cn=ZmxleGl&refsrc=email)"
