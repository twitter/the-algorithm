...
import com.X.clientapp.thriftscala._
import com.X.clientapp.thriftscala.SuggestionDetails
import com.X.guide.scribing.thriftscala._
import com.X.guide.scribing.thriftscala.{SemanticCoreInterest => SemanticCoreInterestV1}
import com.X.guide.scribing.thriftscala.{SimClusterInterest => SimClusterInterestV1}
import com.X.guide.scribing.thriftscala.TopicModuleMetadata.SemanticCoreInterest
import com.X.guide.scribing.thriftscala.TopicModuleMetadata.SimClusterInterest
import com.X.guide.scribing.thriftscala.TransparentGuideDetails.TopicMetadata
...
import com.X.util.mock.Mockito
...
class TopicsIdUtilsSpec
  ...
  import com.X.unified_user_actions.adapter.client_event.TopicIdUtils._
        ...
        GuideItemDetails(transparentGuideDetails = Some(
          TransparentGuideDetails.TopicMetadata(
            TopicModuleMetadata.SimClusterInterest(simClusterInterest =
              com.X.guide.scribing.thriftscala.SimClusterInterest.unsafeEmpty)))),
        None),
      (
        GuideItemDetails(transparentGuideDetails = Some(
        ...
        GuideItemDetails(transparentGuideDetails = Some(
          TransparentGuideDetails.TopicMetadata(
            TopicModuleMetadata.SemanticCoreInterest(
              com.X.guide.scribing.thriftscala.SemanticCoreInterest.unsafeEmpty
