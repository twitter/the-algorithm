...
import com.X.ads.cards.thriftscala.CardEvent
import com.X.ads.eventstream.thriftscala.EngagementEvent
import com.X.ads.spendserver.thriftscala.SpendServerEvent
import com.X.adserver.thriftscala.ImpressionDataNeededAtEngagementTime
import com.X.adserver.thriftscala.ClientInfo
...
import com.X.clientapp.thriftscala.CardDetails
import com.X.clientapp.thriftscala.EventDetails
import com.X.clientapp.thriftscala.EventNamespace
import com.X.clientapp.thriftscala.ImpressionDetails
...
import com.X.clientapp.thriftscala.MediaDetailsV2
import com.X.clientapp.thriftscala.MediaType
import com.X.clientapp.thriftscala.NotificationDetails
import com.X.clientapp.thriftscala.NotificationTabDetails
import com.X.clientapp.thriftscala.PerformanceDetails
import com.X.clientapp.thriftscala.ReportDetails
import com.X.clientapp.thriftscala.SearchDetails
import com.X.clientapp.thriftscala.SuggestionDetails
import com.X.clientapp.thriftscala.{Item => LogEventItem}
import com.X.clientapp.thriftscala.{TweetDetails => LogEventTweetDetails}
import com.X.gizmoduck.thriftscala.UserModification
import com.X.gizmoduck.thriftscala.Profile
import com.X.gizmoduck.thriftscala.Auth
import com.X.gizmoduck.thriftscala.UpdateDiffItem
...
import com.X.iesource.thriftscala.{UserIdentifier => UserIdentifierIE}
import com.X.logbase.thriftscala.ClientEventReceiver
import com.X.logbase.thriftscala.LogBase
import com.X.mediaservices.commons.thriftscala.MediaCategory
import com.X.notificationservice.api.thriftscala.NotificationClientEventMetadata
import com.X.reportflow.thriftscala.ReportType
...
import com.X.video.analytics.thriftscala.ClientMediaEvent
import com.X.video.analytics.thriftscala.SessionState
import com.X.video.analytics.thriftscala._
...
import com.X.unified_user_actions.thriftscala.FeedbackPromptInfo
...
object TestFixtures {
  ...
  trait ClientEventFixture extends CommonFixture {
    ...
    val clientMediaEvent: ClientMediaEvent = ClientMediaEvent(
      ...
      playingMediaState = PlayingMediaState(
        ...
        mediaMetadata = MediaMetadata(publisherIdentifier = PublisherIdentifier
          .XPublisherIdentifier(XPublisherIdentifier(123456L)))
      ),
    ...
    val expectedSearchTweetEventWithControllerData: UnifiedUserAction =
      mkExpectedUUAForActionTowardDefaultTweetEvent(
        ...
        productSurface = Some(ProductSurface.SearchResultsPage),
        productSurfaceInfo =
          Some(ProductSurfaceInfo.SearchResultsPageInfo(SearchResultsPageInfo(query = "X"))),
        traceIdOpt = Some(traceId),
        requestJoinIdOpt = Some(requestJoinId)
      )
  ...
  trait EmailNotificationEventFixture extends CommonFixture {
    val timestamp = 1001L
    val pageUrlStatus =
      "https://X.com/a/status/3?cn=a%3D%3D&refsrc=email"
    val tweetIdStatus = 3L

    val pageUrlEvent =
      "https://X.com/i/events/2?cn=a%3D%3D&refsrc=email"
    val tweetIdEvent = 2L

    val pageUrlNoArgs = "https://X.com/i/events/1"
  ...
  trait UserModificationEventFixture extends CommonFixture {
    ...
    val location = "US"
    val url = s"https://www.X.com/${userName}"
