...
object ItemTypeFilterPredicates {
   ...
   *  Reference code - https://sourcegraph.X.biz/git.X.biz/source/-/blob/src/scala/com/X/experiments/lambda/shared/Timelines.scala?L156
   *  Since enums `PROMOTED_TWEET` and `POPULAR_TWEET` are deprecated in the following thrift
   *  https://sourcegraph.X.biz/git.X.biz/source/-/blob/src/thrift/com/X/clientapp/gen/client_app.thrift?L131
