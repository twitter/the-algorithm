package com.X.unified_user_actions.adapter.tweetypie_event
...
trait BaseTweetypieTweetEventCreate extends BaseTweetypieTweetEvent[TweetCreateEvent] {
   ...
   *  check https://sourcegraph.X.biz/git.X.biz/source/-/blob/src/thrift/com/X/tweetypie/tweet.thrift?L1001.
   *
