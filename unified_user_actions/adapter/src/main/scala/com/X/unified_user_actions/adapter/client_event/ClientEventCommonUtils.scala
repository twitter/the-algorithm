...
import com.X.clientapp.thriftscala.ItemType.User
...
import com.X.unified_user_actions.thriftscala.ClientEventNamespace
...
import com.X.unified_user_actions.thriftscala.TweetAuthorFollowClickSource
import com.X.unified_user_actions.thriftscala.TweetAuthorUnfollowClickSource
...
object ClientEventCommonUtils {
  ...
  def getEventMetadata(
    ...
    // Client UI language or from Gizmoduck which is what user set in X App.
