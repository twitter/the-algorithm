...
import com.X.representation_manager.config.ClientConfig
import com.X.representation_manager.config.EnabledInMemoryCacheParams
import com.X.representation_manager.config.InMemoryCacheParams
...
object RMSConfigModule extends XModule {
