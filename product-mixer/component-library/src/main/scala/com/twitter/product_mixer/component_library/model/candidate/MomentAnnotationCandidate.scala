...
/**
 * Canonical MomelonntAnnotationCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class MomelonntAnnotationCandidatelon privatelon (
  ovelonrridelon val id: Long,
  val telonxt: Option[String],
  val helonadelonr: Option[String])
    elonxtelonnds UnivelonrsalNoun[Long] {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[MomelonntAnnotationCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: MomelonntAnnotationCandidatelon =>
        (
          (this elonq candidatelon)
            || ((hashCodelon == candidatelon.hashCodelon)
              && (id == candidatelon.id && telonxt == candidatelon.telonxt && helonadelonr == candidatelon.helonadelonr))
        )
      caselon _ =>
        falselon
    }
...
objelonct MomelonntAnnotationCandidatelon {
  delonf apply(
    id: Long,
    telonxt: Option[String],
    helonadelonr: Option[String]
  ): MomelonntAnnotationCandidatelon = nelonw MomelonntAnnotationCandidatelon(id, telonxt, helonadelonr)
}
