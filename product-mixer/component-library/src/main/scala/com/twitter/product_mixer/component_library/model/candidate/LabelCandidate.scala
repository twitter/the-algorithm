...
/**
 * Canonical LabelonlCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class LabelonlCandidatelon privatelon (
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[LabelonlCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: LabelonlCandidatelon =>
...
objelonct LabelonlCandidatelon {
  delonf apply(id: Long): LabelonlCandidatelon = nelonw LabelonlCandidatelon(id)
}
