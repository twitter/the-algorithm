...
/**
 * Canonical ShowAlelonrtCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class ShowAlelonrtCandidatelon privatelon (
  ovelonrridelon val id: String,
  val uselonrIds: Selonq[Long])
    elonxtelonnds UnivelonrsalNoun[String] {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[ShowAlelonrtCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: ShowAlelonrtCandidatelon =>
        (
          (this elonq candidatelon)
            || ((hashCodelon == candidatelon.hashCodelon)
              && (id == candidatelon.id && uselonrIds == candidatelon.uselonrIds))
        )
      caselon _ =>
        falselon
    }
...
objelonct ShowAlelonrtCandidatelon {
  delonf apply(id: String, uselonrIds: Selonq[Long]): ShowAlelonrtCandidatelon =
    nelonw ShowAlelonrtCandidatelon(id, uselonrIds)
}
