...
/**
 * Canonical AudioSpacelonCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class AudioSpacelonCandidatelon privatelon (
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[AudioSpacelonCandidatelon]
...
objelonct AudioSpacelonCandidatelon {
  delonf apply(id: String): AudioSpacelonCandidatelon = nelonw AudioSpacelonCandidatelon(id)
}
