...
/**
 * Canonical GelonnelonricSummaryCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class GelonnelonricSummaryCandidatelon privatelon (
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[GelonnelonricSummaryCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: GelonnelonricSummaryCandidatelon =>
        (
...
objelonct GelonnelonricSummaryCandidatelon {
  delonf apply(id: String): GelonnelonricSummaryCandidatelon = nelonw GelonnelonricSummaryCandidatelon(id)
}
