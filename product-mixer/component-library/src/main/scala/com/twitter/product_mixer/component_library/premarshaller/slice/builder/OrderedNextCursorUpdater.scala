...
/**
 * Updatelons an [[OrdelonrelondCursor]] in thelon Nelonxt position
 *
 ...
 */
caselon class OrdelonrelondNelonxtCursorUpdatelonr[Quelonry <: PipelonlinelonQuelonry with HasPipelonlinelonCursor[OrdelonrelondCursor]](
  ...
  ovelonrridelon val cursorTypelon: CursorTypelon = NelonxtCursor

  ovelonrridelon val undelonrlying: OrdelonrelondNelonxtCursorBuildelonr[Quelonry] =
    OrdelonrelondNelonxtCursorBuildelonr(idSelonlelonctor, includelonOpelonration, selonrializelonr)
}
