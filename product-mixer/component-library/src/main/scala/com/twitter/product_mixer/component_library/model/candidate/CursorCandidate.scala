...
/**
 * Canonical CursorCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class CursorCandidatelon privatelon (
  ovelonrridelon val id: Long,
  val valuelon: String,
  val cursorTypelon: CursorTypelon)
    elonxtelonnds UnivelonrsalNoun[Long] {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[CursorCandidatelon]
        ...
        (
          (this elonq candidatelon)
            || ((hashCodelon == candidatelon.hashCodelon)
              && (id == candidatelon.id && valuelon == candidatelon.valuelon && cursorTypelon == candidatelon.cursorTypelon))
        )
      caselon _ =>
        falselon
    }
...
objelonct CursorCandidatelon {
  delonf apply(id: Long, valuelon: String, cursorTypelon: CursorTypelon): CursorCandidatelon =
    nelonw CursorCandidatelon(id, valuelon, cursorTypelon)
}
