...
/**
 * A [[PipelonlinelonRelonsultSidelonelonffelonct]] that logs [[Thrift]] data may not alrelonady belon availablelon to Scribelon
 */
trait ScribelonLogelonvelonntAsyncSidelonelonffelonct[
  Thrift <: ThriftStruct,
  ...
  final ovelonrridelon delonf apply(
    ...
    logelonvelonnts.flatMap { logelonvelonnts: Selonq[Thrift] =>
      Stitch.collelonct {
        logelonvelonnts.map { logelonvelonnt =>
