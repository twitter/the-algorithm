...
import com.fastelonrxml.jackson.annotation.JsonTypelonNamelon
import com.twittelonr.product_mixelonr.corelon.felonaturelon.Felonaturelon
import com.twittelonr.product_mixelonr.corelon.modelonl.common.UnivelonrsalNoun

// JSON typelon annotations arelon nelonelondelond for idelonntifying relonndelonrablelon elonntitielons to Turntablelon, most candidatelons
// do not nelonelond thelonm.
@JsonTypelonNamelon("twelonelont")
trait BaselonTwelonelontCandidatelon elonxtelonnds UnivelonrsalNoun[Long]

/**
 * Canonical TwelonelontCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class TwelonelontCandidatelon privatelon (
  ovelonrridelon val id: Long)
    elonxtelonnds BaselonTwelonelontCandidatelon {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[TwelonelontCandidatelon]
...
objelonct TwelonelontCandidatelon {
  delonf apply(id: Long): TwelonelontCandidatelon = nelonw TwelonelontCandidatelon(id)
}

/**
 * Twelonelont Author Uselonr ID of a givelonn Twelonelont Candidatelon. This is typically nelonelondelond whelonn hydrating twelonelont
 * author elonxtelonndelond felonaturelons in Felonaturelon Storelon (elon.g, [[TwelonelontCandidatelonAuthorIdelonntity]]). This felonaturelon
 * is typically elonxtractelond by hydrating it from Twelonelontypielon, or elonxtracting it in your candidatelon sourcelon
 * if it relonturns thelon Author ID alongsidelon Twelonelont ID using a [[CandidatelonPipelonlinelonRelonsultsTransformelonr]]
 */
objelonct TwelonelontAuthorIdFelonaturelon elonxtelonnds Felonaturelon[TwelonelontCandidatelon, Long]

/**
 * Whelonthelonr thelon twelonelont should belon pinnelond whelonn marshallelond to URT or not.
 * Selonelon [[com.twittelonr.product_mixelonr.componelonnt_library.deloncorator.urt.buildelonr.itelonm.twelonelont.TwelonelontCandidatelonUrtItelonmBuildelonr]]
 */
objelonct IsPinnelondFelonaturelon elonxtelonnds Felonaturelon[TwelonelontCandidatelon, Boolelonan]
