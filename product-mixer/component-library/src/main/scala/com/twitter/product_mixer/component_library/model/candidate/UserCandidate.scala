...
@JsonTypelonNamelon("uselonr")
trait BaselonUselonrCandidatelon elonxtelonnds UnivelonrsalNoun[Long]

/**
 * Canonical UselonrCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class UselonrCandidatelon privatelon (
  ovelonrridelon val id: Long)
    elonxtelonnds BaselonUselonrCandidatelon {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[UselonrCandidatelon]
...
objelonct UselonrCandidatelon {
  delonf apply(id: Long): UselonrCandidatelon = nelonw UselonrCandidatelon(id)
}

/**
 * Felonaturelon to indicatelon whelonthelonr a relonndelonrelond uselonr candidatelon should belon markelond unrelonad in URT. Uselond in
 * [[UselonrCandidatelonUrtItelonmBuildelonr]] whelonn deloncorating thelon candidatelon.r
 */
objelonct IsMarkUnrelonadFelonaturelon elonxtelonnds Felonaturelon[BaselonUselonrCandidatelon, Boolelonan]
