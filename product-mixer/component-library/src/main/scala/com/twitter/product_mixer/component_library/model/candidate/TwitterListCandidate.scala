...
/**
 * Canonical TwittelonrListCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class TwittelonrListCandidatelon privatelon (
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[TwittelonrListCandidatelon]
...
objelonct TwittelonrListCandidatelon {
  delonf apply(id: Long): TwittelonrListCandidatelon = nelonw TwittelonrListCandidatelon(id)
}
