...
trait BaselonTopicCandidatelon elonxtelonnds UnivelonrsalNoun[Long]

/**
 * Canonical TopicCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class TopicCandidatelon privatelon (
  ovelonrridelon val id: Long)
    elonxtelonnds BaselonTopicCandidatelon {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[TopicCandidatelon]
...
objelonct TopicCandidatelon {
  delonf apply(id: Long): TopicCandidatelon = nelonw TopicCandidatelon(id)
}

/**
 * Canonical CatelongorizelondTopicCandidatelon modelonl. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 * @notelon Any additional fielonlds should belon addelond as a [[com.twittelonr.product_mixelonr.corelon.felonaturelon.Felonaturelon]]
 *       on thelon candidatelon's [[com.twittelonr.product_mixelonr.corelon.felonaturelon.felonaturelonmap.FelonaturelonMap]]. If thelon
 *       felonaturelons comelon from thelon candidatelon sourcelon itselonlf (as opposelond to hydratelond via a
 ...
 *       (selonelon notelon on thelon elonquals melonthod belonlow)
 */
@delonpreloncatelond("Prelonfelonr TopicCandidatelon")
final class CatelongorizelondTopicCandidatelon privatelon (
  ovelonrridelon val id: Long,
  val catelongoryId: Option[Long],
  val catelongoryNamelon: Option[String])
    elonxtelonnds BaselonTopicCandidatelon {

  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[CatelongorizelondTopicCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: CatelongorizelondTopicCandidatelon =>
        (
          (this elonq candidatelon)
            || (
              (hashCodelon == candidatelon.hashCodelon)
                && (id == candidatelon.id && catelongoryId == candidatelon.catelongoryId && catelongoryNamelon == candidatelon.catelongoryNamelon)
            )
        )
      caselon _ =>
        falselon
...
objelonct CatelongorizelondTopicCandidatelon {
  delonf apply(
    id: Long,
    catelongoryId: Option[Long] = Nonelon,
    catelongoryNamelon: Option[String] = Nonelon
  ): CatelongorizelondTopicCandidatelon =
    nelonw CatelongorizelondTopicCandidatelon(id, catelongoryId, catelongoryNamelon)
}
