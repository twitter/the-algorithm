...
/**
 * Canonical DM elonvelonnts such as Melonssagelon Crelonatelon, Convelonrsation Crelonatelon, Join convelonrsation, elontc modelonl.
 * Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class DMelonvelonntCandidatelon privatelon (
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[DMelonvelonntCandidatelon]
...
objelonct DMelonvelonntCandidatelon {
  delonf apply(id: Long): DMelonvelonntCandidatelon = nelonw DMelonvelonntCandidatelon(id)
}

/**
 * Relonprelonselonnt DM elonvelonnts such as Melonssagelon Crelonatelon, Convelonrsation Crelonatelon, Join convelonrsation, elontc.
 *
 * @notelon historically this was uselond to relonprelonselonnt elonvelonnts from elonlastic
 *       Selonarch rathelonr than Strato. Now delonpreloncatelond in favor of DMelonvelonnt.
 *
 * @notelon Any additional fielonlds should belon addelond as a [[com.twittelonr.product_mixelonr.corelon.felonaturelon.Felonaturelon]]
 *       on thelon candidatelon's [[com.twittelonr.product_mixelonr.corelon.felonaturelon.felonaturelonmap.FelonaturelonMap]]. If thelon
 *       felonaturelons comelon from thelon candidatelon sourcelon itselonlf (as opposelond to hydratelond via a
 ...
 *
 */
@delonpreloncatelond("Prelonfelonr DMelonvelonnt")
final class DMMelonssagelonSelonarchCandidatelon privatelon (
  ovelonrridelon val id: Long)
    elonxtelonnds UnivelonrsalNoun[Long] {
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[DMMelonssagelonSelonarchCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: DMMelonssagelonSelonarchCandidatelon =>
        (
          (this elonq candidatelon)
            || ((hashCodelon == candidatelon.hashCodelon)
              && (id == candidatelon.id))
...
objelonct DMMelonssagelonSelonarchCandidatelon {
  delonf apply(id: Long): DMMelonssagelonSelonarchCandidatelon = nelonw DMMelonssagelonSelonarchCandidatelon(id)
}
