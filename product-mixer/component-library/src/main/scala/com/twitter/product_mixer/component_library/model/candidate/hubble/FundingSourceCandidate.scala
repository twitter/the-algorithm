...
/**
 * Canonical FundingSourcelonCandidatelon modelonl which delonscribelons a "Funding Instrumelonnt" from thelon thelon Ad
 * Managelonmelonnt pelonrspelonctivelon. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class FundingSourcelonCandidatelon privatelon (
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[FundingSourcelonCandidatelon]
...
objelonct FundingSourcelonCandidatelon {
  delonf apply(
    id: Long,
    adAccountId: Long
  ): FundingSourcelonCandidatelon = nelonw FundingSourcelonCandidatelon(id, adAccountId)
}
