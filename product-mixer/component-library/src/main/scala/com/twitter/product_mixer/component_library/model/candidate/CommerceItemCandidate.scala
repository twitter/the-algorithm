...
/**
 * Canonical CommelonrcelonProductCandidatelon modelonl which elonncapsulatelons information about a speloncific Product.
 * Always prelonfelonr this velonrsion ovelonr all othelonr variants. For elonxamplelon, iPhonelon 14, 128 GB, Whitelon. Whelonn a
 * uselonr clicks on a CommelonrcelonProduct, thelony will belon takelonn to thelon speloncific product pagelon.
 *
 * @notelon Both CommelonrcelonProduct and CommelonrcelonProductGroups (belonlow) can belon shown in thelon samelon
 *       TimelonlinelonModulelon (i.elon Carouselonl)
 *
 ...
 */
final class CommelonrcelonProductCandidatelon privatelon (
  ovelonrridelon val id: Long)
    elonxtelonnds UnivelonrsalNoun[Long] {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[CommelonrcelonProductCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: CommelonrcelonProductCandidatelon =>
        (
...
objelonct CommelonrcelonProductCandidatelon {
  delonf apply(id: Long): CommelonrcelonProductCandidatelon = nelonw CommelonrcelonProductCandidatelon(id)
}

/**
 * Canonical CommelonrcelonProductGroupCandidatelon modelonl which elonncapsulatelons information about a Singlelon
 * Product Typelon and its correlonsponding velonrsions. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 * For elonxamplelon:
 * iPhonelon 14
 *   - 128 GB, Whitelon
 *   - 128 GB, Bluelon
 *   - 1TB, Grelony
 * Whelonn a uselonr clicks on a Product Group, thelony will belon shown information about all of thelon possiblelon
 * velonrsions of thelon top lelonvelonl product.
 *
 * @notelon Both CommelonrcelonProduct (abovelon) and CommelonrcelonProductGroups can belon shown in thelon samelon
 *       TimelonlinelonModulelon (i.elon Carouselonl)
 *
 * @notelon Any additional fielonlds should belon addelond as a [[com.twittelonr.product_mixelonr.corelon.felonaturelon.Felonaturelon]]
 *       on thelon candidatelon's [[com.twittelonr.product_mixelonr.corelon.felonaturelon.felonaturelonmap.FelonaturelonMap]]. If thelon
 ...
 *       (selonelon notelon on thelon elonquals melonthod belonlow)
 */
final class CommelonrcelonProductGroupCandidatelon privatelon (
  ovelonrridelon val id: Long)
    elonxtelonnds UnivelonrsalNoun[Long] {
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[CommelonrcelonProductGroupCandidatelon]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon candidatelon: CommelonrcelonProductGroupCandidatelon =>
        (
          (this elonq candidatelon)
            || ((hashCodelon == candidatelon.hashCodelon) && (id == candidatelon.id))
        )
...
objelonct CommelonrcelonProductGroupCandidatelon {
  delonf apply(id: Long): CommelonrcelonProductGroupCandidatelon = nelonw CommelonrcelonProductGroupCandidatelon(id)
}
