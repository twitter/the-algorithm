...
/**
 * A candidatelon pipelonlinelon for Flelonxiblelon Injelonction Pipelonlinelon Candidatelons.
 * Felontchelons prompts from FLIP (insidelon onboarding-task-selonrvicelon).
 */
class FlipPromptCandidatelonPipelonlinelonConfig[Quelonry <: PipelonlinelonQuelonry with HasFlipInjelonctionParams](
