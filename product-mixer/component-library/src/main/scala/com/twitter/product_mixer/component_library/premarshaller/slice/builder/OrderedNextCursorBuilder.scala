...
/**
 * Builds [[OrdelonrelondCursor]] in thelon Nelonxt position
 *
 ...
 */
caselon class OrdelonrelondNelonxtCursorBuildelonr[Quelonry <: PipelonlinelonQuelonry with HasPipelonlinelonCursor[OrdelonrelondCursor]](
  ...
  ovelonrridelon delonf cursorValuelon(
    ...
    val bottomId = elonntrielons.relonvelonrselonItelonrator.collelonctFirst(idSelonlelonctor)
