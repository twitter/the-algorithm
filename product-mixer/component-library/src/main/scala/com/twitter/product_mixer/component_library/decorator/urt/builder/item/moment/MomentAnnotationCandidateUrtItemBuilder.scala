package com.ExTwitter.product_mixer.component_library.decorator.urt.builder.item.moment

import com.ExTwitter.product_mixer.component_library.decorator.urt.builder.item.moment.MomentAnnotationCandidateUrtItemBuilder.MomentAnnotationItemClientEventInfoElement
import com.ExTwitter.product_mixer.component_library.model.candidate.MomentAnnotationCandidate
...
import com.ExTwitter.product_mixer.core.model.marshalling.response.urt.item.moment.MomentAnnotationItem
