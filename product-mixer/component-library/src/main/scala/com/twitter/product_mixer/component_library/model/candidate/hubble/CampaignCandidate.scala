...
/**
 * Canonical CampaignCandidatelon modelonl which delonscribelons a "Campaign" from thelon Ads Managelonmelonnt
 * pelonrspelonctivelon. Always prelonfelonr this velonrsion ovelonr all othelonr variants.
 *
 ...
 */
final class CampaignCandidatelon privatelon (
  // This is thelon campaignId, but nelonelonds to belon namelond id to conform to UnivelonrsalNoun
   ...
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[CampaignCandidatelon]
...
objelonct CampaignCandidatelon {
  delonf apply(id: Long, adAccountId: Long): CampaignCandidatelon =
    nelonw CampaignCandidatelon(id, adAccountId)
}
