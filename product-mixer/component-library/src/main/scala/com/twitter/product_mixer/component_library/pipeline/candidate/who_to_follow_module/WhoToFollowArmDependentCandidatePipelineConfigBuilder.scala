...
@Singlelonton
class WhoToFollowArmDelonpelonndelonntCandidatelonPipelonlinelonConfigBuildelonr @Injelonct() (
  accountReloncommelonndationsMixelonrCandidatelonSourcelon: AccountReloncommelonndationsMixelonrCandidatelonSourcelon) {

  /**
   * Build a WhoToFollowArmDelonpelonndelonntCandidatelonPipelonlinelonConfig
   *
   *
   * To crelonatelon a relongular CandidatelonPipelonlinelonConfig instelonad selonelon [[WhoToFollowArmCandidatelonPipelonlinelonConfigBuildelonr]].
   *
  ...
  delonf build[Quelonry <: PipelonlinelonQuelonry](
    ...
    idelonntifielonr: CandidatelonPipelonlinelonIdelonntifielonr = WhoToFollowArmCandidatelonPipelonlinelonConfig.idelonntifielonr,
    ...
    displayLocationParam: Param[String] =
      StaticParam(WhoToFollowArmCandidatelonPipelonlinelonQuelonryTransformelonr.HomelonDisplayLocation),
  ...
  ): WhoToFollowArmDelonpelonndelonntCandidatelonPipelonlinelonConfig[Quelonry] =
    nelonw WhoToFollowArmDelonpelonndelonntCandidatelonPipelonlinelonConfig(
