package com.X.product_mixer.component_library.decorator.urt.builder.item.event_summary

import com.X.product_mixer.component_library.decorator.urt.builder.item.event_summary.EventCandidateUrtItemBuilder.EventClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.trends_events.EventDisplayType
import com.X.product_mixer.component_library.model.candidate.trends_events.EventImage
import com.X.product_mixer.component_library.model.candidate.trends_events.EventTimeString
import com.X.product_mixer.component_library.model.candidate.trends_events.EventTitleFeature
import com.X.product_mixer.component_library.model.candidate.trends_events.EventUrl
