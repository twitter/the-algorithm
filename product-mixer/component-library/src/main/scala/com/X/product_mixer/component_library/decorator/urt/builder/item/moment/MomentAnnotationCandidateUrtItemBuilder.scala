package com.X.product_mixer.component_library.decorator.urt.builder.item.moment

import com.X.product_mixer.component_library.decorator.urt.builder.item.moment.MomentAnnotationCandidateUrtItemBuilder.MomentAnnotationItemClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.MomentAnnotationCandidate
