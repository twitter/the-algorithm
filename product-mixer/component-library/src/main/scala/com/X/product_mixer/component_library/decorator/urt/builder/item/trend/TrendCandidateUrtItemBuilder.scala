...
import com.X.product_mixer.component_library.decorator.urt.builder.item.trend.TrendCandidateUrtItemBuilder.TrendsClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.trends_events.TrendDescription
import com.X.product_mixer.component_library.model.candidate.trends_events.TrendDomainContext
import com.X.product_mixer.component_library.model.candidate.trends_events.TrendGroupedTrends
import com.X.product_mixer.component_library.model.candidate.trends_events.TrendNormalizedTrendName
import com.X.product_mixer.component_library.model.candidate.trends_events.TrendTrendName
import com.X.product_mixer.component_library.model.candidate.trends_events.TrendTweetCount
import com.X.product_mixer.component_library.model.candidate.trends_events.TrendUrl
...
import com.X.product_mixer.core.functional_component.decorator.urt.builder.promoted.BasePromotedMetadataBuilder
