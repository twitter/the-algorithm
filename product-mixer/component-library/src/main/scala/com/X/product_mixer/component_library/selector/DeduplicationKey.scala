 ...
 * [[com.X.product_mixer.component_library.model.candidate.BaseTweetCandidate]] resulting in
 ...
 * [[com.X.product_mixer.component_library.model.candidate.BaseTweetCandidate]].
 */
