package com.X.product_mixer.component_library.model.candidate

import com.X.product_mixer.core.model.common.UniversalNoun

/**
 * Canonical XListCandidate model. Always prefer this version over all other variants.
 *
 * @note Any additional fields should be added as a [[com.X.product_mixer.core.feature.Feature]]
 *       on the candidate's [[com.X.product_mixer.core.feature.featuremap.FeatureMap]]. If the
 *       features come from the candidate source itself (as opposed to hydrated via a
 *       [[com.X.product_mixer.core.functional_component.feature_hydrator.CandidateFeatureHydrator]]),
 *       then [[com.X.product_mixer.core.pipeline.candidate.CandidatePipelineConfig.featuresFromCandidateSourceTransformers]]
 ...
 */
final class XListCandidate private (
   ...
   * @inheritdoc
   */
  override def canEqual(that: Any): Boolean = that.isInstanceOf[XListCandidate]
...
object XListCandidate {
  def apply(id: Long): XListCandidate = new XListCandidate(id)
}
