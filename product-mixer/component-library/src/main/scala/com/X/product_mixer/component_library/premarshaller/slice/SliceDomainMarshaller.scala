package com.X.product_mixer.component_library.premarshaller.slice

import com.X.product_mixer.component_library.model.candidate._
import com.X.product_mixer.component_library.model.candidate.hubble.AdCreativeCandidate
import com.X.product_mixer.component_library.model.candidate.hubble.AdGroupCandidate
import com.X.product_mixer.component_library.model.candidate.hubble.AdUnitCandidate
import com.X.product_mixer.component_library.model.candidate.hubble.CampaignCandidate
import com.X.product_mixer.component_library.model.candidate.hubble.FundingSourceCandidate
import com.X.product_mixer.component_library.model.candidate.suggestion.QuerySuggestionCandidate
import com.X.product_mixer.component_library.model.candidate.suggestion.TypeaheadEventCandidate
import com.X.product_mixer.component_library.premarshaller.slice.builder.SliceBuilder
import com.X.product_mixer.component_library.premarshaller.slice.builder.SliceCursorBuilder
import com.X.product_mixer.component_library.premarshaller.slice.builder.SliceCursorUpdater
import com.X.product_mixer.core.functional_component.premarshaller.DomainMarshaller
import com.X.product_mixer.core.functional_component.premarshaller.UndecoratedCandidateDomainMarshallerException
...
import com.X.product_mixer.core.model.marshalling.response.slice._
    ...
    val entries = selections.map {
      ...
      case candidateWithDetails @ ItemCandidateWithDetails(candidate, None, _) =>
        ...
        candidate match {
          ...
          case candidate: XListCandidate => XListItem(candidate.id)
