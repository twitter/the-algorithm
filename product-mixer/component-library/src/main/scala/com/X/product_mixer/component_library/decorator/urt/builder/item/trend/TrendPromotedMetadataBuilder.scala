...
import com.X.product_mixer.component_library.model.candidate.trends_events.PromotedTrendDescriptionFeature
import com.X.product_mixer.component_library.model.candidate.trends_events.PromotedTrendDisclosureTypeFeature
import com.X.product_mixer.component_library.model.candidate.trends_events.PromotedTrendIdFeature
import com.X.product_mixer.component_library.model.candidate.trends_events.PromotedTrendImpressionIdFeature
import com.X.product_mixer.component_library.model.candidate.trends_events.PromotedTrendNameFeature
