package com.X.product_mixer.component_library.decorator.urt.builder.item.user

import com.X.product_mixer.component_library.decorator.urt.builder.item.user.UserCandidateUrtItemBuilder.UserClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.BaseUserCandidate
import com.X.product_mixer.component_library.model.candidate.IsMarkUnreadFeature
import com.X.product_mixer.core.feature.featuremap.FeatureMap
import com.X.product_mixer.core.functional_component.decorator.urt.builder.CandidateUrtEntryBuilder
import com.X.product_mixer.core.functional_component.decorator.urt.builder.item.user.BaseUserReactiveTriggersBuilder
