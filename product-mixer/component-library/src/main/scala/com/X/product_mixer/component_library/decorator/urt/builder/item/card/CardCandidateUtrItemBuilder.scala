package com.X.product_mixer.component_library.decorator.urt.builder.item.card

import com.X.product_mixer.component_library.decorator.urt.builder.item.card.CardCandidateUtrItemBuilder.CardClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.CardCandidate
...
import com.X.product_mixer.core.model.marshalling.response.urt.item.card.CardDisplayType
