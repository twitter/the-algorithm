package com.X.product_mixer.component_library.decorator.slice

import com.X.product_mixer.component_library.model.candidate.CursorCandidate
import com.X.product_mixer.component_library.model.presentation.slice.SliceItemPresentation
 ...
 *       because the [[com.X.product_mixer.component_library.premarshaller.slice.SliceDomainMarshaller]]
