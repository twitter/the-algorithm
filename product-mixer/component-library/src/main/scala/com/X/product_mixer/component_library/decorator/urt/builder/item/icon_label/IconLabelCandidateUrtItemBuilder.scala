package com.X.product_mixer.component_library.decorator.urt.builder.item.icon_label

import com.X.product_mixer.component_library.decorator.urt.builder.item.icon_label.IconLabelCandidateUrtItemBuilder.IconLabelClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.LabelCandidate
