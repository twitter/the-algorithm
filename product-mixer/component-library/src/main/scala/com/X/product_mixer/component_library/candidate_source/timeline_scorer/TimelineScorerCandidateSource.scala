package com.X.product_mixer.component_library.candidate_source.timeline_scorer
...
import com.X.timelinescorer.common.scoredtweetcandidate.thriftscala.v1
import com.X.timelinescorer.common.scoredtweetcandidate.thriftscala.v1.Ancestor
import com.X.timelinescorer.common.scoredtweetcandidate.{thriftscala => ct}
import com.X.timelinescorer.{thriftscala => t}
import com.X.timelineservice.suggests.logging.candidate_tweet_source_id.thriftscala.CandidateTweetSourceId
