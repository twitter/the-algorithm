package com.X.product_mixer.component_library.decorator.urt.builder.item.message

import com.X.product_mixer.component_library.decorator.urt.builder.item.message.CompactPromptCandidateUrtItemStringCenterBuilder.CompactPromptClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.CompactPromptCandidate
