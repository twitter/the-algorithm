...
import com.X.product_mixer.core.model.marshalling.response.urt.item.prompt.Compact
import com.X.product_mixer.core.model.marshalling.response.urt.item.prompt.Large
import com.X.product_mixer.core.model.marshalling.response.urt.item.prompt.Normal
import com.X.product_mixer.core.model.marshalling.response.urt.item.prompt.RelevancePromptContent
import com.X.product_mixer.core.model.marshalling.response.urt.item.prompt.RelevancePromptDisplayType
...
object RelevancePromptConversions {
  ...
  // Based on com.X.timelinemixer.injection.model.candidate.OnboardingRelevancePromptDisplayType#fromThrift
  ...
  // Based on com.X.timelinemixer.injection.model.injection.OnboardingRelevancePromptInjection#buildConfirmation
  ...
  // Based on com.X.timelinemixer.injection.model.candidate.OnboardingInjectionAction#fromThrift
  ...
  // Based on com.X.timelinemixer.injection.model.injection.OnboardingRelevancePromptInjection#buildCallback
