package com.X.product_mixer.component_library.decorator.urt.builder.promoted

import com.X.ads.adserver.{thriftscala => ads}
import com.X.ads.common.base.{thriftscala => ac}
...
import com.X.product_mixer.core.model.marshalling.response.urt.promoted._
