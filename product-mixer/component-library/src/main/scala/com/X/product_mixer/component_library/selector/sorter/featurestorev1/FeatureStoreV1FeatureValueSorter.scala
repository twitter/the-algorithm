package com.X.product_mixer.component_library.selector.sorter.featurestorev1

import com.X.ml.featurestore.lib.EntityId
import com.X.product_mixer.component_library.selector.sorter.Ascending
import com.X.product_mixer.component_library.selector.sorter.Descending
import com.X.product_mixer.component_library.selector.sorter.FeatureValueSorter.featureValueSortDefaultValue
import com.X.product_mixer.component_library.selector.sorter.SorterFromOrdering
import com.X.product_mixer.component_library.selector.sorter.SorterProvider
import com.X.product_mixer.core.feature.featuremap.featurestorev1.FeatureStoreV1FeatureMap._
import com.X.product_mixer.core.feature.featurestorev1.FeatureStoreV1CandidateFeature
...
/**
 * Feature Store v1 version of [[com.X.product_mixer.component_library.selector.sorter.FeatureValueSorter]]
 */
object FeatureStoreV1FeatureValueSorter {
   ...
   *                See [[com.X.product_mixer.component_library.selector.sorter.FeatureValueSorter.featureValueSortDefaultValue]]
