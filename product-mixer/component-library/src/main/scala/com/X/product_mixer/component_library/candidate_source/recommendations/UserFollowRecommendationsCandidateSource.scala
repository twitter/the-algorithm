package com.X.product_mixer.component_library.candidate_source.recommendations

import com.X.follow_recommendations.{thriftscala => fr}
...
import com.X.strato.generated.client.onboarding.follow_recommendations_service.GetRecommendationsClientColumn
