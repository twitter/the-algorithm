package com.X.product_mixer.component_library.decorator.urt.builder.item.ad

import com.X.ads.adserver.{thriftscala => ads}
import com.X.adserver.{thriftscala => adserver}
import com.X.product_mixer.component_library.decorator.urt.builder.contextual_ref.ContextualTweetRefBuilder
import com.X.product_mixer.component_library.decorator.urt.builder.item.tweet.TweetCandidateUrtItemBuilder.TweetClientEventInfoElement
...
import com.X.product_mixer.core.model.marshalling.response.urt.item.tweet.TweetDisplayType
import com.X.product_mixer.core.model.marshalling.response.urt.item.tweet.TweetItem
import com.X.product_mixer.core.model.marshalling.response.urt.promoted.AdMetadataContainer
...
import com.X.product_mixer.core.model.marshalling.response.urt.promoted.DcmUrlOverrideType
...
import com.X.product_mixer.core.model.marshalling.response.urt.promoted.MediaInfo
...
import com.X.product_mixer.core.model.marshalling.response.urt.promoted.Preroll
...
import com.X.product_mixer.core.model.marshalling.response.urt.promoted.UnknownUrlOverrideType
import com.X.product_mixer.core.model.marshalling.response.urt.promoted.VideoVariant
import com.X.product_mixer.core.pipeline.PipelineQuery
import com.X.timelines.util.AdMetadataContainerSerializer
import com.X.timelines.util.PrerollMetadataSerializer
