...
import com.X.onboarding.injections.{thriftscala => flipinjection}
...
import com.X.product_mixer.component_library.model.candidate.FullCoverPromptCandidate
import com.X.product_mixer.component_library.model.candidate.HalfCoverPromptCandidate
import com.X.product_mixer.component_library.model.candidate.InlinePromptCandidate
import com.X.product_mixer.component_library.model.candidate.PromptCarouselTileCandidate
import com.X.product_mixer.component_library.model.candidate.RelevancePromptCandidate
...
object PromptResultsTransformer
   ...
   * Supported injection types have to match those declared in com.X.product_mixer.component_library.transformer.flexible_injection_pipeline.FlipQueryTransformer#supportedPromptFormats
   */
