package com.X.product_mixer.component_library.decorator.urt.builder.item.suggestion

import com.X.product_mixer.component_library.decorator.urt.builder.item.suggestion.SpellingSuggestionCandidateUrtItemBuilder.SpellingItemClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.suggestion.SpellingSuggestionCandidate
