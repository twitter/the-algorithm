package com.X.product_mixer.component_library.decorator.urt.builder.item.article

import com.X.product_mixer.component_library.decorator.urt.builder.item.article.ArticleCandidateUrtItemBuilder.ArticleClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.BaseArticleCandidate
