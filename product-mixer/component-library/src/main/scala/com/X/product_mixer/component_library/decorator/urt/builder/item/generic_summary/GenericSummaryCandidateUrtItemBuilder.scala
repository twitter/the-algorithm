...
import com.X.product_mixer.component_library.decorator.urt.builder.item.generic_summary.GenericSummaryCandidateUrtItemBuilder.GenericSummaryClientEventInfoElement
import com.X.product_mixer.component_library.model.candidate.GenericSummaryCandidate
...
import com.X.product_mixer.core.model.marshalling.response.urt.item.generic_summary.GenericSummaryItemDisplayType
