...
import com.X.product_mixer.core.model.marshalling.response.urt.icon._
...
import com.X.product_mixer.core.model.marshalling.response.urt.item.message.MessageAction
import com.X.product_mixer.core.model.marshalling.response.urt.item.message.MessageActionType
import com.X.product_mixer.core.model.marshalling.response.urt.item.message.MessageImage
import com.X.product_mixer.core.model.marshalling.response.urt.item.message.MessageTextAction
import com.X.product_mixer.core.model.marshalling.response.urt.item.message.UserFacepile
...
import com.X.product_mixer.core.model.marshalling.response.urt.metadata.Dismiss
...
import com.X.product_mixer.core.model.marshalling.response.urt.metadata.UrtEndpoint
import com.X.product_mixer.core.model.marshalling.response.urt.metadata.UrtEndpointOptions
import com.X.product_mixer.core.model.marshalling.response.urt.richtext.Center
import com.X.product_mixer.core.model.marshalling.response.urt.richtext.Natural
...
object OnboardingInjectionConversions {
  ...
  def convertRichText(
    richText: com.X.onboarding.injections.thriftscala.RichText
  ): RichText = {
  ...
  private def convertRef(ref: onboardingthrift.ReferenceObject): ReferenceObject =
    ref match {
      ...
      case onboardingthrift.ReferenceObject.XList(twList) =>
