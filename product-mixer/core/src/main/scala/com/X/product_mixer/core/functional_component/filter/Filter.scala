package com.X.product_mixer.core.functional_component.filter

import com.X.product_mixer.core.functional_component.filter.Filter.SupportsConditionally
import com.X.product_mixer.core.model.common
 ...
 *       or to gate on a [[com.X.timelines.configapi.Param]] you can use [[com.X.product_mixer.component_library.filter.ParamGatedFilter]]
 *
