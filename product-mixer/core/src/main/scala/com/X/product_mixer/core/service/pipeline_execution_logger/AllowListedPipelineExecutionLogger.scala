...
import com.X.product_mixer.core.module.product_mixer_flags.ProductMixerFlagModule.PipelineExecutionLoggerAllowList
import com.X.product_mixer.core.module.product_mixer_flags.ProductMixerFlagModule.ServiceLocal
import com.X.product_mixer.core.pipeline.PipelineQuery
import com.X.product_mixer.core.util.FuturePools
...
class AllowListedPipelineExecutionLogger @Inject() (
  ...
  override def apply(pipelineQuery: PipelineQuery, message: Any): Unit = {
    ...
    if (isServiceLocal || allowListed) {
      futureObserver(
        /**
         * failure to enqueue the work will result with a failed [[com.X.util.Future]]
