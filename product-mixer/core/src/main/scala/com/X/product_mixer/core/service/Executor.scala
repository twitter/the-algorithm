...
import com.X.finagle.tracing.Annotation
import com.X.finagle.tracing.Record
import com.X.finagle.tracing.Trace
import com.X.finagle.tracing.TraceId
import com.X.finagle.tracing.TraceServiceName
import com.X.finagle.tracing.Tracing.LocalBeginAnnotation
import com.X.finagle.tracing.Tracing.LocalEndAnnotation
...
import com.X.product_mixer.core.model.common.identifier.ComponentIdentifierStack
...
import com.X.product_mixer.core.pipeline.pipeline_failure.FeatureHydrationFailed
import com.X.product_mixer.core.pipeline.pipeline_failure.MisconfiguredFeatureMapFailure
import com.X.product_mixer.core.pipeline.pipeline_failure.PipelineFailure
import com.X.product_mixer.core.pipeline.pipeline_failure.PipelineFailureClassifier
import com.X.product_mixer.core.pipeline.pipeline_failure.UncategorizedServerFailure
import com.X.product_mixer.core.quality_factor.QualityFactorObserver
import com.X.product_mixer.core.service.Executor.AlwaysFailOpenIncludingProgrammerErrors
import com.X.product_mixer.core.service.Executor.Context
import com.X.product_mixer.core.service.Executor.TracingConfig
import com.X.product_mixer.core.service.Executor.toPipelineFailureWithComponentIdentifierStack
import com.X.servo.util.CancelledExceptionExtractor
import com.X.stitch.Arrow
import com.X.stitch.Stitch
import com.X.stitch.Stitch.Letter
...
private[core] trait Executor {
  ...
  /**
   * for [[com.X.product_mixer.core.model.common.Component]]s which
  ...
  /** for [[com.X.product_mixer.core.model.common.Component]]s */
  ...
  /**
   * for [[com.X.product_mixer.core.model.common.Component]]s which an `onSuccess`
  ...
  /** for [[com.X.product_mixer.core.pipeline.Pipeline]]s */
  ...
  /** for [[com.X.product_mixer.core.pipeline.product.ProductPipeline]]s */
  ...
  /** for [[com.X.product_mixer.core.model.common.Component]]s which need a result size stat */
  ...
  /** for [[com.X.product_mixer.core.pipeline.PipelineBuilder.Step]]s */
...
private[core] object Executor {
  ...
  /**
   * Always fail-open and return the [[com.X.product_mixer.core.pipeline.product.ProductPipelineResult]]
  ...
  private[this] object Tracing {
    ...
    /**
     * Duplicate of [[com.X.finagle.tracing.Tracing]]'s `localSpans` which
  ...
  /**
   * Returns a feature map containing all the [[com.X.product_mixer.core.feature.Feature]]s
   ...
   * [[com.X.product_mixer.core.pipeline.pipeline_failure.PipelineFailureCategory]] in stats which is more useful
   * for customers components which access a failed [[Feature]] than the original [[com.X.product_mixer.core.pipeline.pipeline_failure.PipelineFailureCategory]].
   */
