...
/**
 * [[CandidateDecorator]] generates a [[com.X.product_mixer.core.model.common.presentation.UniversalPresentation]]
 * for Candidates, which encapsulate information about how to present the candidate
 *
 * @see [[https://docbird.X.biz/product-mixer/functional-components.html#candidate-decorator]]
 * @see [[com.X.product_mixer.core.model.common.presentation.UniversalPresentation]]
 */
...
object CandidateDecorator {
  ...
  /**
   * For use when building a [[CandidateDecorator]] in a [[com.X.product_mixer.core.pipeline.PipelineBuilder]]
   * to ensure that the identifier is updated with the parent [[com.X.product_mixer.core.pipeline.Pipeline.identifier]]
   */
