package com.X.product_mixer.core.functional_component.candidate_source.product_pipeline
 ...
 * [[com.X.product_mixer.core.model.marshalling.request.Product]] within the same Product
