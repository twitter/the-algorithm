...
import com.X.product_mixer.core.functional_component.configapi.registry.ParamConfig
import com.X.servo.decider.DeciderKeyName
import com.X.timelines.configapi.FSParam
import com.X.timelines.configapi.decider.BooleanDeciderParam
...
trait ProductParamConfig extends ParamConfig with ProductParamConfigBuilder {
   ...
   *
   * FeatureSwitches are configured by defining both a [[com.X.timelines.configapi.Param]] in code
