...
import com.X.product_mixer.core.functional_component.scorer.ScoredCandidateResult
import com.X.product_mixer.core.gate.ParamGate
import com.X.product_mixer.core.gate.ParamGate._
...
import com.X.product_mixer.core.pipeline.NewPipelineBuilder
import com.X.product_mixer.core.pipeline.NewPipelineArrowBuilder
import com.X.product_mixer.core.pipeline.NewPipelineResult
...
import com.X.product_mixer.core.pipeline.state.HasCandidatesWithDetails
import com.X.product_mixer.core.pipeline.state.HasCandidatesWithFeatures
import com.X.product_mixer.core.pipeline.state.HasExecutorResults
import com.X.product_mixer.core.pipeline.state.HasQuery
import com.X.product_mixer.core.pipeline.state.HasResult
import com.X.product_mixer.core.pipeline.step.candidate_feature_hydrator.CandidateFeatureHydratorStep
import com.X.product_mixer.core.pipeline.step.gate.GateStep
import com.X.product_mixer.core.pipeline.step.scorer.ScorerStep
import com.X.product_mixer.core.pipeline.step.selector.SelectorStep
...
import com.X.product_mixer.core.service.selector_executor.SelectorExecutorResult
