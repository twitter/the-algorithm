 ...
 *
 * @note if you want to conditionally run a [[BaseCandidateFeatureHydrator]] you can use the mixin [[com.X.product_mixer.core.model.common.Conditionally]]
 *       or to gate on a [[com.X.timelines.configapi.Param]] you can use
 *       [[com.X.product_mixer.component_library.feature_hydrator.candidate.param_gated.ParamGatedCandidateFeatureHydrator]] or
 *       [[com.X.product_mixer.component_library.feature_hydrator.candidate.param_gated.ParamGatedBulkCandidateFeatureHydrator]]
 */
