...
import com.X.product_mixer.shared_library.observer.Observer
import com.X.product_mixer.shared_library.observer.Observer.Observer
import com.X.product_mixer.shared_library.observer.ResultsStatsObserver.ResultsStatsObserver
...
private[core] object ExecutorObserver {
  ...
  /**
   * Make a [[PipelineExecutorObserver]] specifically for a [[com.X.product_mixer.core.pipeline.product.ProductPipeline]]
...
private[core] sealed class ExecutorObserver[T](
  ...
  /**
   * always empty because we expect an already scoped [[com.X.finagle.stats.BroadcastStatsReceiver]] to be passed in
   ...
   * [[com.X.product_mixer.core.pipeline.pipeline_failure.PipelineFailureCategory.categoryName]] and
   * [[com.X.product_mixer.core.pipeline.pipeline_failure.PipelineFailureCategory.failureName]]
   */
