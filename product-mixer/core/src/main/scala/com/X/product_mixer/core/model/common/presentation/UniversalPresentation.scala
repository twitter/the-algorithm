 ...
 * [[com.X.product_mixer.component_library.model.presentation.urt.UrtItemPresentation]]
 *
 * @see [[com.X.product_mixer.core.functional_component.decorator.CandidateDecorator]] for associating a
