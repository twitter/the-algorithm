...
import com.X.product_mixer.core.functional_component.common.access_policy.WithDebugAccessPolicies
...
import com.X.product_mixer.core.service.component_registry
