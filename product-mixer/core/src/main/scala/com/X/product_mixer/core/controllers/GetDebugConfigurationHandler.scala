...
import com.X.scrooge.schema.ThriftDefinitions
import com.X.scrooge.schema.scrooge.scala.CompiledScroogeDefBuilder
import com.X.scrooge.schema.serialization.thrift.ReferenceResolver
import com.X.scrooge.schema.serialization.thrift.ThriftDefinitionsSerializer
import com.X.scrooge.schema.{thriftscala => THRIFT}
