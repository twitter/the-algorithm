...
import com.X.product_mixer.core.model.marshalling.response.urt.item.forward_pivot.GetTheLatest
import com.X.product_mixer.core.model.marshalling.response.urt.item.forward_pivot.GovernmentRequested
import com.X.product_mixer.core.model.marshalling.response.urt.item.forward_pivot.Misleading
import com.X.product_mixer.core.model.marshalling.response.urt.item.forward_pivot.SoftInterventionDisplayType
import com.X.product_mixer.core.model.marshalling.response.urt.item.forward_pivot.StayInformed
