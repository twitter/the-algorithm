package com.X.product_mixer.core.functional_component.common
 ...
 * to all candidates regardless of which pipeline is their [[com.X.product_mixer.core.model.common.presentation.CandidateWithDetails.source]].
 */
...
/**
 * A [[CandidateScope]] that applies the given [[com.X.product_mixer.core.functional_component.selector.Selector]]
 * only to candidates whose [[com.X.product_mixer.core.model.common.presentation.CandidatePipelines]]
...
/**
 * A [[CandidateScope]] that applies the given [[com.X.product_mixer.core.functional_component.selector.Selector]]
 * only to candidates whose [[com.X.product_mixer.core.model.common.presentation.CandidateWithDetails.source]]
 * is [[pipeline]].
 */
...
/**
 * A [[CandidateScope]] that applies the given [[com.X.product_mixer.core.functional_component.selector.Selector]]
 * to all candidates except for the candidates whose [[com.X.product_mixer.core.model.common.presentation.CandidatePipelines]]
