...
import com.X.product_mixer.core.pipeline.PipelineConfigCompanion
...
object MixerPipelineConfig extends PipelineConfigCompanion {
  ...
  /**
   * All the Steps which an [[com.X.product_mixer.core.functional_component.feature_hydrator.AsyncHydrator AsyncHydrator]]
   * can be configured to [[com.X.product_mixer.core.functional_component.feature_hydrator.AsyncHydrator.hydrateBefore hydrateBefore]]
   */
