...
import com.X.concurrent.NamedPoolThreadFactory
...
object FuturePools {
   ...
   *
   * @note the [[FuturePool]] returns a failed [[com.X.util.Future]]s containing
   ...
   * who's `workQueue` is monitored by a [[com.X.finagle.stats.Gauge]]
   *
