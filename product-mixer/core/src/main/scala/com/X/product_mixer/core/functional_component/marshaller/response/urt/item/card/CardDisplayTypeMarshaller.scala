package com.X.product_mixer.core.functional_component.marshaller.response.urt.item.card

import javax.inject.Inject
import javax.inject.Singleton
import com.X.product_mixer.core.model.marshalling.response.urt.item.card._
