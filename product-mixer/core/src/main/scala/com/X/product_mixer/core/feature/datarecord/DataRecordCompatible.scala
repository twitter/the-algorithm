package com.X.product_mixer.core.feature.datarecord

import com.X.dal.personal_data.thriftjava.PersonalDataType
import com.X.ml.api.Feature
import com.X.ml.api.DataType
import com.X.ml.api.thriftscala.GeneralTensor
import com.X.ml.api.thriftscala.StringTensor
import com.X.ml.api.util.ScalaToJavaDataRecordConversions
import com.X.ml.api.{GeneralTensor => JGeneralTensor}
import com.X.ml.api.{RawTypedTensor => JRawTypedTensor}
import com.X.ml.api.{Feature => MlFeature}
