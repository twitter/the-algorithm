...
import com.X.product_mixer.core.functional_component.transformer._
...
sealed trait BaseCandidatePipelineConfig[
  ...
  /**
   * [[CandidateFeatureTransformer]] allow you to define [[com.X.product_mixer.core.feature.Feature]] extraction logic from your [[CandidateSource]] results.
   * If your candidate sources return [[com.X.product_mixer.core.feature.Feature]]s alongside the candidate that might be useful later on,
