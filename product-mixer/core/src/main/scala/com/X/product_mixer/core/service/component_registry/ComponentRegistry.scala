...
/**
 * The [[ComponentRegistry]] works closely with [[ComponentIdentifier]]s and the [[com.X.product_mixer.core.product.registry.ProductPipelineRegistry]]
 * to provide the Product Mixer framework information about the [[com.X.product_mixer.core.pipeline.Pipeline]]s and [[Component]]s
