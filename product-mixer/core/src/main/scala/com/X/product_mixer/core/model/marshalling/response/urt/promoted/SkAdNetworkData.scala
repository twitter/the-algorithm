...
case class SkAdNetworkData(
  ...
  srcAppId: Option[String], // app showing the ad (X app or app promoting through MOPUB)
  dstAppId: Option[String], // app being promoted
  adNetworkId: Option[String], // the ad-network-id being used
  campaignId: Option[Long], // the sk-campaign-id - different from the X campaign id
