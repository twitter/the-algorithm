package com.X.product_mixer.core.model.marshalling.response.rtf.safety_level

/*
  These are model objects for the thrift enum - src/thrift/com/X/spam/rtf/safety_level.thrift
