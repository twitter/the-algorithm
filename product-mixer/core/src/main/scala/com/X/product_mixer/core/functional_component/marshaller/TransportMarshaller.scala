package com.X.product_mixer.core.functional_component.marshaller
 ...
 *
 * @note this is different from `com.X.product_mixer.core.functional_component.premarshaller`
 ...
 * [[com.X.product_mixer.core.functional_component.candidate_source.product_pipeline.ProductPipelineCandidateSource]]
 */
