...
import com.X.finagle.http.Status
import com.X.finagle.http.RouteIndex
import com.X.finatra.http.Controller
import com.X.scrooge.ThriftMethod
      ...
      productNamesFut.map { productNames =>
        productNames.foreach { productName =>
          get(
            ...
            val redirectUrl =
              s"https://feeds.X.biz/dtab/$serviceName/$productName?servicePath=$auroraPath"
