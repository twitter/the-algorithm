package com.X.product_mixer.core.functional_component.common.alert
 ...
 *
 * See the Monitoring 2.0 docs for more information on [[https://docbird.X.biz/mon/how-to-guides.html?highlight=notificationgroup#set-up-email-pagerduty-and-slack-notifications setting up a Pager Duty rotation]]
 */
