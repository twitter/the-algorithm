package com.X.product_mixer.core.model.marshalling.response.slice
 ...
 *
 * They are to be kept in sync with strato/config/src/thrift/com/X/strato/graphql/hubble.thrift
 */
sealed trait AdType
object AdType {
...
case class XListItem(id: Long) extends SliceItem
