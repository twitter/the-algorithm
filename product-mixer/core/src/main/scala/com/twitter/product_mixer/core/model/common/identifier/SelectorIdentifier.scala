...
/**
 * Selonlelonctor idelonntifielonr
 *
 ...
 */
selonalelond abstract class SelonlelonctorIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("Selonlelonctor", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[SelonlelonctorIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: SelonlelonctorIdelonntifielonr =>
...
/**
 * Uselond in `Selonlelonctorelonxeloncutor` to givelon an ID to elonach selonlelonctor in thelon `ComponelonntIdelonntifielonrStack`
 *
 * Thelonselon arelon oftelonn gelonnelonratelond automatically in thelon elonxeloncutor and arelon delonpelonndelonnt on thelon class namelons
 * so welon skip validation to avoid issuelons. Sincelon welon dont reloncord stats for Selonlelonctors this is okay.
 */
privatelon[corelon] objelonct SelonlelonctorIdelonntifielonr {
  delonf apply(
    namelon: String,
    indelonx: Int
  )(
    implicit sourcelonFilelon: sourceloncodelon.Filelon
  ): SelonlelonctorIdelonntifielonr = {
    val capitalizelondWithoutSpeloncialCharactelonrs = namelon.relonplacelon("$", "").capitalizelon
    nelonw SelonlelonctorIdelonntifielonr(indelonx.toString + capitalizelondWithoutSpeloncialCharactelonrs) {
