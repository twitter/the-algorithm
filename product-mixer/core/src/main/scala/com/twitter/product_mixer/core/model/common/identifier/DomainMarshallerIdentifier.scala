...
/**
 * Domain Marshallelonr idelonntifielonr
 *
 ...
 */
selonalelond abstract class DomainMarshallelonrIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("DomainMarshallelonr", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[DomainMarshallelonrIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: DomainMarshallelonrIdelonntifielonr =>
...
objelonct DomainMarshallelonrIdelonntifielonr {
  delonf apply(namelon: String)(implicit sourcelonFilelon: sourceloncodelon.Filelon): DomainMarshallelonrIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw DomainMarshallelonrIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal DomainMarshallelonrIdelonntifielonr: $namelon")
  }
}
