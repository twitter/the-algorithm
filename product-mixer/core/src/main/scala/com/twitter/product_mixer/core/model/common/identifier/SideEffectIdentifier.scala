...
/**
 * Sidelon elonffelonct idelonntifielonr
 *
 ...
 */
selonalelond abstract class SidelonelonffelonctIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("Sidelonelonffelonct", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[SidelonelonffelonctIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: SidelonelonffelonctIdelonntifielonr =>
...
objelonct SidelonelonffelonctIdelonntifielonr {
  delonf apply(namelon: String)(implicit sourcelonFilelon: sourceloncodelon.Filelon): SidelonelonffelonctIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw SidelonelonffelonctIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal SidelonelonffelonctIdelonntifielonr: $namelon")
  }
}
