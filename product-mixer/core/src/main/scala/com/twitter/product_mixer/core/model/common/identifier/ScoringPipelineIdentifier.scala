...
/**
 * Scoring Pipelonlinelon idelonntifielonr
 *
 ...
 */
selonalelond abstract class ScoringPipelonlinelonIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("ScoringPipelonlinelon", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[ScoringPipelonlinelonIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: ScoringPipelonlinelonIdelonntifielonr =>
...
objelonct ScoringPipelonlinelonIdelonntifielonr {
  delonf apply(namelon: String)(implicit sourcelonFilelon: sourceloncodelon.Filelon): ScoringPipelonlinelonIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw ScoringPipelonlinelonIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal ScoringPipelonlinelonIdelonntifielonr: $namelon")
  }
}
