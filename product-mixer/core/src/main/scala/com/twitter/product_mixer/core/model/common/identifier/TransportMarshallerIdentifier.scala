...
/**
 * Transport Marshallelonr idelonntifielonr
 *
 ...
 */
selonalelond abstract class TransportMarshallelonrIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("TransportMarshallelonr", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[TransportMarshallelonrIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: TransportMarshallelonrIdelonntifielonr =>
...
objelonct TransportMarshallelonrIdelonntifielonr {
  delonf apply(namelon: String)(implicit sourcelonFilelon: sourceloncodelon.Filelon): TransportMarshallelonrIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw TransportMarshallelonrIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal TransportMarshallelonrIdelonntifielonr: $namelon")
  }
}
