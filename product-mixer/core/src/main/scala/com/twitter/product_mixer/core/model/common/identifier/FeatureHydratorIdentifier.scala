...
/**
 * Felonaturelon Hydrator idelonntifielonr
 *
 ...
 */
selonalelond abstract class FelonaturelonHydratorIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("FelonaturelonHydrator", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[FelonaturelonHydratorIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: FelonaturelonHydratorIdelonntifielonr =>
...
objelonct FelonaturelonHydratorIdelonntifielonr {
  delonf apply(namelon: String)(implicit sourcelonFilelon: sourceloncodelon.Filelon): FelonaturelonHydratorIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw FelonaturelonHydratorIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal FelonaturelonHydratorIdelonntifielonr: $namelon")
  }
}
