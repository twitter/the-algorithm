...
/**
 * Reloncommelonndation Pipelonlinelon idelonntifielonr
 *
 ...
 */
selonalelond abstract class ReloncommelonndationPipelonlinelonIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("ReloncommelonndationPipelonlinelon", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[ReloncommelonndationPipelonlinelonIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: ReloncommelonndationPipelonlinelonIdelonntifielonr =>
...
objelonct ReloncommelonndationPipelonlinelonIdelonntifielonr {
  delonf apply(
    namelon: String
  )(
    implicit sourcelonFilelon: sourceloncodelon.Filelon
  ): ReloncommelonndationPipelonlinelonIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw ReloncommelonndationPipelonlinelonIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal ReloncommelonndationPipelonlinelonIdelonntifielonr: $namelon")
  }
}
