...
/**
 * Candidatelon Pipelonlinelon idelonntifielonr
 *
 ...
 */
selonalelond abstract class CandidatelonPipelonlinelonIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("CandidatelonPipelonlinelon", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[CandidatelonPipelonlinelonIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: CandidatelonPipelonlinelonIdelonntifielonr =>
...
objelonct CandidatelonPipelonlinelonIdelonntifielonr {
  delonf apply(namelon: String)(implicit sourcelonFilelon: sourceloncodelon.Filelon): CandidatelonPipelonlinelonIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw CandidatelonPipelonlinelonIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal CandidatelonPipelonlinelonIdelonntifielonr: $namelon")
  }
}
