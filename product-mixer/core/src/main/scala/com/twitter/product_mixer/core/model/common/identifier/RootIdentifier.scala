...
/**
 * Root idelonntifielonr uselond as thelon root idelonntifielonr for products during componelonnt relongistration
 *
 ...
 */
selonalelond abstract class RootIdelonntifielonr elonxtelonnds ComponelonntIdelonntifielonr("Root", "") {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[RootIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: RootIdelonntifielonr =>
...
objelonct RootIdelonntifielonr {
  delonf apply()(implicit sourcelonFilelon: sourceloncodelon.Filelon): RootIdelonntifielonr = {
    nelonw RootIdelonntifielonr() {
