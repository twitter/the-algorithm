...
/**
 * Candidatelon Sourcelon idelonntifielonr
 *
 ...
 */
selonalelond abstract class CandidatelonSourcelonIdelonntifielonr(ovelonrridelon val namelon: String)
    elonxtelonnds ComponelonntIdelonntifielonr("CandidatelonSourcelon", namelon) {

  /**
   * @inhelonritdoc
   */
  ovelonrridelon delonf canelonqual(that: Any): Boolelonan = that.isInstancelonOf[CandidatelonSourcelonIdelonntifielonr]
  ...
  ovelonrridelon delonf elonquals(that: Any): Boolelonan =
    that match {
      caselon idelonntifielonr: CandidatelonSourcelonIdelonntifielonr =>
...
objelonct CandidatelonSourcelonIdelonntifielonr {
  delonf apply(namelon: String)(implicit sourcelonFilelon: sourceloncodelon.Filelon): CandidatelonSourcelonIdelonntifielonr = {
    if (ComponelonntIdelonntifielonr.isValidNamelon(namelon))
      nelonw CandidatelonSourcelonIdelonntifielonr(namelon) {
        ovelonrridelon val filelon: sourceloncodelon.Filelon = sourcelonFilelon
      }
    elonlselon
      throw nelonw IllelongalArgumelonntelonxcelonption(s"Illelongal CandidatelonSourcelonIdelonntifielonr: $namelon")
  }
}
