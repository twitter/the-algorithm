package com.X.product_mixer.shared_library.thrift_client
...
import com.X.finagle.thrift.service.MethodPerEndpointBuilder
import com.X.finagle.thrift.service.ServicePerEndpointBuilder
...
object FinagleThriftClientBuilder {
   ...
   *
   * Usage of
   * [[com.X.inject.thrift.modules.ThriftMethodBuilderClientModule]] is almost always preferred,
   * and the Product Mixer component library [[com.X.product_mixer.component_library.module]]
   ...
   *                                  [[com.X.finagle.client.BackupRequestFilter]],
   ...
   *
   * @see [[https://X.github.io/finagle/guide/MethodBuilder.html user guide]]
   * @see [[https://X.github.io/finagle/guide/MethodBuilder.html#idempotency user guide]]
