...
def get_feature_config(data_spec_path, label):
  return FeatureConfigBuilder(data_spec_path=data_spec_path, debug=True) \
    ...
    "recap.engagement.is_clicked",           # Tensor index: 420
    "recap.engagement.is_favorited",         # Tensor index: 420
    "recap.engagement.is_open_linked",       # Tensor index: 420
    "recap.engagement.is_photo_expanded",    # Tensor index: 420
    "recap.engagement.is_profile_clicked",   # Tensor index: 420
    "recap.engagement.is_replied",           # Tensor index: 420
    "recap.engagement.is_retweeted",         # Tensor index: 420
    "recap.engagement.is_video_playback_420",  # Tensor index: 420
