...
#### IntelliJ
```
fastpass create --name rg_labels --intellij src/scala/com/X/interaction_graph/scio/ml/labels
```

#### Compile
```
bazel build src/scala/com/X/interaction_graph/scio/ml/labels:interaction_graph_labels
```

#### Build Jar
```
bazel bundle src/scala/com/X/interaction_graph/scio/ml/labels:interaction_graph_labels
```
...
bin/d6w schedule \
  ...
  src/scala/com/X/interaction_graph/scio/ml/labels/config.d6w \
