...
#### IntelliJ
```
fastpass create --name rg_neg --intellij src/scala/com/X/interaction_graph/scio/agg_negative
```

#### Compile
```
bazel build src/scala/com/X/interaction_graph/scio/agg_negative:interaction_graph_negative_scio
```

#### Build Jar
```
bazel bundle src/scala/com/X/interaction_graph/scio/agg_negative:interaction_graph_negative_scio
```
...
bin/d6w schedule \
  ...
  src/scala/com/X/interaction_graph/scio/agg_negative/config.d6w \
