...
#### IntelliJ
```
fastpass create --name rg_labels --intellij src/scala/com/X/interaction_graph/scio/agg_notifications
```

#### Compile
```
bazel build src/scala/com/X/interaction_graph/scio/agg_notifications:interaction_graph_notifications_scio
```

#### Build Jar
```
bazel bundle src/scala/com/X/interaction_graph/scio/agg_notifications:interaction_graph_notifications_scio
```
...
bin/d6w schedule \
  ...
  src/scala/com/X/interaction_graph/scio/agg_notifications/config.d6w \
