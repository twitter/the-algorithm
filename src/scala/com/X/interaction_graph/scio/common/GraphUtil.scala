...
import com.X.socialgraph.presto.thriftscala.{Edge => SocialGraphEdge}
import com.X.flockdb.tools.datasets.flock.thriftscala.FlockEdge
import com.X.interaction_graph.scio.common.FeatureGroups.HEALTH_FEATURE_LIST
...
object GraphUtil {
  ...
  /**
   * Convert com.X.socialgraph.presto.thriftscala.Edge (from unfollows) into common InteractionGraphRawInput class.
   * updatedAt field in socialgraph.unfollows is in seconds.
   */
