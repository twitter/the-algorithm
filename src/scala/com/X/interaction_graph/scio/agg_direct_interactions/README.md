...
#### IntelliJ
```
./bazel idea src/scala/com/X/interaction_graph/scio/agg_direct_interactions:interaction_graph_agg_direct_interactions_scio
```

#### Compile
```
./bazel build src/scala/com/X/interaction_graph/scio/agg_direct_interactions:interaction_graph_agg_direct_interactions_scio
```

#### Build Jar
```
./bazel bundle src/scala/com/X/interaction_graph/scio/agg_direct_interactions:interaction_graph_agg_direct_interactions_scio
```
...
bin/d6w schedule \
  ...
  src/scala/com/X/interaction_graph/scio/agg_direct_interactions/config.d6w \
