...
#### IntelliJ
```
./bazel idea src/scala/com/X/interaction_graph/scio/agg_client_event_logs:interaction_graph_client_event_logs_scio
```

#### Compile
```
./bazel build src/scala/com/X/interaction_graph/scio/agg_client_event_logs:interaction_graph_client_event_logs_scio
```

#### Build Jar
```
./bazel bundle src/scala/com/X/interaction_graph/scio/agg_client_event_logs:interaction_graph_client_event_logs_scio
```
...
bin/d6w schedule \
  ...
  src/scala/com/X/interaction_graph/scio/agg_client_event_logs/config.d6w \
