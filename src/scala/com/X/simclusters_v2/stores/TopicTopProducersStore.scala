...
import com.X.recos.entities.thriftscala.{SemanticCoreEntityWithLocale, UserScoreList}
import com.X.storage.client.manhattan.kv.ManhattanKVClientMtlsParams
import com.X.storehaus.ReadableStore
import com.X.storehaus_internal.manhattan.{Athena, ManhattanRO, ManhattanROConfig}
