package com.X.simclusters_v2.scio.bq_generation.simclusters_index_generation
...
object Config {
  ...
  val simclustersEngagementBasedIndexGenerationSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/engagement_based_index_generation.sql"
  val unifiedUserTweetActionPairGenerationSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/unified_user_tweet_action_pair_generation.sql"
  val combinedUserTweetActionPairGenerationSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/combined_user_tweet_action_pair_generation.sql"
  val adsUserTweetActionPairGenerationSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/ads_user_tweet_action_pair_generation.sql"
  val evergreenContentUserTweetActionPairGenerationSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/evergreen_content_user_tweet_action_pair_generation.sql"
  val favBasedVideoTweetActionPairGenerationSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/user_video_tweet_fav_engagement_generation.sql"
