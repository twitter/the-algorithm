...
import com.X.algebird_internal.thriftscala.DecayedValue
  ...
  def parseTopKTweetsForClusterKeyColumn(
    ...
    val tweetIdToScoresMap = tweetScorePairs.asScala
      .map((gr: GenericRecord) => {
        ...
        // Ref: https://github.com/X/algebird/blob/develop/algebird-core/src/main/scala/com/X/algebird/DecayedValue.scala
        val scaledTime =
