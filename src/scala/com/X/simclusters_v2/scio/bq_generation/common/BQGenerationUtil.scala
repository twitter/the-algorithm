...
object BQGenerationUtil {
  ...
  val TweetFavCountSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/tweet_fav_count.sql"

  val NSFWTweetIdDenylistSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/nsfw_tweet_denylist.sql"

  val ClusterTopTweetsIntersectionWithFavBasedIndexSQLPath =
    s"/com/X/simclusters_v2/scio/bq_generation/sql/cluster_top_tweets_intersection_with_fav_based_index.sql"
