...
import com.X.simclusters_v2.hdfs_sources.RightNodeCosineSimilarityScioScalaDataset
import com.X.simclusters_v2.thriftscala.RightNode
import com.X.simclusters_v2.thriftscala.SimilarRightNodes
import com.X.wtf.scalding.jobs.cosine_similarity.common.ApproximateMatrixSelfTransposeMultiplicationJob

/**
Build:
./bazel bundle src/scala/com/X/simclusters_v2/scio/multi_type_graph/multi_type_graph_sims:multi-type-graph-cosine-similarity-scio-adhoc-app

To kick off an adhoc run:
bin/d6w create \
  ${GCP_PROJECT_NAME}/us-central1/multi-type-graph-cosine-similarity-scio-adhoc-app \
  src/scala/com/X/simclusters_v2/scio/multi_type_graph/multi_type_graph_sims/cosine-similarity-scio-adhoc.d6w \
...
bin/d6w schedule \
  ...
  src/scala/com/X/simclusters_v2/scio/multi_type_graph/multi_type_graph_sims/cosine-similarity-scio-batch.d6w \
  --bind=profile.project=${GCP_PROJECT_NAME} \
