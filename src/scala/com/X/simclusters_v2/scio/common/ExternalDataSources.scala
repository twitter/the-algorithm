package com.X.simclusters_v2.scio.common
...
import com.X.simclusters_v2.scalding.embedding.common.ExternalDataSources.ValidFlockEdgeStateId
import com.X.simclusters_v2.scalding.embedding.common.ExternalDataSources.getStandardLanguageCode
...
object ExternalDataSources {
  ...
  def topicFollowGraphSource(
    ...
    // src/scala/com/X/simclusters_v2/scalding/embedding/common/ExternalDataSources.scala
