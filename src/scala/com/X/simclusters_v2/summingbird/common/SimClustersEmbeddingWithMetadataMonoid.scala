...
import com.X.algebird.{Monoid, OptionMonoid}
import com.X.simclusters_v2.common.SimClustersEmbedding
import com.X.simclusters_v2.summingbird.common.Monoids.TopKScoresUtils
...
class SimClustersEmbeddingWithMetadataMonoid(
  ...
  private val optionMaxMonoid =
    new OptionMonoid[Long]()(com.X.algebird.Max.maxSemigroup[Long])
