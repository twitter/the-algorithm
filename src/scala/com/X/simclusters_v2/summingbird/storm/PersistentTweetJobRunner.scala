package com.X.simclusters_v2.summingbird.storm
...
import com.X.simclusters_v2.summingbird.common.Monoids.PersistentSimClustersEmbeddingLongestL2NormMonoid
import com.X.simclusters_v2.summingbird.common.SimClustersProfile.AltSetting
...
import com.X.simclusters_v2.summingbird.stores.PersistentTweetEmbeddingStore.PersistentTweetEmbeddingId
import com.X.simclusters_v2.summingbird.stores.PersistentTweetEmbeddingStore
import com.X.simclusters_v2.summingbird.stores.TopKClustersForTweetKeyReadableStore
import com.X.simclusters_v2.summingbird.stores.TweetKey
import com.X.simclusters_v2.summingbird.stores.TweetStatusCountsStore
...
import com.X.storehaus.FutureCollector
import com.X.summingbird.online.option._
import com.X.summingbird.option._
...
import com.X.summingbird_internal.runner.common.SBRunConfig
import com.X.summingbird_internal.runner.storm.GenericRunner
import com.X.summingbird_internal.runner.storm.StormConfig
import com.X.tormenta_internal.spout.eventbus.SubscriberId
import com.X.tweetypie.thriftscala.StatusCounts
import com.X.wtf.summingbird.sources.storm.TimelineEventSource
import java.lang
...
object PersistentTweetStormJob {
  ...
  import com.X.simclusters_v2.summingbird.common.Implicits._
    ...
    new StormConfig {
      ...
      override def transformConfig(config: Map[String, AnyRef]): Map[String, AnyRef] = {
        ...
        super.transformConfig(config) ++ List(
          ...
          BTConfig.TOPOLOGY_TEAM_EMAIL -> "no-reply@X.com",
          ...
          BTConfig.TOPOLOGY_WORKER_CHILDOPTS -> List(
            ...
            "-Dcom.X.eventbus.client.zoneName=" + zone,
       ...
       * The list of available options: com.X.summingbird.online.option
       */
