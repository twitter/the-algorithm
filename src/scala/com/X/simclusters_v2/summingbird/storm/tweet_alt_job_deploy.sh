...
BASE_DIR="src/scala/com/X/simclusters_v2/summingbird"
...
heron submit "${AURORA_PATH}" "dist/${JAR_NAME}" com.X.simclusters_v2.summingbird.storm.TweetJobRunner --env "$ENV" --dc "$CLUSTER" --alt "alt" --usingLogFavScore
