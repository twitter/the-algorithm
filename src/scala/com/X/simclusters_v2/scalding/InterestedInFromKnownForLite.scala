...
import com.X.simclusters_v2.common.{ClusterId, ModelVersions, UserId}
...
trait InterestedInFromKnownForLite extends XScheduledExecutionApp {
 ...
 *
 * scalding remote run \
 * --target src/scala/com/X/simclusters_v2/scalding:interested_in_lite_20m_145k_2020-adhoc \
 * --main-class com.X.simclusters_v2.scalding.InterestedInFromKnownForLite20M145K2020Adhoc \
