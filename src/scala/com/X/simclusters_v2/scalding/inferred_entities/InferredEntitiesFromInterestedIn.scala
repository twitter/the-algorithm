...
import com.X.simclusters_v2.common.UTTEntityId
...
import com.X.simclusters_v2.thriftscala.EntitySource
import com.X.simclusters_v2.thriftscala.InferredEntity
import com.X.simclusters_v2.thriftscala.SemanticCoreEntityWithScore
import com.X.simclusters_v2.thriftscala.SimClustersInferredEntities
import com.X.simclusters_v2.thriftscala.SimClustersSource
...
import com.X.wtf.entity_real_graph.scalding.common.SemanticCoreFilters.getValidSemanticCoreEntities
import com.X.wtf.entity_real_graph.scalding.common.DataSources
...
./bazel bundle src/scala/com/X/simclusters_v2/scalding/inferred_entities/ &&\
scalding remote run \
  --main-class com.X.simclusters_v2.scalding.inferred_entities.InferredInterestedInSemanticCoreEntitiesAdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/inferred_entities:inferred_entities_from_interested_in-adhoc \
  --user recos-platform \
  -- --date 2019-11-11 --email your_ldap@X.com
 */
...
./bazel bundle src/scala/com/X/simclusters_v2/scalding/inferred_entities/ &&\
scalding remote run \
  --main-class com.X.simclusters_v2.scalding.inferred_entities.InferredUTTEntitiesFromInterestedInAdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/inferred_entities:inferred_entities_from_interested_in-adhoc \
  --user recos-platform \
  -- --date 2019-11-03 --email your_ldap@X.com
 */
