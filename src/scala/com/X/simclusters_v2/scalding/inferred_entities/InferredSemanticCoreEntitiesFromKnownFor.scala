...
import com.X.wtf.entity_real_graph.scalding.common.{DataSources => ERGDataSources}
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/inferred_entities:inferred_entities_from_known_for-adhoc && \
 oscar hdfs --user recos-platform --screen --tee your_ldap-logs/ \
  --bundle inferred_entities_from_known_for-adhoc \
  --tool com.X.simclusters_v2.scalding.inferred_entities.InferredSemanticCoreEntitiesFromKnownForAdhocApp \
  -- --date 2019-11-02 --email your_ldap@X.com
 */
