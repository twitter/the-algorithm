...
import com.X.ads.entities.db.thriftscala.PromotedTweet
import com.X.dataproducts.estimation.ReservoirSampler
import com.X.scalding.typed.TypedPipe
import com.X.scalding.{DateRange, Execution, TypedTsv}
import com.X.scalding_internal.dalv2.DAL
import com.X.scalding_internal.dalv2.remote_access.{ExplicitLocation, Proc3Atla, ProcAtla}
import com.X.simclusters_v2.common.{SimClustersEmbedding, Timestamp, TweetId, UserId}
...
import com.X.timelineservice.thriftscala.{ContextualizedFavoriteEvent, FavoriteEventUnion}
import com.X.wtf.scalding.client_event_processing.thriftscala.{
  InteractionDetails,
  InteractionType,
