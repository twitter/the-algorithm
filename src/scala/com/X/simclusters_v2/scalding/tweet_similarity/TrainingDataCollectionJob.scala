...
import com.X.scalding_internal.dalv2.remote_access.Proc3Atla
import com.X.scalding_internal.job.XExecutionApp
import com.X.simclusters_v2.hdfs_sources.TweetSimilarityUnhydratedPairsSource
...
/** To run:
scalding remote run --target src/scala/com/X/simclusters_v2/scalding/tweet_similarity:training_data_collection-adhoc \
--user cassowary \
...
--main-class com.X.simclusters_v2.scalding.tweet_similarity.TrainingDataCollectionAdhocApp -- \
--date 2020-04-15 \
 ...
 * */
object TrainingDataCollectionAdhocApp extends XExecutionApp {
...
/**
  ...
  training_data_collection_30min src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
...
/**
capesospy-v2 update --build_locally --start_cron \
  training_data_collection_120min src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
