...
scalding remote run --target src/scala/com/X/simclusters_v2/scalding/tweet_similarity:model_eval-adhoc \
--user cassowary \
--submitter hadoopnest2.atla.X.com \
--main-class com.X.simclusters_v2.scalding.tweet_similarity.ModelEvalAdhocApp -- \
--date 2020-02-19 \
 ...
 **/
object ModelEvalAdhocApp extends XExecutionApp {
