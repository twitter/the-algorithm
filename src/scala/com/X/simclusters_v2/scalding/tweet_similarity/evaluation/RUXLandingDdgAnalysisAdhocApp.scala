package com.X.simclusters_v2.scalding.tweet_similarity.evaluation

import com.X.rux.landing_page.data_pipeline.LabeledRuxServiceScribeScalaDataset
import com.X.rux.landing_page.data_pipeline.thriftscala.LandingPageLabel
import com.X.rux.service.thriftscala.FocalObject
import com.X.rux.service.thriftscala.UserContext
...
import com.X.wtf.scalding.jobs.common.DDGUtil
import java.util.TimeZone

/** To run:
scalding remote run --target src/scala/com/X/simclusters_v2/scalding/tweet_similarity/evaluation:rux_landing_ddg_analysis-adhoc \
--user cassowary \
--submitter hadoopnest2.atla.X.com \
--main-class com.X.simclusters_v2.scalding.tweet_similarity.evaluation.RUXLandingDdgAnalysisAdhocApp -- \
--date 2020-04-06 2020-04-13 \
--ddg model_based_tweet_similarity_10254 \
--version 1 \
--output_path /user/cassowary/adhoc/ddg10254
 * */
object RUXLandingDdgAnalysisAdhocApp extends XExecutionApp {
