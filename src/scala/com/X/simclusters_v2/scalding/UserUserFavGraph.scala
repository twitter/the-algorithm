...
import com.X.simclusters_v2.thriftscala.DecayedSums
...
/**
 * ./bazel bundle src/scala/com/X/simclusters_v2/scalding:fav_graph_adhoc && \
 * oscar hdfs --user frigate --host hadoopnest1.atla.X.com --bundle fav_graph_adhoc \
 * --tool com.X.simclusters_v2.scalding.UserUserFavGraphAdhoc --screen --screen-detached \
 ...
 */
object UserUserFavGraphAdhoc extends XExecutionApp {
  implicit val tz: java.util.TimeZone = DateOps.UTC
...
/**
 * $ capesospy-v2 update --start_cron fav_graph src/scala/com/X/simclusters_v2/capesos_config/atla_proc.yaml
 */
object UserUserFavGraphBatch extends XScheduledExecutionApp {
...
object DumpFavGraphAdhoc extends XExecutionApp {
  implicit val tz: java.util.TimeZone = DateOps.UTC
