...
import com.X.scalding.{DateRange, Days, Stat, UniqueID}
...
import com.X.iesource.thriftscala.{InteractionEvent, InteractionType, ReferenceTweet}
import com.X.simclusters_v2.common.{Country, Language, TopicId, TweetId, UserId}
