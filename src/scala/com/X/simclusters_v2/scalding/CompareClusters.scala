...
import com.X.scalding.{DateOps, DateParser, Execution, Stat, TypedPipe, TypedTsv, UniqueID}
import com.X.scalding_internal.job.XExecutionApp
import com.X.simclusters_v2.common.{ClusterId, UserId}
...
object CompareClustersAdhoc extends XExecutionApp {
