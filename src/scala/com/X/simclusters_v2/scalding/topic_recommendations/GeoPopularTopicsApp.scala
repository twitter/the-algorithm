...
import com.X.scalding_internal.dalv2.remote_access.Proc2Atla
import com.X.scalding_internal.multiformat.format.keyval.KeyVal
import com.X.simclusters_v2.common.SemanticCoreEntityId
import com.X.simclusters_v2.hdfs_sources.GeopopularTopTweetImpressedTopicsScalaDataset
import com.X.timelines.per_topic_metrics.thriftscala.PerTopicAggregateEngagementMetric
...
/**
 scalding remote run \
 --target src/scala/com/X/simclusters_v2/scalding/topic_recommendations:geopopular_top_tweets_impressed_topics_adhoc \
 --main-class com.X.simclusters_v2.scalding.topic_recommendations.GeoPopularTopicsAdhocApp \
 --submitter  hadoopnest1.atla.X.com --user recos-platform \
 -- \
