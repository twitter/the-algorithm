package com.X.simclusters_v2.scalding.topic_recommendations.model_based_topic_recommendations
...
import com.X.scalding.source.DailySuffixCsv
import com.X.scalding.source.DailySuffixTypedTsv
import com.X.simclusters_v2.hdfs_sources.FavTfgTopicEmbeddingsScalaDataset
...
/*
To run:
scalding remote run --target src/scala/com/X/simclusters_v2/scalding/topic_recommendations/model_based_topic_recommendations:training_data_for_topic_recommendations-adhoc \
--user cassowary \
--submitter atla-aor-08-sr1 \
--main-class com.X.simclusters_v2.scalding.topic_recommendations.model_based_topic_recommendations.UserTopicFeatureHydrationAdhocApp \
