...
import com.X.recos.entities.thriftscala._
...
import com.X.simclusters_v2.hdfs_sources.DataSources
import com.X.simclusters_v2.hdfs_sources.TopLocaleTopicsForProducerFromEmScalaDataset
import com.X.simclusters_v2.scalding.common.matrix.SparseMatrix
import com.X.simclusters_v2.scalding.embedding.common.EmbeddingUtil.ProducerId
...
import com.X.wtf.scalding.jobs.common.EMRunner
...
scalding remote run --user cassowary --reducers 2000 \
 --target src/scala/com/X/simclusters_v2/scalding/topic_recommendations:top_topics_for_producers_from_em-adhoc \
 --main-class com.X.simclusters_v2.scalding.topic_recommendations.TopicsForProducersFromEMAdhocApp \
