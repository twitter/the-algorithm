package com.X.simclusters_v2.scalding.offline_job
...
import com.X.simclusters_v2.hdfs_sources.TweetClusterScoresHourlySuffixSource
import com.X.simclusters_v2.hdfs_sources.TweetTopKClustersHourlySuffixSource
import com.X.simclusters_v2.scalding.common.Util
import com.X.simclusters_v2.scalding.offline_job.SimClustersOfflineJob._
import com.X.simclusters_v2.thriftscala.ClustersUserIsInterestedIn
import java.util.TimeZone

/**
scalding remote run --target src/scala/com/X/simclusters_v2/scalding/offline_job:simclusters_offline_job-adhoc \
--user cassowary \
--submitter hadoopnest2.atla.X.com \
--main-class com.X.simclusters_v2.scalding.offline_job.SimClustersOfflineJobAdhocApp -- \
 ...
 */
object SimClustersOfflineJobAdhocApp extends XExecutionApp {
...
/**
For example:
scalding remote run --target src/scala/com/X/simclusters_v2/scalding/offline_job:dump_cluster_topk_job-adhoc \
--user cassowary
--main-class com.X.simclusters_v2.scalding.offline_job.DumpClusterTopKTweetsAdhoc \
--submitter hadoopnest2.atla.X.com -- \
--date 2019-08-03 \
 ...
 */
object DumpClusterTopKTweetsAdhoc extends XExecutionApp {

  implicit val timeZone: TimeZone = DateOps.UTC
  implicit val dateParser: DateParser = DateParser.default

  import com.X.simclusters_v2.scalding.common.TypedRichPipe._
  import com.X.simclusters_v2.summingbird.common.ThriftDecayedValueMonoid._
