...
import com.X.simclusters_v2.scalding.offline_job.SimClustersOfflineJobUtil._
import com.X.simclusters_v2.thriftscala.TweetAndClusterScores
 ...
 * --start_cron offline_tweet_job src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
