package com.X.simclusters_v2.scalding.offline_job.adhoc
...
import com.X.simclusters_v2.common.{ClusterId, CosineSimilarityUtil, TweetId}
import com.X.simclusters_v2.scalding.common.matrix.SparseRowMatrix
import com.X.simclusters_v2.scalding.offline_job.SimClustersOfflineJobUtil
 ...
 *
  scalding remote run \
     --target src/scala/com/X/simclusters_v2/scalding/offline_job/adhoc:tweet_embedding_evaluation_samples-adhoc \
     --user recos-platform \
     --reducers 1000 \
     --main-class com.X.simclusters_v2.scalding.offline_job.adhoc.TweetSimilarityEvaluationSamplingAdhocApp -- \
 ...
 *
  scalding remote run \
  --target src/scala/com/X/simclusters_v2/scalding/offline_job/adhoc:tweet_embedding_evaluation-adhoc \
  --user recos-platform \
  --reducers 1000 \
  --main-class com.X.simclusters_v2.scalding.offline_job.adhoc.TweetSimilarityEvaluationAdhocApp -- \
  --date 2021-01-27 \
