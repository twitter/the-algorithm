...
import com.X.simclusters_v2.common.{ClusterId, TweetId, UserId}
...
import com.X.simclusters_v2.summingbird.common.{Configs, SimClustersInterestedInUtil}
 ...
 * To run the job:
    scalding remote run \
    --target src/scala/com/X/simclusters_v2/scalding/offline_job/adhoc:tweet_embedding-adhoc \
    --user recos-platform \
    --reducers 1000 \
    --main-class com.X.simclusters_v2.scalding.offline_job.adhoc.SimClustersTweetEmbeddingAdhocApp -- \
