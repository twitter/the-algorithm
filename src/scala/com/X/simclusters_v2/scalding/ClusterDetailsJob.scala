...
import com.X.algebird.QTree
import com.X.algebird.QTreeSemigroup
...
import com.X.pluck.source.cassowary.SimsCandidatesSource
...
import com.X.scalding_internal.job.analytics_batch._
...
/**
 scalding remote run  --main-class com.X.simclusters_v2.scalding.ClusterDetailsAdhoc \
  --target src/scala/com/X/simclusters_v2/scalding:cluster_details-adhoc \
 ...
 */
object ClusterDetailsAdhoc extends XExecutionApp {
...
trait ClusterDetailsBatchTrait extends XScheduledExecutionApp {
...
/**
scalding remote run  --main-class com.X.simclusters_v2.scalding.DumpClusterDetailsAdhoc \
  --target src/scala/com/X/simclusters_v2/scalding:cluster_details-dump \
  --user recos-platform -- \
  --date 2020-06-25 \
  --clusterIds 5542 129677 48645 \
  --inputDir /user/recos-platform/adhoc/your_ldap/cluster_details_inferred_lang
 */
object DumpClusterDetailsAdhoc extends XExecutionApp {
  def job: Execution[Unit] =
    Execution.getConfigMode.flatMap {
      case (config, mode) =>
        Execution.withId { implicit uniqueId =>
...
/**
 * ./bazel bundle src/scala/com/X/simclusters_v2/scalding:cluster_details && \
 * oscar hdfs --user cassowary --host hadoopnest2.atla.X.com --bundle cluster_details \
 * --tool com.X.simclusters_v2.scalding.DumpClusterSimilaritiesAdhoc --screen --screen-detached \
 ...
 */
object DumpClusterSimilaritiesAdhoc extends XExecutionApp {
  def job: Execution[Unit] =
    Execution.getConfigMode.flatMap {
      case (config, mode) =>
        Execution.withId { implicit uniqueId =>
