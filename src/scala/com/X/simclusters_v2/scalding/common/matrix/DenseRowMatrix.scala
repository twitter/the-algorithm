package com.X.simclusters_v2.scalding.common.matrix

import com.X.algebird.{ArrayMonoid, BloomFilterMonoid, Monoid, Semigroup}
import com.X.algebird.Semigroup._
import com.X.bijection.Injection
import com.X.scalding.{TypedPipe, ValuePipe}
