...
import com.X.simclusters_v2.hdfs_sources.SimclustersV2InterestedInFromProducerEmbeddings20M145KUpdatedScalaDataset
 ...
 *
 scalding remote run \
  --target src/scala/com/X/simclusters_v2/scalding:interested_in_from_producer_embeddings \
  --main-class com.X.simclusters_v2.scalding.InterestedInFromProducerEmbeddingsAdhocApp \
