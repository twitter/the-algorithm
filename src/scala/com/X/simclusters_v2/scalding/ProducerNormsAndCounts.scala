...
object ProducerNormsAndCountsBatch extends XScheduledExecutionApp {
...
object ProducerNormsAndCountsAdhoc extends XExecutionApp {
...
object DumpNormsAndCountsAdhoc extends XExecutionApp {
  implicit val tz: java.util.TimeZone = DateOps.UTC
  def job: Execution[Unit] =
    Execution.getConfigMode.flatMap {
      case (config, mode) =>
