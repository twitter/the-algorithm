...
import com.X.simclusters_v2.hdfs_sources.TimelineDataExtractorFixedPathSource
import com.X.simclusters_v2.hdfs_sources._
import com.X.simclusters_v2.thriftscala.DisplayLocation
import com.X.simclusters_v2.thriftscala.ReferenceTweet
import com.X.simclusters_v2.thriftscala.ReferenceTweets
import com.X.simclusters_v2.thriftscala.TweetLabels
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures.IS_LINGER_IMPRESSION
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures.SOURCE_AUTHOR_ID
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures.SOURCE_TWEET_ID
import com.X.timelines.prediction.features.itl.ITLFeatures
 ...
 * A scheduled version of the job to parse Timelines data for impressed and engaged tweets.
 capesospy-v2 update|create --start_cron tweet_evaluation_timelines_reference_batch src/scala/com/X/simclusters_v2/capesos_config/atla_proc.yaml
 */
object ScheduledTimelinesDataExtractionBatch extends XScheduledExecutionApp {
 ...
 * on a particular day, or to generate human readable data for debugging.
 ./bazel bundle src/scala/com/X/simclusters_v2/scalding/evaluation:tweet_evaluation_timelines_reference_adhoc

 oscar hdfs --screen --user cassowary --bundle tweet_evaluation_timelines_reference_adhoc \
 --tool com.X.simclusters_v2.scalding.evaluation.AdhocTimelinesDataExtraction \
 -- --date 2018-11-15 --output_dir /user/cassowary/your_ldap/test_htl_data/recap --sample_rate 0.01 \
 --recap --rectweet --output_tsv
 */
object AdhocTimelinesDataExtraction extends XExecutionApp {
