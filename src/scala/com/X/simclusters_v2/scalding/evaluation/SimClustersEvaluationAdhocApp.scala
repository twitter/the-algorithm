...
import com.X.simclusters_v2.candidate_source.ClusterRanker
import com.X.simclusters_v2.hdfs_sources.AdhocKeyValSources
import com.X.simclusters_v2.hdfs_sources.ClusterTopKTweetsHourlySuffixSource
import com.X.simclusters_v2.hdfs_sources.SimclustersV2InterestedInScalaDataset
import com.X.simclusters_v2.hdfs_sources.TweetEvaluationTimelinesReferenceSetScalaDataset
import com.X.simclusters_v2.scalding.common.Util
import com.X.simclusters_v2.thriftscala.CandidateTweet
import com.X.simclusters_v2.thriftscala.CandidateTweets
import com.X.simclusters_v2.thriftscala.ClusterTopKTweetsWithScores
...
import com.X.simclusters_v2.scalding.offline_job.OfflineRecConfig
import com.X.simclusters_v2.scalding.offline_job.OfflineTweetRecommendation
...
./bazel bundle src/scala/com/X/simclusters_v2/scalding/evaluation:simcluster_offline_eval_adhoc
...
oscar hdfs --user cassowary --screen --screen-detached --tee your_ldap/prod_percentile \
 ...
 --tool com.X.simclusters_v2.scalding.evaluation.SimClustersEvaluationAdhocApp \
 ...
 --toEmailAddress your_ldap@X.com \
 --testRunName TestingProdOn0305Data
 */
object SimClustersEvaluationAdhocApp extends XExecutionApp {
