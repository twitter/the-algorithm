...
import com.X.bijection.{Bufferable, Injection}
import com.X.recos.entities.thriftscala.{Entity, SemanticCoreEntity}
import com.X.scalding.{DateRange, Days, Duration, Execution, RichDate, TypedPipe, UniqueID}
...
import com.X.simclusters_v2.hdfs_sources.{AdhocKeyValSources, EntityEmbeddingsSources}
import com.X.simclusters_v2.scalding.common.matrix.{SparseMatrix, SparseRowMatrix}
import com.X.simclusters_v2.scalding.embedding.common.EmbeddingUtil.ClusterId
import com.X.simclusters_v2.scalding.embedding.common.{
  EmbeddingUtil,
  ExternalDataSources,
...
import com.X.wtf.entity_real_graph.thriftscala.{Edge, FeatureName}
import com.X.wtf.scalding.jobs.common.{AdhocExecutionApp, DataSources, ScheduledExecutionApp}
 ...
 *
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:locale_entity_simclusters_embedding_v2
 * $ capesospy-v2 update \
  --build_locally \
  --start_cron locale_entity_simclusters_embedding_v2 src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
...
/**
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:locale_entity_simclusters_embedding_v2-adhoc
 *
 * $ scalding remote run \
  --main-class com.X.simclusters_v2.scalding.embedding.LocaleEntitySimClustersEmbeddingV2AdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/embedding:locale_entity_simclusters_embedding_v2-adhoc \
