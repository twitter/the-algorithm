package com.X.simclusters_v2.scalding.embedding

import com.X.dal.client.dataset.KeyValDALDataset
import com.X.recos.entities.thriftscala.Entity
import com.X.recos.entities.thriftscala.Hashtag
import com.X.recos.entities.thriftscala.SemanticCoreEntity
...
import com.X.simclusters_v2.hdfs_sources.presto_hdfs_sources._
import com.X.simclusters_v2.hdfs_sources.AdhocKeyValSources
import com.X.simclusters_v2.hdfs_sources.EntityEmbeddingsSources
import com.X.simclusters_v2.hdfs_sources.InterestedInSources
import com.X.simclusters_v2.scalding.embedding.LocaleEntitySimClustersEmbeddingsJob._
import com.X.simclusters_v2.scalding.embedding.common.EmbeddingUtil
import com.X.simclusters_v2.scalding.embedding.common.ExternalDataSources
import com.X.simclusters_v2.scalding.embedding.common.EmbeddingUtil._
import com.X.simclusters_v2.scalding.embedding.common.EntityEmbeddingUtil._
import com.X.simclusters_v2.scalding.embedding.common.SimClustersEmbeddingJob._
import com.X.simclusters_v2.thriftscala.{
  SimClustersEmbedding => ThriftSimClustersEmbedding,
  _
}
import com.X.wtf.entity_real_graph.common.EntityUtil
import com.X.wtf.entity_real_graph.thriftscala.Edge
import com.X.wtf.entity_real_graph.thriftscala.EntityType
import com.X.wtf.scalding.jobs.common.AdhocExecutionApp
import com.X.wtf.scalding.jobs.common.DataSources
import com.X.wtf.scalding.jobs.common.ScheduledExecutionApp
import java.util.TimeZone

/**
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:entity_per_language_embeddings_job-adhoc
 *
 * ---------------------- Deploy to atla ----------------------
 * $ scalding remote run \
  --main-class com.X.simclusters_v2.scalding.embedding.LocaleEntitySimClustersEmbeddingAdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/embedding:entity_per_language_embeddings_job-adhoc \
  --user recos-platform \
...
/**
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:semantic_core_entity_embeddings_per_language_job
 * $ capesospy-v2 update \
  --build_locally \
  --start_cron semantic_core_entity_embeddings_per_language_job src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
