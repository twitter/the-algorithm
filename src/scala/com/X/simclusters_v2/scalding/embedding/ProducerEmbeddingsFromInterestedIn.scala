 ...
 *
$ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:producer_embeddings_from_interested_in-adhoc

 $ scalding remote run \
 --main-class com.X.simclusters_v2.scalding.embedding.ProducerEmbeddingsFromInterestedInAdhocApp \
 --target src/scala/com/X/simclusters_v2/scalding/embedding:producer_embeddings_from_interested_in-adhoc \
