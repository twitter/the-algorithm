...
import com.X.scalding_internal.dalv2.dataset.DAL.DALSourceBuilderExtension
import com.X.scalding_internal.dalv2.remote_access.AllowCrossDC
import com.X.search.common.features.ExternalTweetFeature
import com.X.search.common.features.SearchContextFeature
import com.X.search.tweet_ranking.scalding.datasets.TweetEngagementRawTrainingDataDailyJavaDataset
import com.X.simclusters_v2.common.ClusterId
import com.X.simclusters_v2.hdfs_sources.AdhocAbuseSimclusterFeaturesScalaDataset
...
import com.X.simclusters_v2.scalding.embedding.abuse.DataSources.getUserInterestedInSparseMatrix
 ...
 * Example command:
 * scalding remote run \
 * --target src/scala/com/X/simclusters_v2/scalding/embedding/abuse:abuse-adhoc \
 * --main-class com.X.simclusters_v2.scalding.embedding.abuse.AdhocAbuseSimClusterFeaturesScaldingJob \
 * --submitter  hadoopnest1.atla.X.com --user cassowary \
