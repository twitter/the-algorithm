...
import com.X.scalding.source.TypedText
import com.X.scalding_internal.dalv2.DALWrite.{D, _}
import com.X.scalding_internal.multiformat.format.keyval.KeyVal
import com.X.simclusters_v2.hdfs_sources.SearchAbuseSimclusterFeaturesManhattanScalaDataset
import com.X.simclusters_v2.scalding.common.matrix.SparseMatrix
import com.X.simclusters_v2.scalding.embedding.abuse.AbuseSimclusterFeaturesScaldingJob.buildKeyValDataSet
import com.X.simclusters_v2.scalding.embedding.abuse.AdhocAbuseSimClusterFeaturesScaldingJob.{
...
import com.X.simclusters_v2.scalding.embedding.common.EmbeddingUtil.{ClusterId, UserId}
 ...
 *
 * scalding remote run \
 * --target src/scala/com/X/simclusters_v2/scalding/embedding/abuse:abuse-prod \
 * --main-class com.X.simclusters_v2.scalding.embedding.abuse.AdhocSearchAbuseSimclusterFeaturesScaldingJob \
 * --hadoop-properties "mapreduce.job.split.metainfo.maxsize=-1" \
 * --cluster bluebird-qus1 --submitter hadoopnest-bluebird-1.qus1.X.com \
