package com.X.simclusters_v2.scalding.embedding.abuse
...
import com.X.scalding.Years
import com.X.simclusters_v2.scalding.common.matrix.SparseMatrix
import com.X.simclusters_v2.scalding.embedding.abuse.DataSources.NumBlocksP95
import com.X.simclusters_v2.scalding.embedding.abuse.DataSources.getFlockBlocksSparseMatrix
import com.X.simclusters_v2.scalding.embedding.abuse.DataSources.getUserInterestedInTruncatedKMatrix
...
import com.X.simclusters_v2.thriftscala.AdhocCrossSimClusterInteractionScores
import com.X.simclusters_v2.thriftscala.ClustersScore
import com.X.simclusters_v2.thriftscala.ModelVersion
import com.X.wtf.scalding.jobs.common.AdhocExecutionApp
import com.X.wtf.scalding.jobs.common.CassowaryJob
import com.X.simclusters_v2.hdfs_sources.AdhocCrossSimclusterBlockInteractionFeaturesScalaDataset
import com.X.simclusters_v2.hdfs_sources.AdhocCrossSimclusterFavInteractionFeaturesScalaDataset
...
scalding remote run \
--user cassowary \
--submitter hadoopnest1.atla.X.com \
--target src/scala/com/X/simclusters_v2/scalding/embedding/abuse:cross_simcluster-adhoc \
--main-class com.X.simclusters_v2.scalding.embedding.abuse.CrossSimClusterFeaturesScaldingJob \
