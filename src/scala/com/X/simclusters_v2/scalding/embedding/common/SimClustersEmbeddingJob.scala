...
import com.X.scalding.{Args, DateRange, Execution, TypedPipe, UniqueID}
...
/**
 * This is the base job for computing SimClusters Embedding for any Noun Type on X, such as
