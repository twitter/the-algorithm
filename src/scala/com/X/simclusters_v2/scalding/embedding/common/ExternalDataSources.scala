package com.X.simclusters_v2.scalding.embedding.common

import com.X.algebird.Aggregator
import com.X.common.text.language.LocaleUtil
import com.X.escherbird.common.thriftscala.Locale
import com.X.escherbird.common.thriftscala.LocalizedUser
import com.X.escherbird.metadata.thriftscala.FullMetadata
import com.X.escherbird.scalding.source.FullMetadataSource
import com.X.escherbird.scalding.source.utt.UttSourceScalaDataset
import com.X.escherbird.utt.strato.thriftscala.SnapshotType
import com.X.escherbird.utt.thriftscala.UttEntityRecord
import com.X.interests_ds.jobs.interests_service.UserTopicRelationSnapshotScalaDataset
import com.X.interests.thriftscala.InterestRelationType
import com.X.interests.thriftscala.UserInterestsRelationSnapshot
import com.X.penguin.scalding.datasets.PenguinUserLanguagesScalaDataset
...
import com.X.scalding.ValuePipe
...
import com.X.simclusters_v2.common._
import com.X.simclusters_v2.hdfs_sources.SimclustersV2InterestedIn20M145KUpdatedScalaDataset
import com.X.simclusters_v2.hdfs_sources.UserUserFavGraphScalaDataset
import com.X.scalding_internal.dalv2.remote_access.AllowCrossDC
import com.X.common_header.thriftscala.CommonHeader
import com.X.common_header.thriftscala.IdType
import com.X.common_header.thriftscala.VersionedCommonHeader
...
import com.X.search.adaptive.scribing.thriftscala.AdaptiveSearchScribeLog
...
import com.X.frigate.data_pipeline.magicrecs.magicrecs_notifications_lite.thriftscala.MagicRecsNotificationLite
import com.X.simclusters_v2.thriftscala.ClustersUserIsInterestedIn
import com.X.simclusters_v2.thriftscala.EdgeWithDecayedWeights
...
import com.X.wtf.entity_real_graph.scalding.common.DatasetConstants
import com.X.wtf.entity_real_graph.scalding.common.SemanticCoreFilters
import com.X.wtf.scalding.client_event_processing.thriftscala.InteractionDetails
import com.X.wtf.scalding.client_event_processing.thriftscala.InteractionType
import com.X.wtf.scalding.client_event_processing.thriftscala.TweetImpressionDetails
import com.X.frigate.data_pipeline.scalding.magicrecs.magicrecs_notification_lite.MagicrecsNotificationLite1DayLagScalaDataset
...
import com.X.interests_ds.jobs.interests_service.UserInterestRelationSnapshotScalaDataset
import com.X.simclusters_v2.scalding.embedding.common.EmbeddingUtil.UserId
import com.X.scalding.typed.{ValuePipe => TypedValuePipe}
import com.X.tweetsource.common.thriftscala.UnhydratedTweet
...
object ExternalDataSources {
  ...
  def ieSourceTweetEngagementsSource(implicit dateRange: DateRange): TypedPipe[InteractionEvent] = {
    DAL
      .read(
        com.X.iesource.processing.events.batch.ServerEngagementsScalaDataset,
