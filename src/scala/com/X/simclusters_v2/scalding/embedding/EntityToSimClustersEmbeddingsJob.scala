...
import com.X.simclusters_v2.scalding.embedding.common.EntityEmbeddingUtil
import com.X.simclusters_v2.scalding.embedding.common.SimClustersEmbeddingJob
...
/**
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:entity_embeddings_job-adhoc
 *
 * ---------------------- Deploy to atla ----------------------
 * $ scalding remote run \
  --main-class com.X.simclusters_v2.scalding.embedding.EntityToSimClustersEmbeddingAdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/embedding:entity_embeddings_job-adhoc \
  --user recos-platform \
...
/**
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:semantic_core_entity_embeddings_2020_job
 * $ capesospy-v2 update \
  --build_locally \
  --start_cron semantic_core_entity_embeddings_2020_job src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
