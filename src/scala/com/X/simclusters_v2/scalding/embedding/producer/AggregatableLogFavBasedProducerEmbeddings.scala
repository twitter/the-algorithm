package com.X.simclusters_v2.scalding.embedding.producer
...
import com.X.wtf.scalding.jobs.common.{AdhocExecutionApp, ScheduledExecutionApp}
...
/**
 * Production job:
capesospy-v2 update aggregatable_producer_embeddings_by_logfav_score src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
...
/**
 * Production job:
capesospy-v2 update --build_locally --start_cron aggregatable_producer_embeddings_by_logfav_score_2020 src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
...
/**
 * Production job:
capesospy-v2 update --build_locally --start_cron aggregatable_producer_embeddings_by_logfav_score_relaxed_fav_engagement_threshold_2020 src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
...
--main-class com.X.simclusters_v2.scalding.embedding.producer.AggregatableLogFavBasedProducerEmbeddingsAdhocApp \
--target src/scala/com/X/simclusters_v2/scalding/embedding/producer:aggregatable_logfav_based_producer_embeddings_job-adhoc \
-- --date 2020-04-08
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/producer:aggregatable_logfav_based_producer_embeddings_job_2020-adhoc
scalding remote run \
--user cassowary \
--keytab /var/lib/tss/keys/fluffy/keytabs/client/cassowary.keytab \
--principal service_acoount@TWITTER.BIZ \
--cluster bluebird-qus1 \
--main-class com.X.simclusters_v2.scalding.embedding.producer.AggregatableLogFavBasedProducerEmbeddings2020AdhocApp \
--target src/scala/com/X/simclusters_v2/scalding/embedding/producer:aggregatable_logfav_based_producer_embeddings_job_2020-adhoc \
