...
import com.X.simclusters_v2.hdfs_sources.{DataSources, InterestedInSources}
import com.X.simclusters_v2.scalding.common.matrix.{SparseMatrix, SparseRowMatrix}
import com.X.simclusters_v2.scalding.embedding.ProducerEmbeddingsFromInterestedIn
import com.X.simclusters_v2.scalding.embedding.common.EmbeddingUtil.{
  ClusterId,
  ProducerId,
  UserId
}
import com.X.simclusters_v2.scalding.embedding.common.SimClustersEmbeddingBaseJob
