...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_inferred_lang_tfg_topic_embeddings-adhoc
 scalding remote run \
  --user cassowary \
  --keytab /var/lib/tss/keys/fluffy/keytabs/client/cassowary.keytab \
  --principal service_acoount@TWITTER.BIZ \
  --cluster bluebird-qus1 \
  --main-class com.X.simclusters_v2.scalding.embedding.tfg.FavInferredLanguageTfgBasedTopicEmbeddingsAdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_inferred_lang_tfg_topic_embeddings-adhoc \
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_inferred_lang_tfg_topic_embeddings
capesospy-v2 update --build_locally --start_cron fav_inferred_lang_tfg_topic_embeddings src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
