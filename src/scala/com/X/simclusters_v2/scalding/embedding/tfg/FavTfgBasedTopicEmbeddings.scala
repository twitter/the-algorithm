package com.X.simclusters_v2.scalding.embedding.tfg
...
import com.X.simclusters_v2.thriftscala.TfgTopicEmbeddings
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings-adhoc
 scalding remote run \
  --user cassowary \
  --keytab /var/lib/tss/keys/fluffy/keytabs/client/cassowary.keytab \
  --principal service_acoount@TWITTER.BIZ \
  --cluster bluebird-qus1 \
  --main-class com.X.simclusters_v2.scalding.embedding.tfg.FavTfgTopicEmbeddingsAdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings-adhoc \
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings
capesospy-v2 update --build_locally --start_cron fav_tfg_topic_embeddings src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings_2020-adhoc
 scalding remote run \
  --user cassowary \
  --keytab /var/lib/tss/keys/fluffy/keytabs/client/cassowary.keytab \
  --principal service_acoount@TWITTER.BIZ \
  --cluster bluebird-qus1 \
  --main-class com.X.simclusters_v2.scalding.embedding.tfg.FavTfgTopicEmbeddings2020AdhocApp \
  --target src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings_2020-adhoc \
  --hadoop-properties "scalding.with.reducers.set.explicitly=true mapreduce.job.reduces=4000" \
  -- --date 2020-12-08
 */
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings_2020
capesospy-v2 update --build_locally --start_cron fav_tfg_topic_embeddings_2020 src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
...
/**
./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings_2020_copy
scalding scalding remote run --target src/scala/com/X/simclusters_v2/scalding/embedding/tfg:fav_tfg_topic_embeddings_2020_copy
 */
