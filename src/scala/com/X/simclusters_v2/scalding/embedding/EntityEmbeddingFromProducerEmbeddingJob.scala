...
import com.X.onboarding.relevance.candidates.thriftscala.InterestBasedUserRecommendations
import com.X.onboarding.relevance.candidates.thriftscala.UTTInterest
import com.X.onboarding.relevance.source.UttAccountRecommendationsScalaDataset
...
import com.X.simclusters_v2.hdfs_sources.ProducerEmbeddingSources
import com.X.simclusters_v2.hdfs_sources.SemanticCoreEmbeddingsFromProducerScalaDataset
...
import com.X.simclusters_v2.thriftscala.SimClusterWithScore
...
import com.X.wtf.scalding.jobs.common.StatsUtil._
import java.util.TimeZone

/*
  $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:entity_embedding_from_producer_embedding-adhoc

  $ scalding remote run \
  --main-class com.X.simclusters_v2.scalding.embedding.EntityEmbeddingFromProducerEmbeddingAdhocJob \
  --target src/scala/com/X/simclusters_v2/scalding/embedding:entity_embedding_from_producer_embedding-adhoc \
  --user recos-platform \
...
/*
 $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding/embedding:entity_embedding_from_producer_embedding_job
 $ capesospy-v2 update \
  --build_locally \
  --start_cron entity_embedding_from_producer_embedding_job src/scala/com/X/simclusters_v2/capesos_config/atla_proc3.yaml
 */
