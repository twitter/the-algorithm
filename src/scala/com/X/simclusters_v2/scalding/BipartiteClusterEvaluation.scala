...
import com.X.simclusters_v2.hdfs_sources.NormsAndCountsFixedPathSource
import com.X.simclusters_v2.hdfs_sources.ProducerNormsAndCountsScalaDataset
...
import com.X.simclusters_v2.scalding.BipartiteClusterEvaluationClasses._
import com.X.simclusters_v2.scalding.common.TypedRichPipe._
import com.X.simclusters_v2.scalding.common.Util
import com.X.simclusters_v2.thriftscala.BipartiteClusterQuality
...
object BipartiteClusterEvaluation extends XExecutionApp {
  ...
  /**
   * ./bazel bundle src/scala/com/X/simclusters_v2/scalding:bp_cluster_evaluation && \
   * oscar hdfs --user frigate --host hadoopnest2.atla.X.com --bundle bp_cluster_evaluation \
   * --tool com.X.simclusters_v2.scalding.BipartiteClusterEvaluation --screen --screen-detached \
   ...
   * --toEmailAddress your_ldap@X.com --modelVersion 20M_145K_updated
   */
...
object DumpBpQuality extends XExecutionApp {
