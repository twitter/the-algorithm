...
import com.X.simclusters_v2.scalding.common.Util.Distribution
import com.X.simclusters_v2.thriftscala.ClusterQuality
import com.X.simclusters_v2.thriftscala.ClustersUserIsKnownFor
...
/**
 * ./bazel bundle src/scala/com/X/simclusters_v2/scalding:cluster_evaluation && \
 * oscar hdfs --user frigate --host hadoopnest1.atla.X.com --bundle cluster_evaluation \
 * --tool com.X.simclusters_v2.scalding.ClusterEvaluationAdhoc --screen --screen-detached \
 ...
 */
object ClusterEvaluationAdhoc extends XExecutionApp {
...
trait ClusterEvaluationBatch extends XScheduledExecutionApp {
  implicit val tz: java.util.TimeZone = DateOps.UTC
  implicit val dp = DateParser.default
  ...
  val emailAddress: String = "no-reply@X.com"
...
object ClusterEvaluationFor20M145K extends ClusterEvaluationBatch {
  ...
  override val batchDescription = "com.X.simclusters_v2.scalding.ClusterEvaluationFor20M145K"
...
object ClusterEvaluationFor20M145K2020 extends ClusterEvaluationBatch {
  ...
  override val batchDescription =
    "com.X.simclusters_v2.scalding.ClusterEvaluationFor20M145K2020"
