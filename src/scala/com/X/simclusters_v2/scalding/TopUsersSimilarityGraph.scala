...
import com.X.algebird.Max
import com.X.algebird.Monoid
import com.X.bijection.scrooge.BinaryScalaCodec
import com.X.hermit.candidate.thriftscala.Candidate
import com.X.hermit.candidate.thriftscala.Candidates
import com.X.logging.Logger
import com.X.pluck.source.cassowary.FollowingsCosineSimilaritiesManhattanSource
import com.X.sbf.core.AlgorithmConfig
import com.X.sbf.core.MHAlgorithm
import com.X.sbf.core.PredictionStat
import com.X.sbf.core.SparseBinaryMatrix
import com.X.sbf.core.SparseRealMatrix
import com.X.sbf.graph.Graph
...
import com.X.scalding_internal.source.lzo_scrooge.FixedPathLzoScrooge
import com.X.simclusters_v2.scalding.common.TypedRichPipe._
...
import com.X.wtf.scalding.sims.thriftscala.SimilarUserPair
...
/**
 * ./bazel bundle src/scala/com/X/simclusters_v2/scalding:top_users_only && \
 * oscar hdfs --hadoop-client-memory 120000 --user cassowary --host atla-aor-08-sr1 \
 * --bundle top_users_only --tool com.X.simclusters_v2.scalding.ClusterHdfsGraphApp \
 ...
 */
object ClusterHdfsGraphApp extends XExecutionApp {
 ...
 * --bundle top_users_only --tool com.X.simclusters_v2.scalding.ScalableTopUsersSimilarityGraphApp \
 ...
 */
object ScalableTopUsersSimilarityGraphApp extends XExecutionApp {
 ...
 *
 * 1. Get the top N most followed users on X
 ...
 *
 * Example invocation:
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding:top_users_similarity_graph && \
 * oscar hdfs --hadoop-client-memory 60000 --host atla-amw-03-sr1 --bundle top_users_similarity_graph \
 * --tool com.X.simclusters_v2.scalding.TopUsersSimilarityGraphApp \
 ...
 *
 */
object TopUsersSimilarityGraphApp extends XExecutionApp {
  implicit val tz: java.util.TimeZone = DateOps.UTC
  implicit val dp = DateParser.default
  val log = Logger()
...
/**
 * App that only outputs the topK users on X by active follower count. Example invocation:
 * $ ./bazel bundle src/scala/com/X/simclusters_v2/scalding:top_users_only && \
 * oscar hdfs --hadoop-client-memory 60000 --host atla-aor-08-sr1 --bundle top_users_only \
 * --tool com.X.simclusters_v2.scalding.TopUsersOnlyApp \
 ...
 * ./bazel bundle src/scala/com/X/simclusters_v2/scalding:top_users_only && \
 * oscar hdfs --hadoop-client-memory 60000 --user cassowary --host atla-aor-08-sr1 \
 * --bundle top_users_only --tool com.X.simclusters_v2.scalding.TopUsersOnlyApp \
 ...
 * --includeMappedIds
 */
object TopUsersOnlyApp extends XExecutionApp {
  implicit val tz: java.util.TimeZone = DateOps.UTC
  implicit val dp = DateParser.default
  val log = Logger()
