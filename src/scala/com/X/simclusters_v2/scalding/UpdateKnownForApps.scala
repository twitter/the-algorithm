...
import com.X.simclusters_v2.scalding.UpdateKnownFor.ClusterScoresForNode
import com.X.simclusters_v2.scalding.UpdateKnownFor.NeighborhoodInformation
...
trait UpdateKnownForBatch extends XScheduledExecutionApp {
...
object UpdateKnownFor20M145K extends UpdateKnownForBatch {
  ...
  override val batchDescription: String =
    "com.X.simclusters_v2.scalding.UpdateKnownFor20M145K"
...
object UpdateKnownForAdhoc extends XExecutionApp {
  implicit val tz: java.util.TimeZone = DateOps.UTC
  implicit val dp = DateParser.default
    ...
    Execution.getConfigMode.flatMap {
      case (config, mode) =>
        Execution.withId { implicit uniqueId =>
          ...
          val defaultEmailAddress = "your_ldap@X.com"
