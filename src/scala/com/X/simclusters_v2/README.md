# SimClusters: Community-based Representations for Heterogeneous Recommendations at X
...
All SimClusters related GCP jobs are under [src/scala/com/X/simclusters_v2/scio/bq_generation](scio/bq_generation).
