...
import com.X.timelines.data_processing.ml_util.aggregation_framework.AggregationConfig
...
trait TimelinesAggregationConfigTrait
   ...
   * [[com.X.timelines.data_processing.jobs.timeline_ranking_user_features.TimelineRankingAggregatesV2FeaturesProdJob]]
