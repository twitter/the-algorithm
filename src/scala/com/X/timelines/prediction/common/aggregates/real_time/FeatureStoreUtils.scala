...
import com.X.ml.featurestore.catalog.datasets.magicrecs.UserFeaturesDataset
import com.X.ml.featurestore.catalog.datasets.geo.GeoUserLocationDataset
import com.X.ml.featurestore.lib.dataset.DatasetParams
import com.X.ml.featurestore.lib.export.strato.FeatureStoreAppNames
import com.X.ml.featurestore.lib.online.FeatureStoreClient
import com.X.ml.featurestore.lib.params.FeatureStoreParams
import com.X.strato.client.{Client, Strato}
...
private[real_time] object FeatureStoreUtils {
  ...
  def mkFeatureStoreClient(
    ...
    com.X.server.Init() // necessary in order to use WilyNS path
