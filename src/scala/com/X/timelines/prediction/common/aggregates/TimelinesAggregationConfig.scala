...
import com.X.scalding_internal.multiformat.format.keyval
...
import com.X.timelines.data_processing.ml_util.aggregation_framework.OfflineAggregateDataRecordStore
...
object TimelinesAggregationConfig extends TimelinesAggregationConfigTrait {
  ...
  def storeToDatasetMap: Map[String, KeyValDALDataset[
    ...
    XWideUserAggregateStore -> XWideUserAggregatesScalaDataset,
    XWideUserAuthorAggregateStore -> XWideUserAuthorAggregatesScalaDataset,
