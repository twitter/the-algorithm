...
import com.X.timelines.data_processing.ml_util.aggregation_framework.heron.OnlineAggregationConfigTrait
import com.X.timelines.data_processing.ml_util.aggregation_framework.metrics.CountMetric
import com.X.timelines.data_processing.ml_util.aggregation_framework.metrics.SumMetric
import com.X.timelines.data_processing.ml_util.transforms.BinaryUnion
import com.X.timelines.data_processing.ml_util.transforms.DownsampleTransform
import com.X.timelines.data_processing.ml_util.transforms.IsNewUserTransform
import com.X.timelines.data_processing.ml_util.transforms.IsPositionTransform
import com.X.timelines.data_processing.ml_util.transforms.LogTransform
import com.X.timelines.data_processing.ml_util.transforms.PositionCase
import com.X.timelines.data_processing.ml_util.transforms.RichITransform
import com.X.timelines.data_processing.ml_util.transforms.RichRemoveUnverifiedUserTransform
import com.X.timelines.prediction.features.client_log_event.ClientLogEventDataRecordFeatures
import com.X.timelines.prediction.features.common.CombinedFeatures
import com.X.timelines.prediction.features.common.CombinedFeatures._
import com.X.timelines.prediction.features.common.ProfileLabelFeatures
import com.X.timelines.prediction.features.common.SearchLabelFeatures
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures.IS_TOP_FIVE
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures.IS_TOP_ONE
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures.IS_TOP_TEN
import com.X.timelines.prediction.features.common.TimelinesSharedFeatures.LOG_POSITION
import com.X.timelines.prediction.features.list_features.ListFeatures
...
trait TimelinesOnlineAggregationDefinitionsTrait extends OnlineAggregationConfigTrait {
  ...
  val ProdAggregateGroups = Set(
    ...
    addFeatureFilterFromResource(
      _,
      "com/X/timelines/prediction/common/aggregates/real_time/aggregates_to_drop.txt"))
