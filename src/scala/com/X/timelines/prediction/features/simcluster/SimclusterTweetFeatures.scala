package com.X.timelines.prediction.features.simcluster

import com.X.dal.personal_data.thriftjava.PersonalDataType._
import com.X.finagle.stats.StatsReceiver
import com.X.ml.api.{Feature, FeatureContext}
import com.X.ml.api.Feature.{Continuous, SparseBinary, SparseContinuous}
    ...
    simclustersMapOpt.flatMap { simclustersMap =>
      val filteredSimclustersMap = simclustersMap.filter {
        case (clusterId, score) =>
          ...
          // com.X.ml.featurestore.catalog.features.recommendations.SimClustersV2TweetTopClusters
