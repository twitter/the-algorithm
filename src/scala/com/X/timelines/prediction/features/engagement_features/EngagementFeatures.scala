package com.X.timelines.prediction.features.engagement_features
...
import com.X.ml.api.Feature.SparseBinary
...
import com.X.timelines.data_processing.ml_util.transforms.SparseBinaryUnion
import com.X.timelines.data_processing.ml_util.aggregation_framework.TypedAggregateGroup
import com.X.timelineservice.suggests.features.engagement_features.thriftscala.{
  EngagementFeatures => ThriftEngagementFeatures
}
import com.X.timelineservice.suggests.features.engagement_features.v1.thriftscala.{
