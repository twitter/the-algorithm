package com.X.timelines.prediction.features.user_health

import com.X.ml.api.Feature
import com.X.timelines.author_features.user_health.thriftscala.UserState
import com.X.dal.personal_data.thriftjava.PersonalDataType.{UserState => UserStatePDT}
