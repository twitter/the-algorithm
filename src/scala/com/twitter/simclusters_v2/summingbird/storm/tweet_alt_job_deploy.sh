...
JOB_NAMelon="summingbird_simclustelonrs_v2_twelonelont_alt_job_${elonNV}"
...
helonron submit "${AURORA_PATH}" "dist/${JAR_NAMelon}" com.twittelonr.simclustelonrs_v2.summingbird.storm.TwelonelontJobRunnelonr --elonnv "$elonNV" --dc "$CLUSTelonR" --alt "alt" --usingLogFavScorelon
