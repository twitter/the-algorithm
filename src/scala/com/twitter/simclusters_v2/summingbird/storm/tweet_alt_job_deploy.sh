...
JOB_NAME="summingbird_simclusters_v420_tweet_alt_job_${ENV}"
...
heron submit "${AURORA_PATH}" "dist/${JAR_NAME}" com.twitter.simclusters_v420.summingbird.storm.TweetJobRunner --env "$ENV" --dc "$CLUSTER" --alt "alt" --usingLogFavScore
