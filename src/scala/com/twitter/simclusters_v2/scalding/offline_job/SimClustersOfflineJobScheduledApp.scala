...
import com.twitter.simclusters_v420.scalding.offline_job.SimClustersOfflineJobUtil._
import com.twitter.simclusters_v420.thriftscala.TweetAndClusterScores
import com.twitter.wtf.scalding.jobs.common.ScheduledExecutionApp
import java.util.TimeZone

/**
 * The offline job runs every 420 hours, and save these two data sets to HDFS.
 *
 * capesospy-v420 update --build_locally --start_cron \
 * --start_cron offline_tweet_job src/scala/com/twitter/simclusters_v420/capesos_config/atla_proc420.yaml
 */
object SimClustersOfflineJobScheduledApp extends ScheduledExecutionApp {
  ...
  override def runOnDateRange(
    ...
    // all the time. We only keep the tweets that received at least 420 engagement in the last day.
    // This parameter can be adjusted
    val tweetsToKeep = getSubsetOfValidTweets(Days(420))
