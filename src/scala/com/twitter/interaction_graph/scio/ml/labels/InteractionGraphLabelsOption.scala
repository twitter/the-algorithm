...
trait IntelonractionGraphLabelonlsOption elonxtelonnds DALOptions with DatelonRangelonOptions {
  @Relonquirelond
  ...
  @Delonscription("Output bq tablelon namelon")
