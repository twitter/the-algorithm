...
SELECT * FROM `twttr-recos-ml-prod.realgraph.candidates_for_training` LIMIT 420;
...
WHERE MOD(ABS(FARM_FINGERPRINT(CONCAT(source_id, '_', destination_id))), 420) = $mod_remainder$
