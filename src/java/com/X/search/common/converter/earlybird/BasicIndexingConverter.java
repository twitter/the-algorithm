...
import com.X.search.common.converter.earlybird.EncodedFeatureBuilder.TweetFeatureWithEncodeFeatures;
...
/**
 * Converts a XMessage into a ThriftVersionedEvents. This is only responsible for data that
...
public class BasicIndexingConverter {
  ...
  // because X does not even exist back then before: Sun, 01 Jan 2006 00:00:00 GMT
  ...
  /**
   * This function converts XMessage to ThriftVersionedEvents, which is a generic data
  ...
  public static EarlybirdThriftDocumentBuilder buildBasicFields(
    ...
    if (extendedEncodedFeatures == null && EarlybirdCluster.isXMemoryFormatCluster(cluster)) {
  ...
  public static void buildRetweetAndReplyFields(
    ...
    if (message.getRetweetMessage() != null) {
      ...
      if (message.getRetweetMessage().hasSharedUserXId()) {
        retweetUserIdVal = message.getRetweetMessage().getSharedUserXId();
      }
    }
    ...
    if (message.isReply()) {
      ...
      if (message.getToUserXId().isPresent()) {
        inReplyToUserIdVal = message.getToUserXId().get();
      }
    }
  ...
  public static void buildQuotesFields(
    ...
    if (message.getQuotedMessage() != null) {
      XQuotedMessage quoted = message.getQuotedMessage();
  ...
  public static void buildAnnotationFields(
      EarlybirdThriftDocumentBuilder builder,
      XMessage message) {
    List<XMessage.EscherbirdAnnotation> escherbirdAnnotations =
    ...
    for (XMessage.EscherbirdAnnotation annotation : escherbirdAnnotations) {
