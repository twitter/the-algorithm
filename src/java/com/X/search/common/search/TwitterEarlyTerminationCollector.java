...
/**
 * A XCollector containing the most common early termination logic based on
 ...
 * as a wrapper.
 */
public abstract class XEarlyTerminationCollector
    extends XCollector implements LeafCollector {
  private static final Logger LOG = LoggerFactory.getLogger(XEarlyTerminationCollector.class);
  private static final SearchCounter NEGATIVE_TIME_PER_SEGMENT =
      SearchCounter.export("XEarlyTerminationCollector_negative_time_per_segment");
  private static final SearchRateCounter QUERY_TIMEOUT_ENFORCED =
      SearchRateCounter.export("XEarlyTerminationCollector_query_timeout_enforced");
  ...
  /**
   * Creates a new XEarlyTerminationCollector instance.
   *
   ...
   */
  public XEarlyTerminationCollector(
