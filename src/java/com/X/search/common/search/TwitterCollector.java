 ...
 * this class to be a base of all X Collectors.
 *
 * {@link com.X.search.common.search.XIndexSearcher} uses the {@link #isTerminated()}
 * method to perform early termination, instead of relying on CollectionTerminatedException.
 */
public abstract class XCollector implements Collector {
