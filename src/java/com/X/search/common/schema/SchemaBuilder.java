package com.X.search.common.schema;
...
import com.X.common.text.util.CharSequenceTermAttributeSerializer;
import com.X.common.text.util.PositionIncrementAttributeSerializer;
import com.X.common.text.util.TokenStreamSerializer;
import com.X.common.text.util.TokenTypeAttributeSerializer;
import com.X.search.common.schema.base.FeatureConfiguration;
import com.X.search.common.schema.base.FieldNameToIdMapping;
import com.X.search.common.schema.thriftjava.ThriftCSFFieldSettings;
import com.X.search.common.schema.thriftjava.ThriftCSFType;
import com.X.search.common.schema.thriftjava.ThriftCSFViewSettings;
import com.X.search.common.schema.thriftjava.ThriftFacetFieldSettings;
import com.X.search.common.schema.thriftjava.ThriftFeatureNormalizationType;
...
import com.X.search.common.schema.thriftjava.ThriftFixedLengthCSFSettings;
import com.X.search.common.schema.thriftjava.ThriftIndexOptions;
import com.X.search.common.schema.thriftjava.ThriftIndexedFieldSettings;
...
import com.X.search.common.schema.thriftjava.ThriftSearchFieldSettings;
...
import com.X.search.common.util.analysis.IntTermAttributeSerializer;
import com.X.search.common.util.analysis.LongTermAttributeSerializer;
import com.X.search.common.util.analysis.PayloadAttributeSerializer;
...
public class SchemaBuilder {
   ...
   * {@link com.X.search.common.util.text.TweetTokenStreamSerializer}.
   */
   ...
   * {@link com.X.search.common.util.analysis.PayloadWeightedTokenizer} to store weighted
   * values.
   *
   ...
   * {@link com.X.search.common.util.analysis.PayloadWeightedTokenizer}.
   */
   ...
   * attributes defined in {@link com.X.search.common.util.text.TweetTokenStreamSerializer}.
   */
