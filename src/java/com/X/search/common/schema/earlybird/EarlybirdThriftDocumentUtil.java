...
import com.X.search.common.util.analysis.XNormalizedMinEngagementTokenStream;
...
public final class EarlybirdThriftDocumentUtil {
  ...
  public static void addNormalizedMinEngagementField(
    ...
    XNormalizedMinEngagementTokenStream stream = new
        XNormalizedMinEngagementTokenStream(normalizedNumEngagements);
