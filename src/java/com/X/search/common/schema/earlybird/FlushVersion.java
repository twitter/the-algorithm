...
public enum FlushVersion {
  ...
  VERSION_39("Fix pic.X.com image link handling not setting the internal field correctly."),
  ...
  VERSION_63("Switch to new index API in com.X.search.core.earlybird.", true),
   ...
   * @deprecated Please use {@link com.X.search.common.schema.base.Schema#getVersionDescription()}
   */
  @Deprecated
   ...
   * @deprecated Please use {@link com.X.search.common.schema.base.Schema#getMajorVersionNumber()}.
   */
  @Deprecated
   ...
   * @deprecated Please use {@link com.X.search.common.schema.base.Schema#isVersionOfficial()}.
   */
  @Deprecated
