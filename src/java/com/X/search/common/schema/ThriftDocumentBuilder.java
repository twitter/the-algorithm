...
import com.X.search.common.util.analysis.LongTermsTokenStream;
import com.X.search.common.util.analysis.PayloadAttributeSerializer;
import com.X.search.common.util.analysis.PayloadWeightedTokenizer;
...
public class ThriftDocumentBuilder {
   ...
   * The Lucene TokenStream is serialized using X's
   * {@link com.X.common.text.util.TokenStreamSerializer}
   */
   ...
   * See {@link com.X.search.common.util.analysis.PayloadWeightedTokenizer} for more details.
   */
