...
import com.X.common.text.transformer.RegexTransformer;
import com.X.common.text.transformer.RtRemovalTransformer;
import com.X.common.text.transformer.Transformer;
import com.X.common.text.transformer.TransformerChain;
import com.X.common_internal.text.duplicate.RandomSubstringExtractor;
import com.X.common_internal.text.duplicate.SignatureGenerator;
...
public class TweetQualityFeatureExtractor {
  private static final Transformer STATUS_TEXT_CLEANER =
      TransformerChain.of(
          // remove @reply as defined in X-text
  ...
  /**
   * Given XMessage, extract all interesting tweet text features and store in
   * the returned TweetTextFeatures object.
   *
   * @param tweet XMessage to extract features from
   * @throws IOException
   */
  public void extractTweetTextFeatures(final XMessage tweet) {
