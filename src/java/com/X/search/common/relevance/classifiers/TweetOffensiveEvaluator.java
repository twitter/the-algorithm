...
import com.X.common.text.token.attribute.TokenType;
import com.X.common.util.Clock;
import com.X.common_internal.text.pipeline.XNgramGenerator;
import com.X.common_internal.text.topic.BlacklistedTopics;
import com.X.common_internal.text.topic.BlacklistedTopics.FilterMode;
...
import com.X.search.common.util.io.periodic.PeriodicFileLoader;
...
public class TweetOffensiveEvaluator extends TweetEvaluator {
  ...
  private static final ThreadLocal<XNgramGenerator> NGRAM_GENERATOR_HOLDER =
      new ThreadLocal<XNgramGenerator>() {
        @Override
        protected XNgramGenerator initialValue() {
          ...
          return new XNgramGenerator.Builder(PenguinVersion.PENGUIN_6)
  ...
  @Override
  public void evaluate(final XMessage tweet) {
  ...
  private boolean isTweetOffensive(final XMessage tweet,
