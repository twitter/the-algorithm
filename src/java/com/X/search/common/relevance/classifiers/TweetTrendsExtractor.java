...
import com.X.search.common.relevance.NGramCache;
import com.X.search.common.relevance.TrendsThriftDataServiceManager;
...
public class TweetTrendsExtractor {
   ...
   */
  public void extractTrends(XMessage tweet) {
   ...
   */
  public void extractTrends(Iterable<XMessage> tweets) {
  ...
  private void updateTrendsStats(XMessage tweet,
