...
/**
 * Compute a text score for XMessage based on its offensiveness,
...
public class TweetTextScorer extends TweetScorer {
  ...
  public void scoreTweet(final XMessage tweet) {
  ...
  private void updateStats(boolean isOffensiveText,
    ...
    if (XMessage.hasMultipleHashtagsOrTrends(textFeatures)) {
