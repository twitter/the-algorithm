...
import com.X.search.common.indexing.thriftjava.ThriftGeoTags;
...
public class GeoObject {
  ...
  public static Optional<GeoObject> fromPlace(Place place) {
    ...
    if (place.isSetBounding_box() && place.getBounding_boxSize() > 0) {
      ...
      if (pointsCount == 1) {
        ...
        // See e.g. birdherd/src/main/scala/com/X/birdherd/tweetypie/TweetyPiePlace.scala
  ...
  public ThriftGeoTags toThriftGeoTags(long XMessageId) {
    ThriftGeoTags geoTags = new ThriftGeoTags();
    geoTags.setStatusId(XMessageId);
