...
import com.X.search.common.encoding.features.SmartIntegerNormalizer;
...
public abstract class MutableFeatureNormalizers {
  ...
  // of engagements we see on X, anything larger than this would be represented as the same
