package com.X.search.common.util.earlybird;
...
import com.X.search.common.logging.DebugMessageBuilder;
import com.X.search.common.ranking.thriftjava.ThriftFacetFinalSortOrder;
...
import com.X.search.earlybird.thrift.ThriftFacetRankingMode;
  ...
  public static ThriftFacetCountMetadata mergeFacetMetadata(
    ...
    if (metadataUpdate != null) {
      ...
      if (userIDWhitelist != null) {
        ...
        if (mergedMetadata.getXUserId() != -1 && !mergedMetadata.isDontFilterUser()) {
          mergedMetadata.setDontFilterUser(
              userIDWhitelist.contains(mergedMetadata.getXUserId()));
        }
      }
    }
