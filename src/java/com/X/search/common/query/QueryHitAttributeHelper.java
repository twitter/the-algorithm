...
import com.X.search.queryparser.visitors.MultiTermDisjunctionRankVisitor;
import com.X.search.queryparser.visitors.NodeRankAnnotator;
...
public class QueryHitAttributeHelper extends HitAttributeHelper {
  ...
  /**
   * Constructor specific for com.X.search.queryParser.query.Query
   *
