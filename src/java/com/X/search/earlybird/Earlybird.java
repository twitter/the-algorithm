...
import com.X.search.common.config.Config;
...
import com.X.search.common.util.Kerberos;
import com.X.search.common.util.PlatformStatsExporter;
import com.X.search.earlybird.admin.EarlybirdAdminManager;
import com.X.search.earlybird.admin.EarlybirdHealthHandler;
...
import com.X.search.earlybird.exception.UncaughtExceptionHandler;
import com.X.search.earlybird.factory.EarlybirdServerFactory;
import com.X.search.earlybird.factory.EarlybirdWireModule;
import com.X.search.earlybird.thrift.EarlybirdService;
import com.X.search.earlybird.util.EarlybirdDecider;
import com.X.server.handler.DeciderHandler$;
import com.X.server.AbstractXServer;
import com.X.thriftwebforms.DisplaySettingsConfig;
import com.X.thriftwebforms.MethodOptionsAccessConfig;
import com.X.thriftwebforms.ThriftClientSettingsConfig;
import com.X.thriftwebforms.ThriftMethodSettingsConfig;
import com.X.thriftwebforms.ThriftServiceSettings;
import com.X.thriftwebforms.ThriftWebFormsSettings;
import com.X.thriftwebforms.XServerThriftWebForms;
import com.X.util.Await;
import com.X.util.TimeoutException;

public class Earlybird extends AbstractXServer {
  ...
  private void setupThriftWebForms() {
    XServerThriftWebForms.addAdminRoutes(this, XServerThriftWebForms.apply(
  ...
  void innerMain() throws TimeoutException, InterruptedException, EarlybirdStartupException {
    ...
    // If this method throws, XServer will catch the exception and call close, so we don't
    // catch it here.
    try {
