...
import com.X.search.earlybird.config.TierConfig;
import com.X.search.earlybird.exception.AlreadyInServerSetUpdateException;
import com.X.search.earlybird.exception.NotInServerSetUpdateException;
...
public class EarlybirdServerSetManager implements ServerSetMember {
  ...
  public void joinServerSet(String username) throws ServerSet.UpdateException {
    ...
    synchronized (endpointStatusLock) {
      ...
      try {
        XServerSet.Service service = getServerSetService();
  ...
  private XServerSet.Service getServerSetService() {
  ...
  public void joinServerSetForServiceProxy() {
    ...
    try {
      XServerSet.Service service = getServerSetForServiceProxyOnArchive();
  ...
  @VisibleForTesting
  protected XServerSet.Service getServerSetForServiceProxyOnArchive() {
