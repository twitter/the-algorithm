...
import com.X.search.common.util.date.DateUtil;
import com.X.search.common.util.io.EmptyRecordReader;
import com.X.search.common.util.io.LzoThriftBlockFileReader;
import com.X.search.common.util.io.MergingSortedRecordReader;
...
public class PartitionedBatch {
  ...
  public void load(FileSystem hdfs) throws IOException {
    ...
    if (dailyBatchFiles != null && dailyBatchFiles.length > 0) {
      ...
      // Partition folder does not exist. This case can happen for early days of X
