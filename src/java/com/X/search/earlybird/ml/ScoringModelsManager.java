package com.X.search.earlybird.ml;
...
import com.X.search.common.util.ml.prediction_engine.CompositeFeatureContext;
import com.X.search.common.util.ml.prediction_engine.LightweightLinearModel;
import com.X.search.common.util.ml.prediction_engine.ModelLoader;

import static com.X.search.modeling.tweet_ranking.TweetScoringFeatures.CONTEXT;
import static com.X.search.modeling.tweet_ranking.TweetScoringFeatures.FeatureContextVersion.CURRENT_VERSION;
...
public class ScoringModelsManager {
  ...
  public static ModelLoader createClasspathLoader(
    ...
    AbstractFile defaultModelsBaseDir = FileUtils.getTmpDirHandle(
        ...
        "/com/X/search/earlybird/ml/default_models");
