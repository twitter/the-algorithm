...
import com.X.search.common.util.io.flushable.PersistentFile;
import com.X.search.earlybird.archive.ArchiveSegment;
...
public class SegmentSyncConfig {
  ...
  private String getLocalLuceneSyncDirFileName(Segment segment) {
    if (segment instanceof ArchiveSegment) {
      ...
      String endDateString = XDateFormat.apply("yyyyMMdd").format(endDate);
