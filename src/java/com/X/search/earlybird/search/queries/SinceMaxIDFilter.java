package com.X.search.earlybird.search.queries;
...
import com.X.search.common.query.DefaultFilterWeight;
...
import com.X.search.core.earlybird.index.util.AllDocsIterator;
import com.X.search.core.earlybird.index.util.RangeFilterDISI;
  ...
  public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost)
    ...
    return new DefaultFilterWeight(this) {
      ...
      protected DocIdSetIterator getDocIdSetIterator(LeafReaderContext context) throws IOException {
        ...
        EarlybirdIndexSegmentAtomicReader XInMemoryIndexReader =
            (EarlybirdIndexSegmentAtomicReader) reader;
        TweetIDMapper tweetIdMapper =
            (TweetIDMapper) XInMemoryIndexReader.getSegmentData().getDocIDToTweetIDMapper();
        ...
        return new SinceMaxIDDocIdSetIterator(
            XInMemoryIndexReader, sinceIdExclusive, maxIdInclusive);
      }
    };
  }
