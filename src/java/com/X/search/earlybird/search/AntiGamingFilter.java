...
import com.X.common_internal.collections.RandomAccessPriorityQueue;
...
public class AntiGamingFilter {
  ...
  private void extractTerms(IndexReader reader) throws IOException {
    ...
    // Create a new XIndexSearcher instance here instead of an IndexSearcher instance, to use
    // the XIndexSearcher.collectionStatistics() implementation.
    query.createWeight(new XIndexSearcher(reader), ScoreMode.COMPLETE, 1.0f)
