...
import com.X.search.common.schema.base.ThriftDocumentUtil;
...
import com.X.search.common.schema.earlybird.EarlybirdEncodedFeaturesUtil;
...
import com.X.search.core.earlybird.index.EarlybirdIndexSegmentWriter;
import com.X.search.core.earlybird.index.column.ColumnStrideFieldIndex;
import com.X.search.core.earlybird.index.column.DocValuesUpdate;
...
import com.X.search.earlybird.exception.FlushVersionMismatchException;
import com.X.search.earlybird.partition.SearchIndexingMetricSet;
import com.X.search.earlybird.partition.SegmentIndexStats;
...
public class EarlybirdSegment {
   ...
   * Creates XIndexReader used for searching. This is shared by all Searchers.
