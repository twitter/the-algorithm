...
import com.X.search.earlybird.index.EarlybirdSegment;
...
import com.X.search.earlybird.util.ScheduledExecutorTask;
...
class QueryCacheUpdateTask extends ScheduledExecutorTask {
  ...
  private SearchResultsInfo update() throws IOException {
    ...
    if (searcher == null) {
      LOG.warn("Unable to get searcher from XIndexManager for segment ["
    ...
    searcher.getXIndexReader().getSegmentData().updateQueryCacheResult(
