package com.X.search.earlybird.common.config;
...
import com.X.search.common.config.ConfigFile;
import com.X.search.common.config.ConfigurationException;
...
public final class EarlybirdConfig {
  ...
  public static final String EARLYBIRD_ZK_CONFIG_DIR = "/X/search/production/earlybird/";
