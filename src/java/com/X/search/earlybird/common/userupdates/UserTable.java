...
import com.X.search.common.util.hash.GeneralLongHashFunction;
...
public class UserTable {
  ...
  public boolean indexUserUpdate(UserUpdatesChecker checker, UserUpdate userUpdate) {
    ...
    switch (userUpdate.updateType) {
      case ANTISOCIAL:
        setAntisocial(userUpdate.XUserID, userUpdate.updateValue != 0);
        break;
      case NSFW:
        setNSFW(userUpdate.XUserID, userUpdate.updateValue != 0);
        break;
      case OFFENSIVE:
        setOffensive(userUpdate.XUserID, userUpdate.updateValue != 0);
        break;
      case PROTECTED:
        setIsProtected(userUpdate.XUserID, userUpdate.updateValue != 0);
        break;
      default:
        return false;
    }
