...
import com.X.search.earlybird.common.NonPagingAssert;
...
import com.X.search.earlybird.partition.PartitionConfigLoader;
import com.X.search.earlybird.partition.PartitionConfigLoadingException;
import com.X.search.earlybird.util.OneTaskScheduledExecutorManager;
import com.X.search.earlybird.util.PeriodicActionParams;
import com.X.search.earlybird.util.ShutdownWaitTimeParams;
...
public class UpdateableEarlybirdStateManager extends OneTaskScheduledExecutorManager {
  ...
  private static final String DEFAULT_ZK_SCHEMA_LOCATION =
      "/X/search/production/earlybird/schema";
