...
import com.X.search.common.query.HitAttributeCollector;
...
import com.X.search.common.search.termination.TerminationQuery;
...
public abstract class EarlybirdQueryHelper {
  ...
  public static final org.apache.lucene.search.Query maybeWrapWithHitAttributionCollector(
      ...
      @Nullable com.X.search.queryparser.query.Query node,
