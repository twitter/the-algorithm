 ...
 *
 * All rate limiters used in this class are tolerant to bursts. See XRateLimiterFactory for
 * more details.
 *
...
public class ClientIdQuotaFilter extends SimpleFilter<EarlybirdRequest, EarlybirdResponse> {
  ...
  private final XRateLimiterProxyFactory rateLimiterProxyFactory;
  ...
  public ClientIdQuotaFilter(ClientIdQuotaManager quotaManager,
                             XRateLimiterProxyFactory rateLimiterProxyFactory) {
