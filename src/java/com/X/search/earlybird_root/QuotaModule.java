...
import com.google.common.util.concurrent.XRateLimiterProxyFactory;
...
import com.X.search.earlybird_root.quota.ConfigBasedQuotaConfig;
import com.X.search.earlybird_root.quota.ConfigRepoBasedQuotaManager;

public class QuotaModule extends XModule {
  @VisibleForTesting
  ...
  ClientIdQuotaFilter provideConfigRepoBasedClientIdQuotaFilter(
      ...
      XRateLimiterProxyFactory rateLimiterProxyFactory) throws Exception {
