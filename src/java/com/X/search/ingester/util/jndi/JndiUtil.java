package com.X.search.ingester.util.jndi;
...
public abstract class JndiUtil {
  // This is different from the search repo---X-naming-devtest.xml is
  // checked in as a resource in src/resources/com/X/search/ingester.
  public static final String DEFAULT_JNDI_XML =
      System.getProperty("jndiXml", "/com/X/search/ingester/X-naming-devtest.xml");
