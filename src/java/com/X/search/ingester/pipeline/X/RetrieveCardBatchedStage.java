...
import com.X.search.ingester.pipeline.util.BatchingClient;
import com.X.search.ingester.pipeline.util.CardFieldUtil;
import com.X.search.ingester.pipeline.util.IngesterStageTimer;
import com.X.search.ingester.pipeline.util.ResponseNotReturnedException;
import com.X.spiderduck.common.URLUtils;
import com.X.tweetypie.thriftjava.GetTweetOptions;
import com.X.tweetypie.thriftjava.GetTweetResult;
import com.X.tweetypie.thriftjava.GetTweetsRequest;
import com.X.tweetypie.thriftjava.MediaEntity;
import com.X.tweetypie.thriftjava.StatusState;
...
@ProducesConsumed
public class RetrieveCardBatchedStage extends XBaseStage
  ...
  private void updateMessage(IngesterXMessage message, Card2 card) {
  ...
  private String getLastHop(IngesterXMessage message, String url) {
