...
public abstract class XBatchedBaseStage<T, R> extends
    XBaseStage<T, CompletableFuture<R>> {
  private static final Logger LOG = LoggerFactory.getLogger(XBatchedBaseStage.class);
