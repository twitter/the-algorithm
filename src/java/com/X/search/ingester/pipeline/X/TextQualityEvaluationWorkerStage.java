...
import com.X.search.common.relevance.classifiers.TweetEvaluator;
import com.X.search.common.relevance.classifiers.TweetOffensiveEvaluator;
import com.X.search.common.relevance.classifiers.TweetTextClassifier;
import com.X.search.common.relevance.classifiers.TweetTextEvaluator;
...
@ProducesConsumed
public class TextQualityEvaluationWorkerStage extends XBaseStage
    <XMessage, XMessage> {
  ...
  private final BlockingQueue<XMessage> messages =
  ...
  public void innerProcess(Object obj) throws StageException {
    if (!(obj instanceof XMessage)) {
      LOG.error("Object is not a XMessage object: {}", obj);
      return;
    }

    if (decider.isAvailable(deciderKey)) {
      XMessage message = XMessage.class.cast(obj);
      try {
  ...
  private void classifyAndScore(XMessage message) {
