...
@ProducesConsumed
public class TextFeatureExtractionWorkersStage extends XBaseStage
    <XMessage, XMessage> {
  ...
  private final BlockingQueue<XMessage> messageQueue =
  ...
  private boolean tryToParse(XMessage message) {
