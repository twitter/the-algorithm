...
import com.X.search.common.metrics.SearchDelayStats;
...
import com.X.tweetypie.thriftjava.TweetEventFlags;
...
public class FilterEventsBySafetyTypeStage extends XBaseStage
  ...
  private void incrementInvalidSafetyTypeStatMap(TweetEvent tweetEvent, String eventType) {
    com.X.tweetypie.thriftjava.SafetyType thriftSafetyType =
  ...
  public enum SafetyType {
    ...
    public static SafetyType fromThriftSafetyType(
            com.X.tweetypie.thriftjava.SafetyType safetyType) {
      if (safetyType == null) {
        return INVALID;
      }
      switch(safetyType) {
