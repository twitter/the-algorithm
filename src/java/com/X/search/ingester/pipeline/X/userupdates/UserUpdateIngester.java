...
import com.X.gizmoduck.thriftjava.LifecycleChangeReason;
import com.X.gizmoduck.thriftjava.LookupContext;
import com.X.gizmoduck.thriftjava.QueryFields;
import com.X.gizmoduck.thriftjava.Safety;
import com.X.gizmoduck.thriftjava.UpdateDiffItem;
import com.X.gizmoduck.thriftjava.User;
import com.X.gizmoduck.thriftjava.UserModification;
import com.X.gizmoduck.thriftjava.UserService;
import com.X.gizmoduck.thriftjava.UserType;
import com.X.search.common.indexing.thriftjava.AntisocialUserUpdate;
...
public class UserUpdateIngester {
  ...
  public Future<List<AntisocialUserUpdate>> transform(UserModification userModification) {
    ...
    return userFuture
        ...
        .onFailure(com.X.util.Function.cons(exception -> {
