...
import com.X.search.ingester.pipeline.wire.ProductionWireModule;
import com.X.search.ingester.pipeline.wire.WireModule;
import com.X.search.ingester.util.jndi.JndiUtil;
import com.X.server.AbstractXServer;
import com.X.server.handler.DeciderHandler$;

/** Starts the ingester/indexer pipeline. */
public class IngesterPipelineApplication extends AbstractXServer {
