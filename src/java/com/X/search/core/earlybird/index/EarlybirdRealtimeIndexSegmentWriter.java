...
import com.X.search.core.earlybird.index.inverted.EarlybirdCSFDocValuesProcessor;
import com.X.search.core.earlybird.index.inverted.InvertedRealtimeIndex;
import com.X.search.core.earlybird.index.inverted.InvertedRealtimeIndexWriter;
...
public final class EarlybirdRealtimeIndexSegmentWriter extends EarlybirdIndexSegmentWriter {
  ...
  private static final class PerField implements Comparable<PerField> {
    ...
    void initInvertState() {
      // it's okay if this is null - in that case XTermHashPerField
