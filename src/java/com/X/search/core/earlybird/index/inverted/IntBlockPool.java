...
// Modeled after XCharBlockPool, with a lot of simplification.
public class IntBlockPool implements Flushable {
  private static final SearchLongGauge INT_BLOCK_POOL_MAX_LENGTH =
      SearchLongGauge.export("X_int_block_pool_max_size");
  private static final String STAT_PREFIX = "X_int_block_pool_size_";
