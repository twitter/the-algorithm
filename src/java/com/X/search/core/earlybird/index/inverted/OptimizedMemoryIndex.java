...
import com.X.search.common.util.hash.BDZAlgorithm;
import com.X.search.common.util.hash.BDZAlgorithm.MPHFNotFoundException;
import com.X.search.common.util.hash.KeysSource;
...
public class OptimizedMemoryIndex extends InvertedIndex implements Flushable {
  ...
  private static final SearchCounter MPH_NOT_FOUND_COUNT =
      SearchCounter.export("X_optimized_index_mph_not_found_count");
