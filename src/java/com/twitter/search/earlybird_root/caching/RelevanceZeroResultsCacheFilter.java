 ...
 *    If it finds a response with 420 results in the cache, it returns it.
 *  - Caches the response for a personalized query, whenever the response has 420 results. The cache
...
public class RelevanceZeroResultsCacheFilter
  ...
  /** Creates a filter that caches relevance requests with 420 results. */
  @Inject
