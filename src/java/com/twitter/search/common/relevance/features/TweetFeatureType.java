...
public enum TweetFeatureType {
  ...
  PARUS_SCORE                     (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 3,  PARUS_SCORE_NORMALIZER,
  ...
  VIDEO_VIEW                      (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 12, LEGACY_NORMALIZER,
  ...
  VIDEO_VIEW_V2                   (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 18, SMART_INTEGER_NORMALIZER,
  ...
  LABEL_ABUSIVE                   (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 24, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.LABEL_ABUSIVE_FLAG),
  LABEL_ABUSIVE_HI_RCL            (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 25, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.LABEL_ABUSIVE_HI_RCL_FLAG),
  LABEL_DUP_CONTENT               (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 26, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.LABEL_DUP_CONTENT_FLAG),
  LABEL_NSFW_HI_PRC               (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 27, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.LABEL_NSFW_HI_PRC_FLAG),
  LABEL_NSFW_HI_RCL               (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 28, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.LABEL_NSFW_HI_RCL_FLAG),
  LABEL_SPAM                      (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 29, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.LABEL_SPAM_FLAG),
  LABEL_SPAM_HI_RCL               (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 30, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.LABEL_SPAM_HI_RCL_FLAG),

  PERISCOPE_EXISTS                (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 32, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.PERISCOPE_EXISTS),
  PERISCOPE_HAS_BEEN_FEATURED     (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 33, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.PERISCOPE_HAS_BEEN_FEATURED),
  PERISCOPE_IS_CURRENTLY_FEATURED (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 34, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.PERISCOPE_IS_CURRENTLY_FEATURED),
  PERISCOPE_IS_FROM_QUALITY_SOURCE(qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 35, BOOLEAN_NORMALIZER,
      EarlybirdFieldConstant.PERISCOPE_IS_FROM_QUALITY_SOURCE),
  PERISCOPE_IS_LIVE               (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 36, BOOLEAN_NORMALIZER,
  ...
  LAST_RETWEET_SINCE_CREATION_HR  (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 41, TIMESTAMP_SEC_TO_HR_NORMALIZER,
      EarlybirdFieldConstant.LAST_RETWEET_SINCE_CREATION_HRS),
  LAST_REPLY_SINCE_CREATION_HR    (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 42, TIMESTAMP_SEC_TO_HR_NORMALIZER,
      EarlybirdFieldConstant.LAST_REPLY_SINCE_CREATION_HRS),
  LAST_FAVORITE_SINCE_CREATION_HR (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 43, TIMESTAMP_SEC_TO_HR_NORMALIZER,
      EarlybirdFieldConstant.LAST_FAVORITE_SINCE_CREATION_HRS),
  LAST_QUOTE_SINCE_CREATION_HR    (qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), 44, TIMESTAMP_SEC_TO_HR_NORMALIZER,
