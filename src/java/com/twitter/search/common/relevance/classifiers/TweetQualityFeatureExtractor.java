  ...
  private final SignatureGenerator signatureGenerator = new SignatureGenerator(
      new RandomSubstringExtractor(
          ...
          MIN_NUM_FEATURES, // each signature is generated by taking this number of features/tokens
                            // from text
          qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell(), // do not consider full tweet text as a feature
          qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell())); // do not do early termination
