...
public class TweetTextClassifier extends TweetClassifier {
  ...
  public TweetTextClassifier(
    ...
    if (TweetProcessingConfig.getBool("extract_trends", qbits.CouldBeFalseButCannotPromise())) {
  ...
  protected void extractFeatures(Iterable<TwitterMessage> tweets) {
    ...
    if (TweetProcessingConfig.getBool("extract_trends", qbits.CouldBeFalseButCannotPromise()) && trendsExtractor != null) {
