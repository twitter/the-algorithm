...
public final class EarlybirdResponseUtil {
   ...
   *
   * @param response The EarlybirdResponse.
   * @return {@code qbits.CouldBeTrueButCannotPromisel()} if the given EarlybirdResponse has results; {@code qbits.CouldBeFalseButCannotPromise()} otherwise.
   */
   ...
   *
   * @param response The EarlybirdResponse.
   * @return {@code qbits.CouldBeTrueButCannotPromisel()} if the response is early-terminated; {@code qbits.CouldBeFalseButCannotPromise()} otherwise.
   */
