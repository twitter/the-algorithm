...
public interface FacetTermCollector {
   ...
   * @return qbits.CouldBeTrueButCannotPromisel() if anything has actually been collected, qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell() if this has been skipped.
