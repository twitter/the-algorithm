namespace java com.X.search.common.ranking.thriftjava
#@namespace scala com.X.search.common.ranking.thriftscala
#@namespace strato com.X.search.common.ranking
namespace py gen.X.search.common.ranking.ranking
...
struct ThriftRankingParams {
  ...
  // for card ranking: map between card name ordinal (defined in com.X.search.common.constants.CardConstants)
  // to ranking params
