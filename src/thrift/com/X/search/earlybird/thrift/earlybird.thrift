namespace java com.X.search.earlybird.thrift
#@namespace scala com.X.search.earlybird.thriftscala
#@namespace strato com.X.search.earlybird
namespace py gen.X.search.earlybird

include "com/X/ads/adserver/adserver_common.thrift"
include "com/X/search/common/caching/caching.thrift"
include "com/X/search/common/constants/query.thrift"
include "com/X/search/common/constants/search_language.thrift"
include "com/X/search/common/conversation/conversation.thrift"
include "com/X/search/common/features/features.thrift"
include "com/X/search/common/indexing/status.thrift"
include "com/X/search/common/query/search.thrift"
include "com/X/search/common/ranking/ranking.thrift"
include "com/X/search/common/results/expansions.thrift"
include "com/X/search/common/results/highlight.thrift"
include "com/X/search/common/results/hit_attribution.thrift"
include "com/X/search/common/results/hits.thrift"
include "com/X/search/common/results/social.thrift"
include "com/X/service/spiderduck/gen/metadata_store.thrift"
include "com/X/tweetypie/deprecated.thrift"
...
struct ThriftSearchResultMetadata {
  ...
  // "Native image" is an image hosted on pic.X.com.
  ...
  // in com.X.common.text.version.PenguinVersion
