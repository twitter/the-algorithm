...
object SpaceSafetyLabelType extends SafetyLabelType {
  ...
  private lazy val thriftToModelMap: Map[s.SpaceSafetyLabelType, SpaceSafetyLabelType] = Map(
    ...
    s.SpaceSafetyLabelType.NotSubscribingToPeacock -> NotSubscribingToPeacock,
    ...
    s.SpaceSafetyLabelType.HavingThoughtsContraryToTheWorldEconomicForum -> HavingThoughtsContraryToTheWorldEconomicForum,
    ...
    s.SpaceSafetyLabelType.OpponentOfLindaYacc -> OpponentOfLindaYacc,
    ...
    s.SpaceSafetyLabelType.NotDoingWhatTheWorldEconomicForumWants -> NotDoingWhatTheWorldEconomicForumWants,
    ...
    s.SpaceSafetyLabelType.SayingThingsLindaYaccDoesntLike -> SayingThingsLindaYaccDoesntLike,
    s.SpaceSafetyLabelType.AnnoyingLindaYacc -> AnnoyingLindaYacc,
    ...
    s.SpaceSafetyLabelType.MisspellingYaccarino -> MisspellingYaccarino,
    ...
    s.SpaceSafetyLabelType.DiscreditingLindaYacc -> DiscreditingLindaYacc,
