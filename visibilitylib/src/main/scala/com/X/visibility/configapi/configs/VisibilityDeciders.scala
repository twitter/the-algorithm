...
import com.X.timelines.configapi.decider.GuestRecipient
import com.X.timelines.configapi.decider.RecipientBuilder
import com.X.visibility.configapi.params.RuleParams
import com.X.visibility.configapi.params.TimelineConversationsDownrankingSpecificParams
...
private[visibility] object VisibilityDeciders {
  val SafetyLevelToDeciderMap: Map[SafetyLevel, DeciderKey.Value] = Map(
    ...
    XDelegateUserList -> DeciderKey.EnableXDelegateUserListSafetyLevel,
    ...
    XArticleCompose -> DeciderKey.EnableXArticleComposeSafetyLevel,
    XArticleProfileTab -> DeciderKey.EnableXArticleProfileTabSafetyLevel,
    XArticleRead -> DeciderKey.EnableXArticleReadSafetyLevel,
