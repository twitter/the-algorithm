...
private[visibility] object DeciderKey extends DeciderKeyEnum {
  ...
  val EnableXDelegateUserListSafetyLevel: Value = Value(
    "visibility_library_enable_X_delegate_user_list_safety_level"
  )
  ...
  val EnableXArticleComposeSafetyLevel: Value = Value(
    "visibility_library_enable_X_article_compose_safety_level"
  )
  val EnableXArticleProfileTabSafetyLevel: Value = Value(
    "visibility_library_enable_X_article_profile_tab_safety_level"
  )
  val EnableXArticleReadSafetyLevel: Value = Value(
    "visibility_library_enable_X_article_read_safety_level"
  )
