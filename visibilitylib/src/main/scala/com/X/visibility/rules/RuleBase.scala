...
import com.X.visibility.features.AuthorScreenName
import com.X.visibility.features.Feature
import com.X.visibility.features.FeatureMap
import com.X.visibility.features.RawQuery
...
object RuleBase {
  ...
  val RuleMap: Map[SafetyLevel, VisibilityPolicy] = Map(
    ...
    XDelegateUserList -> XDelegateUserListPolicy,
    ...
    XArticleCompose -> XArticleComposePolicy,
    XArticleProfileTab -> XArticleProfileTabPolicy,
    XArticleRead -> XArticleReadPolicy,
