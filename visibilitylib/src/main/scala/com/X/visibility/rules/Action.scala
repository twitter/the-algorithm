...
import com.X.datatools.entityservice.entities.thriftscala.FleetInterstitial
import com.X.scrooge.ThriftStruct
import com.X.visibility.common.actions.LocalizedMessage
import com.X.visibility.common.actions._
import com.X.visibility.common.actions.converter.scala.AppealableReasonConverter
import com.X.visibility.common.actions.converter.scala.AvoidReasonConverter
import com.X.visibility.common.actions.converter.scala.ComplianceTweetNoticeEventTypeConverter
import com.X.visibility.common.actions.converter.scala.DownrankHomeTimelineReasonConverter
import com.X.visibility.common.actions.converter.scala.DropReasonConverter
import com.X.visibility.common.actions.converter.scala.InterstitialReasonConverter
import com.X.visibility.common.actions.converter.scala.LimitedActionsPolicyConverter
import com.X.visibility.common.actions.converter.scala.LimitedEngagementReasonConverter
import com.X.visibility.common.actions.converter.scala.LocalizedMessageConverter
import com.X.visibility.common.actions.converter.scala.SoftInterventionDisplayTypeConverter
import com.X.visibility.common.actions.converter.scala.SoftInterventionReasonConverter
import com.X.visibility.common.actions.converter.scala.TombstoneReasonConverter
import com.X.visibility.features.Feature
import com.X.visibility.logging.thriftscala.HealthActionType
import com.X.visibility.models.ViolationLevel
import com.X.visibility.strato.thriftscala.NudgeActionType.EnumUnknownNudgeActionType
import com.X.visibility.strato.thriftscala.{Nudge => StratoNudge}
import com.X.visibility.strato.thriftscala.{NudgeAction => StratoNudgeAction}
import com.X.visibility.strato.thriftscala.{NudgeActionType => StratoNudgeActionType}
import com.X.visibility.strato.thriftscala.{NudgeActionPayload => StratoNudgeActionPayload}
import com.X.visibility.thriftscala
