...
import com.X.contenthealth.sensitivemediasettings.thriftscala.SensitiveMediaSettingsLevel
import com.X.contenthealth.toxicreplyfilter.thriftscala.FilterState
import com.X.conversions.DurationOps._
import com.X.gizmoduck.thriftscala.Label
import com.X.gizmoduck.thriftscala.MuteSurface
import com.X.health.platform_manipulation.stcm_tweet_holdback.StcmTweetHoldback
...
import com.X.takedown.util.{TakedownReasons => TakedownReasonsUtil}
import com.X.timelines.configapi.EnumParam
...
import com.X.visibility.features.{AuthorBlocksOuterAuthor => AuthorBlocksOuterAuthorFeature}
import com.X.visibility.features.{AuthorBlocksViewer => AuthorBlocksViewerFeature}
import com.X.visibility.features.{
...
import com.X.visibility.features.{CommunityTweetIsHidden => CommunityTweetIsHiddenFeature}
import com.X.visibility.features.{
  NotificationIsOnCommunityTweet => NotificationIsOnCommunityTweetFeature
}
import com.X.visibility.features.{OuterAuthorFollowsAuthor => OuterAuthorFollowsAuthorFeature}
import com.X.visibility.features.{OuterAuthorIsInnerAuthor => OuterAuthorIsInnerAuthorFeature}
import com.X.visibility.features.{TweetHasCard => TweetHasCardFeature}
import com.X.visibility.features.{TweetHasMedia => TweetHasMediaFeature}
import com.X.visibility.features.{TweetIsCommunityTweet => TweetIsCommunityTweetFeature}
import com.X.visibility.features.{TweetIsEditTweet => TweetIsEditTweetFeature}
import com.X.visibility.features.{TweetIsStaleTweet => TweetIsStaleTweetFeature}
import com.X.visibility.features.{ViewerBlocksAuthor => ViewerBlocksAuthorFeature}
import com.X.visibility.features.{ViewerIsCommunityAdmin => ViewerIsCommunityAdminFeature}
import com.X.visibility.features.{ViewerIsCommunityMember => ViewerIsCommunityMemberFeature}
import com.X.visibility.features.{
...
import com.X.visibility.features.{ViewerMutesAuthor => ViewerMutesAuthorFeature}
import com.X.visibility.features.{
  ViewerMutesRetweetsFromAuthor => ViewerMutesRetweetsFromAuthorFeature
}
import com.X.visibility.models.ViolationLevel
import com.X.visibility.models._
import com.X.visibility.rules.Result.FoundCardUriRootDomain
import com.X.visibility.rules.Result.FoundMediaLabel
import com.X.visibility.rules.Result.FoundSpaceLabel
import com.X.visibility.rules.Result.FoundSpaceLabelWithScoreAboveThreshold
import com.X.visibility.rules.Result.FoundTweetLabel
import com.X.visibility.rules.Result.FoundTweetLabelForPerspectivalUser
import com.X.visibility.rules.Result.FoundTweetLabelWithLanguageIn
import com.X.visibility.rules.Result.FoundTweetLabelWithLanguageScoreAboveThreshold
import com.X.visibility.rules.Result.FoundTweetLabelWithScoreAboveThreshold
import com.X.visibility.rules.Result.FoundTweetViolationOfLevel
import com.X.visibility.rules.Result.FoundTweetViolationOfSomeLevel
import com.X.visibility.rules.Result.FoundUserLabel
import com.X.visibility.rules.Result.FoundUserRole
import com.X.visibility.rules.Result.HasQuerySource
import com.X.visibility.rules.Result.HasTweetTimestampAfterCutoff
import com.X.visibility.rules.Result.HasTweetTimestampAfterOffset
import com.X.visibility.rules.Result.HasTweetTimestampBeforeCutoff
import com.X.visibility.rules.Result.ParamWasTrue
import com.X.visibility.rules.Result.Result
import com.X.visibility.rules.Result.Satisfied
import com.X.visibility.rules.Result.Unsatisfied
import com.X.visibility.util.NamingUtils
import com.X.visibility.{features => feats}
...
object Condition {
  ...
  case object ViewerFiltersNoConfirmedEmail
      extends BooleanFeatureCondition(
        com.X.visibility.features.ViewerFiltersNoConfirmedEmail
      )

  case object ViewerFiltersNoConfirmedPhone
      extends BooleanFeatureCondition(
        com.X.visibility.features.ViewerFiltersNoConfirmedPhone
      )

  case object ViewerFiltersDefaultProfileImage
      extends BooleanFeatureCondition(
        com.X.visibility.features.ViewerFiltersDefaultProfileImage
      )

  case object ViewerFiltersNewUsers
      extends BooleanFeatureCondition(
        com.X.visibility.features.ViewerFiltersNewUsers
      )

  case object ViewerFiltersNotFollowedBy
      extends BooleanFeatureCondition(
        com.X.visibility.features.ViewerFiltersNotFollowedBy
      )

  case object AuthorHasConfirmedEmail
      extends BooleanFeatureCondition(
        com.X.visibility.features.AuthorHasConfirmedEmail
      )

  case object AuthorHasVerifiedPhone
      extends BooleanFeatureCondition(
        com.X.visibility.features.AuthorHasVerifiedPhone
      )

  case object AuthorHasDefaultProfileImage
      extends BooleanFeatureCondition(
        com.X.visibility.features.AuthorHasDefaultProfileImage
      )
  ...
  case object SearchQueryHasUser
      extends BooleanFeatureCondition(com.X.visibility.features.SearchQueryHasUser)
