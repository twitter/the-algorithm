...
import com.X.spam.rtf.thriftscala.SafetyResultReason
import com.X.util.Memoize
import com.X.visibility.common.actions.AppealableReason
import com.X.visibility.common.actions.AvoidReason.MightNotBeSuitableForAds
import com.X.visibility.common.actions.LimitedEngagementReason
import com.X.visibility.common.actions.SoftInterventionDisplayType
import com.X.visibility.common.actions.SoftInterventionReason
import com.X.visibility.common.actions.LimitedActionsPolicy
import com.X.visibility.common.actions.LimitedAction
import com.X.visibility.common.actions.converter.scala.LimitedActionTypeConverter
import com.X.visibility.configapi.params.FSRuleParams.FosnrFallbackDropRulesEnabledParam
import com.X.visibility.configapi.params.FSRuleParams.FosnrRulesEnabledParam
import com.X.visibility.configapi.params.RuleParam
import com.X.visibility.configapi.params.RuleParams.EnableFosnrRuleParam
...
import com.X.visibility.rules.ComposableActions.ComposableActionsWithInterstitialLimitedEngagements
import com.X.visibility.rules.ComposableActions.ComposableActionsWithSoftIntervention
import com.X.visibility.rules.ComposableActions.ComposableActionsWithAppealable
...
import com.X.visibility.rules.Condition.NonAuthorViewer
import com.X.visibility.rules.Condition.Not
import com.X.visibility.rules.Condition.ViewerDoesNotFollowAuthorOfFosnrViolatingTweet
import com.X.visibility.rules.Condition.ViewerFollowsAuthorOfFosnrViolatingTweet
import com.X.visibility.rules.FreedomOfSpeechNotReach.DefaultViolationLevel
import com.X.visibility.rules.Reason._
import com.X.visibility.rules.State.Evaluated
