...
import com.X.visibility.configapi.params.SafetyLevelParam
import com.X.visibility.configapi.params.SafetyLevelParams._
...
object SafetyLevel {
  ...
  private lazy val thriftToModelMap: Map[ThriftSafetyLevel, SafetyLevel] = Map(
    ...
    ThriftSafetyLevel.XDelegateUserList -> XDelegateUserList,
    ...
    ThriftSafetyLevel.XArticleCompose -> XArticleCompose,
    ThriftSafetyLevel.XArticleProfileTab -> XArticleProfileTab,
    ThriftSafetyLevel.XArticleRead -> XArticleRead,
  ...
  case object XDelegateUserList extends SafetyLevel {
    override val enabledParam: SafetyLevelParam = EnableXDelegateUserListSafetyLevelParam
  }
  ...
  case object XArticleCompose extends SafetyLevel {
    override val enabledParam: SafetyLevelParam = EnableXArticleComposeSafetyLevelParam
  }
  case object XArticleProfileTab extends SafetyLevel {
    override val enabledParam: SafetyLevelParam = EnableXArticleProfileTabSafetyLevelParam
  }
  case object XArticleRead extends SafetyLevel {
    override val enabledParam: SafetyLevelParam = EnableXArticleReadSafetyLevelParam
  }
