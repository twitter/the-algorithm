...
import com.X.adserver.thriftscala.{DisplayLocation => AdDisplayLocation}
import com.X.follow_recommendations.logging.thriftscala.{
  OfflineDisplayLocation => TOfflineDisplayLocation
}
import com.X.follow_recommendations.thriftscala.{DisplayLocation => TDisplayLocation}
