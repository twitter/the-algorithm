...
import com.X.addressbook.datatypes.thriftscala.QueryType
import com.X.addressbook.thriftscala.AddressBookGetRequest
import com.X.addressbook.thriftscala.AddressBookGetResponse
import com.X.addressbook.thriftscala.Addressbook2
import com.X.addressbook.thriftscala.ClientInfo
import com.X.finagle.stats.NullStatsReceiver
import com.X.finagle.stats.StatsReceiver
import com.X.wtf.scalding.jobs.addressbook.thriftscala.STPResultFeature
import com.X.follow_recommendations.common.clients.addressbook.models.Contact
import com.X.follow_recommendations.common.clients.addressbook.models.EdgeType
import com.X.follow_recommendations.common.clients.addressbook.models.QueryOption
import com.X.follow_recommendations.common.clients.addressbook.models.RecordIdentifier
import com.X.wtf.scalding.jobs.address_book.ABUtil.hashContact
import com.X.wtf.scalding.jobs.address_book.ABUtil.normalizeEmail
import com.X.wtf.scalding.jobs.address_book.ABUtil.normalizePhoneNumber
import com.X.hermit.usercontacts.thriftscala.{UserContacts => tUserContacts}
