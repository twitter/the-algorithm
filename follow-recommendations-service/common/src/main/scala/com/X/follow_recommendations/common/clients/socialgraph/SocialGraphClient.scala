...
import com.X.follow_recommendations.common.models.UserIdWithTimestamp
...
import com.X.socialgraph.thriftscala.OverCapacity
...
import com.X.strato.generated.client.onboarding.socialGraphService.IdsClientColumn
...
object SocialGraphClient {
  ...
  // Ref: src/thrift/com/X/socialgraph/social_graph_service.thrift
