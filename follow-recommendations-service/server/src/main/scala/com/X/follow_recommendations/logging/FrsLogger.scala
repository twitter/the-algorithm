package com.X.follow_recommendations.logging

import com.X.finagle.stats.StatsReceiver
import com.X.follow_recommendations.common.constants.GuiceNamedConstants
import com.X.follow_recommendations.common.models.HasIsSoftUser
import com.X.follow_recommendations.configapi.params.GlobalParams
import com.X.follow_recommendations.logging.thriftscala.RecommendationLog
...
import com.X.scribelib.marshallers.ExternalRefererDataProvider
...
object FrsLogger {
  ...
  def mkProvider(clientContext: ClientContext) = new ClientDataProvider {
    ...
    /** The personalization id (pid) of the user, used to personalize X services */
    ...
    /** Whether the user is accessing X via a secured connection */
    ...
    /**
     * The external site, partner, or email that lead to the current X application. Returned value consists of a
