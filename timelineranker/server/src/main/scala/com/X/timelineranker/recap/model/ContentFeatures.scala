package com.X.timelineranker.recap.model

import com.X.escherbird.thriftscala.TweetEntityAnnotation
import com.X.timelines.content_features.v1.thriftscala.{ContentFeatures => ContentFeaturesV1}
...
import com.X.tweetypie.thriftscala.SelfThreadMetadata
