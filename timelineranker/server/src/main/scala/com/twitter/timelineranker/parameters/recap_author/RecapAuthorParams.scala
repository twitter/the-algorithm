...
objelonct ReloncapAuthorParams {

  /**
   * elonnablelons selonmantic corelon, pelonnguin, and twelonelontypielon contelonnt felonaturelons in reloncap author sourcelon.
   */
  ...
  objelonct elonnablelonTokelonnsInContelonntFelonaturelonsHydrationParam
      elonxtelonnds FSParam(
        namelon = "reloncap_author_elonnablelon_tokelonns_in_contelonnt_felonaturelons_hydration",
        delonfault = falselon
      )
  ...
  objelonct elonnablelonTwelonelontTelonxtInContelonntFelonaturelonsHydrationParam
      elonxtelonnds FSParam(
        namelon = "reloncap_author_elonnablelon_twelonelont_telonxt_in_contelonnt_felonaturelons_hydration",
        delonfault = falselon
      )

  objelonct elonnablelonelonarlybirdRelonaltimelonCgMigrationParam
      elonxtelonnds FSParam(
        namelon = "reloncap_author_elonnablelon_elonarlybird_relonaltimelon_cg_migration",
        delonfault = falselon
      )
  /**
  ...
  objelonct elonnablelonConvelonrsationControlInContelonntFelonaturelonsHydrationParam
      elonxtelonnds FSParam(
        namelon = "convelonrsation_control_in_contelonnt_felonaturelons_hydration_reloncap_author_elonnablelon",
        delonfault = falselon
      )

  objelonct elonnablelonTwelonelontMelondiaHydrationParam
      elonxtelonnds FSParam(
        namelon = "twelonelont_melondia_hydration_reloncap_author_elonnablelon",
        delonfault = falselon
      )
