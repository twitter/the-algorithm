package com.X.timelineranker.adapter
...
import com.X.timelineservice.model.core
import com.X.timelineservice.{model => tls}
import com.X.timelineservice.{thriftscala => tlsthrift}
import com.X.timelineservice.model.core._
