...
import com.X.scrooge.{BinaryThriftStructSerializer, ThriftStructCodec, ThriftStruct}
import com.X.util.{Future, Return, Try, Throw}
 ...
 * com.X.servo.util.TransformerLawSpec.
 *
