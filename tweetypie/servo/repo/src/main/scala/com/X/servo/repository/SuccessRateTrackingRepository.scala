package com.X.servo.repository

import com.X.finagle.mux.ClientDiscardedRequestException
import com.X.finagle.stats.StatsReceiver
import com.X.finagle.{CancelledConnectionException, CancelledRequestException}
import com.X.servo.util.{Gate, SuccessRateTracker}
...
object SuccessRateTrackingRepository {
  ...
  def isCancellation(t: Throwable): Boolean =
    t match {
      ...
      // Most of these exceptions can be wrapped in com.X.finagle.Failure
