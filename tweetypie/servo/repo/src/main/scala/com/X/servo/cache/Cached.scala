...
import com.X.servo.cache.thriftscala.CachedValueStatus.DoNotCache
import com.X.servo.util.{Gate, Transformer}
import com.X.util.{Duration, Return, Throw, Time}
...
object Cached {
   ...
   * This exhortation is also given in com.X.servo.util.Transformer, but repeated here.
   */
 ...
 * using the [[com.X.servo.cache.thriftscala.CachedValue]] struct, which is similar, but
 * untyped.
 */
case class Cached[V](
  value: Option[V],
