...
import com.X.scrooge.schema.scrooge.scala.CompiledScroogeDefBuilder
import com.X.scrooge.schema.scrooge.scala.CompiledScroogeValueExtractor
import com.X.scrooge.schema.tree.DefinitionTraversal
import com.X.scrooge.schema.tree.FieldPath
import com.X.scrooge.schema.{ThriftDefinitions => DEF}
import com.X.scrooge_internal.linter.known_annotations.AllowedAnnotationKeys.TweetEditAllowed
import com.X.stitch.Stitch
import com.X.tweetypie.core.TweetCreateFailure
import com.X.tweetypie.repository.TweetQuery.Options
...
import com.X.tweetypie.thriftscala.TweetCreateState.FieldEditNotAllowed
import com.X.tweetypie.thriftscala.TweetCreateState.InitialTweetNotFound
