...
import com.X.finagle.memcached.exp.localMemcachedPort
...
import com.X.servo.repository.CachedResult
import com.X.servo.util.Availability
import com.X.tweetypie.backends._
import com.X.tweetypie.caching.SoftTtl
import com.X.tweetypie.handler.DuplicateTweetFinder
import com.X.tweetypie.repository.TombstoneTtl
...
class TweetServiceSettings(val flags: TweetServiceFlags) {
   ...
   * Used by [[com.X.tweetypie.repository.ManhattanTweetRepository]].
   */
