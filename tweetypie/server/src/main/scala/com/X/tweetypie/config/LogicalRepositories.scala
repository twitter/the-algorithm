...
import com.X.config.yaml.YamlConfig
import com.X.decider.Decider
import com.X.featureswitches.v2.FeatureSwitches
import com.X.finagle.memcached
import com.X.finagle.stats.StatsReceiver
import com.X.servo.cache._
import com.X.servo.cache.{KeyValueResult => _}
import com.X.servo.repository._
import com.X.stitch.NotFound
import com.X.stitch.Stitch
import com.X.stitch.repo.Repo
...
import com.X.stringcenter.client.MultiProjectStringCenter
import com.X.translation.Languages
import com.X.translation.YamlConfigLanguages
import com.X.tweetypie.caching.CacheOperations
import com.X.tweetypie.caching.Expiry
import com.X.tweetypie.caching.ServoCachedValueSerializer
import com.X.tweetypie.caching.StitchCaching
import com.X.tweetypie.caching.ValueSerializer
...
import com.X.tweetypie.hydrator.TextRepairer
import com.X.tweetypie.hydrator.TweetHydration
import com.X.tweetypie.hydrator.TweetQueryOptionsExpander
...
import com.X.tweetypie.serverutil.BoringStackTrace
import com.X.tweetypie.serverutil.ExceptionCounter
import com.X.tweetypie.thriftscala.DeviceSource
import com.X.tweetypie.thriftscala.Place
import com.X.tweetypie.thriftscala.entities.EntityExtractor
...
import com.X.visibility.common.KeywordMatcher
import com.X.visibility.common.LocalizationSource
import com.X.visibility.common.TweetMediaMetadataSource
...
import com.X.visibility.common.tflock.UserIsInvitedToConversationRepository
import com.X.visibility.configapi.configs.VisibilityDeciderGates
import com.X.visibility.generators.CountryNameGenerator
...
import com.X.visibility.interfaces.tweets.TweetVisibilityLibrary
import com.X.visibility.interfaces.tweets.UserUnavailableStateVisibilityLibrary
import com.X.visibility.util.DeciderUtil
import com.X.visibility.util.FeatureSwitchUtil
...
object LogicalRepositories {
  ...
  class RepoConfig[K, V](
    ...
    def newCaching(
      ...
      withMiddleware { repo =>
        val logger = Logger(s"com.X.tweetypie.config.LogicalRepositories.$name")
  ...
  def apply(
    ...
    new LogicalRepositories {
      ...
      private[this] val tweetVisibilityLogger =
        com.X.logging.Logger("com.X.tweetypie.TweetVisibility")
