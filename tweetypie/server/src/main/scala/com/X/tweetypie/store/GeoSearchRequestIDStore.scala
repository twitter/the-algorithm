...
import com.X.geoduck.backend.relevance.thriftscala.ReportFailure
import com.X.geoduck.backend.relevance.thriftscala.ReportResult
import com.X.geoduck.backend.relevance.thriftscala.ConversionReport
import com.X.geoduck.backend.searchrequestid.thriftscala.SearchRequestID
import com.X.geoduck.backend.tweetid.thriftscala.TweetID
import com.X.geoduck.common.thriftscala.GeoduckException
import com.X.geoduck.service.identifier.thriftscala.PlaceIdentifier
