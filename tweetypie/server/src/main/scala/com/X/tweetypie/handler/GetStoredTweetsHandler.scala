...
import com.X.tweetypie.core.StoredTweetResult._
import com.X.tweetypie.core.StoredTweetResult
import com.X.tweetypie.core.TweetResult
import com.X.tweetypie.FieldId
import com.X.tweetypie.FutureArrow
import com.X.tweetypie.repository.CacheControl
import com.X.tweetypie.repository.TweetQuery
import com.X.tweetypie.repository.TweetResultRepository
import com.X.tweetypie.thriftscala.{BounceDeleted => BounceDeletedState}
import com.X.tweetypie.thriftscala.{ForceAdded => ForceAddedState}
import com.X.tweetypie.thriftscala.GetStoredTweetsRequest
import com.X.tweetypie.thriftscala.GetStoredTweetsOptions
import com.X.tweetypie.thriftscala.GetStoredTweetsResult
import com.X.tweetypie.thriftscala.{HardDeleted => HardDeletedState}
import com.X.tweetypie.thriftscala.{NotFound => NotFoundState}
import com.X.tweetypie.thriftscala.{SoftDeleted => SoftDeletedState}
...
import com.X.tweetypie.thriftscala.StoredTweetState
import com.X.tweetypie.thriftscala.{Undeleted => UndeletedState}
