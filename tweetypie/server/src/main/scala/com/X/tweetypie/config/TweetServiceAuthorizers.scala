...
import com.X.finagle.mtls.transport.S2STransport
import com.X.servo.gate.RateLimitingGate
import com.X.servo.request.ClientRequestAuthorizer.UnauthorizedException
import com.X.servo.request.{ClientRequestAuthorizer, ClientRequestObserver}
...
import com.X.tweetypie.service.MethodAuthorizer
...
object RateLimiterAuthorizer {
   ...
   * https://cgit.X.biz/source/tree/stitch/stitch-tweetypie/src/main/scala/com/X/stitch/tweetypie/TweetyPie.scala#n47
   *
   */
