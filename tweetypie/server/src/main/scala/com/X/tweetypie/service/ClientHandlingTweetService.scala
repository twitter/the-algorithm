/** Copyright 2012 X, Inc. */
package com.X.tweetypie.service

import com.X.coreservices.StratoPublicApiRequestAttributionCounter
import com.X.finagle.CancelledRequestException
import com.X.finagle.context.Contexts
import com.X.finagle.context.Deadline
...
import com.X.servo.util.ExceptionCategorizer
import com.X.servo.util.MemoizedExceptionCounterFactory
import com.X.tweetypie.Future
import com.X.tweetypie.Gate
import com.X.tweetypie.Logger
