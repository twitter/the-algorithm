...
import com.X.context.thriftscala.FeatureContext
import com.X.tweetypie.backends.LimiterService
...
import com.X.tweetypie.util.TweetCreationLock.{Key => TweetCreationLockKey}
...
object PostTweet {
  ...
  object LogFailures extends Filter[PostTweetResult] {
    private[this] val failedTweetCreationsLogger = Logger(
      "com.X.tweetypie.FailedTweetCreations"
    )
