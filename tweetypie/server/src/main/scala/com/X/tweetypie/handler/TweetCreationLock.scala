...
import com.X.servo.cache.Cache
import com.X.servo.util.Scribe
import com.X.tweetypie.serverutil.ExceptionCounter
import com.X.tweetypie.thriftscala.PostTweetResult
import com.X.tweetypie.util.TweetCreationLock.Key
import com.X.tweetypie.util.TweetCreationLock.State
...
object CacheBasedTweetCreationLock {
  ...
  private[this] val UniquenessIdLog = Logger("com.X.tweetypie.handler.UniquenessId")
