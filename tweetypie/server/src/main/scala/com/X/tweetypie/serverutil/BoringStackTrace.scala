...
import com.X.finagle.ChannelException
...
object BoringStackTrace {
  ...
  def isBoring(t: Throwable): Boolean =
    t match {
      ...
      // org.apache.thrift.TApplicationException: Internal error processing issue3: 'com.X.finagle.service.DeadlineFilter$DeadlineExceededException: exceeded request deadline of 100.milliseconds by 4.milliseconds. Deadline expired at 2020-08-27 17:07:46 +0000 and now it is 2020-08-27 17:07:46 +0000.'
