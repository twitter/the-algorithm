...
import com.X.ads.loggingclient.AdsLoggingClient
import com.X.adserver.thriftscala.AdCallbackEvent
import com.X.conversions.DurationOps._
import com.X.conversions.PercentOps._
import com.X.container.{thriftscala => ccs}
import com.X.deferredrpc.client.DeferredThriftService
import com.X.deferredrpc.thrift.Datacenter
import com.X.deferredrpc.thrift.DeferredRPC
import com.X.deferredrpc.thrift.Target
import com.X.escherbird.thriftscala.TweetEntityAnnotationService$FinagleClient
import com.X.escherbird.thriftscala.{
...
import com.X.expandodo.thriftscala.CardsService$FinagleClient
import com.X.expandodo.thriftscala.{CardsService => CardsScroogeIface}
import com.X.finagle._
import com.X.finagle.builder.ClientBuilder
import com.X.finagle.client.Transporter
import com.X.finagle.factory.TimeoutFactory
...
import com.X.finagle.partitioning.param
import com.X.finagle.service.TimeoutFilter.PropagateDeadlines
import com.X.finagle.service._
...
import com.X.finagle.tracing.DefaultTracer
import com.X.flockdb.client.thriftscala.FlockDB
import com.X.flockdb.client.FlockResponse
import com.X.flockdb.client.TFlockClient
import com.X.flockdb.client.UserTimelineGraph
import com.X.geoduck.backend.hydration.thriftscala.{Hydration => GeoduckHydration}
import com.X.geoduck.backend.relevance.thriftscala.Relevance
import com.X.geoduck.backend.relevance.thriftscala.Relevance$FinagleClient
import com.X.geoduck.backend.relevance.thriftscala.RelevanceContext
import com.X.geoduck.service.common.clientmodules.GeoduckGeohashLocate
import com.X.geoduck.thriftscala.ReverseGeocoder
import com.X.geoduck.util.service.GeoduckLocate
import com.X.gizmoduck.thriftscala.UserService
import com.X.hashing.KeyHasher
import com.X.limiter.client.LimiterClientFactory
import com.X.mediainfo.server.thriftscala.MediaInfoService$FinagleClient
import com.X.mediainfo.server.thriftscala.{MediaInfoService => MediaInfoScroogeIface}
import com.X.merlin.thriftscala.UserRolesService
import com.X.passbird.thriftscala.PassbirdService
import com.X.passbird.thriftscala.PassbirdService$FinagleClient
import com.X.service.gen.scarecrow.thriftscala.ScarecrowService$FinagleClient
import com.X.service.gen.scarecrow.thriftscala.{ScarecrowService => ScarecrowScroogeIface}
import com.X.service.talon.thriftscala.Talon$FinagleClient
import com.X.service.talon.thriftscala.{Talon => TalonScroogeIface}
import com.X.snowflake.client.SnowflakeClient
import com.X.snowflake.thriftscala.Snowflake
import com.X.socialgraph.thriftscala.SocialGraphService$FinagleClient
import com.X.socialgraph.thriftscala.{SocialGraphService => SocialGraphScroogeIface}
...
import com.X.timelineservice.fanout.thriftscala.FanoutService
import com.X.timelineservice.fanout.thriftscala.FanoutService$FinagleClient
import com.X.timelineservice.{thriftscala => tls}
import com.X.tweetypie.backends._
import com.X.tweetypie.client_id.ClientIdHelper
import com.X.tweetypie.media.MediaClient
import com.X.tweetypie.service.ReplicatingTweetService.GatedReplicationClient
import com.X.tweetypie.storage.ManhattanTweetStorageClient
import com.X.tweetypie.storage.TweetStorageClient
import com.X.tweetypie.store._
import com.X.tweetypie.thriftscala.DeleteLocationData
import com.X.tweetypie.thriftscala.RetweetArchivalEvent
import com.X.tweetypie.thriftscala.TweetEvent
import com.X.tweetypie.thriftscala.TweetServiceInternal$FinagleClient
import com.X.user_image_service.thriftscala.UserImageService$FinagleClient
import com.X.user_image_service.thriftscala.{UserImageService => UserImageScroogeIface}
import com.X.util.Throw
import com.X.util.Timer
import com.X.util.{TimeoutException => UtilTimeoutException}
