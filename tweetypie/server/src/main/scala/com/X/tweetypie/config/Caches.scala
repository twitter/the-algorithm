...
import com.X.servo.cache.{Serializer => CacheSerializer, _}
import com.X.tweetypie.client_id.ClientIdHelper
import com.X.tweetypie.core._
import com.X.tweetypie.handler.CacheBasedTweetCreationLock
import com.X.tweetypie.repository._
import com.X.tweetypie.serverutil._
import com.X.tweetypie.thriftscala._
import com.X.tweetypie.util._
  ...
  def apply(
    ...
    def observeCache[K, V](
      ...
      ObservableCache(
        ...
        com.X.logging.Logger(s"com.X.tweetypie.cache.$logName")
      )
