...
import com.X.mediaservices.commons.mediainformation.thriftscala.UserDefinedProductMetadata
import com.X.mediaservices.commons.photurkey.thriftscala.PrivacyType
import com.X.mediaservices.commons.servercommon.thriftscala.{ServerError => CommonServerError}
import com.X.mediaservices.commons.thriftscala.ProductKey
import com.X.mediaservices.commons.thriftscala.MediaKey
import com.X.servo.util.FutureArrow
import com.X.thumbingbird.{thriftscala => ifs}
import com.X.tweetypie.backends.MediaInfoService
import com.X.tweetypie.backends.UserImageService
import com.X.tweetypie.core.UpstreamFailure
import com.X.user_image_service.{thriftscala => uis}
import com.X.user_image_service.thriftscala.MediaUpdateAction
import com.X.user_image_service.thriftscala.MediaUpdateAction.Delete
import com.X.user_image_service.thriftscala.MediaUpdateAction.Undelete
