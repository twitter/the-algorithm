...
import com.X.passbird.clientapplication.thriftscala.ClientApplication
import com.X.passbird.clientapplication.thriftscala.GetClientApplicationsResponse
...
object DeviceSourceRepository {
  ...
  val DefaultUrl = "https://help.X.com/en/using-X/how-to-tweet#source-labels"
