...
import com.X.tweetypie.store.Takedown
import com.X.tweetypie.thriftscala.DataError
import com.X.tweetypie.thriftscala.DataErrorCause
import com.X.tweetypie.thriftscala.SetTweetUserTakedownRequest
