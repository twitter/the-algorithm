...
object TweetQuery {
   ...
   *   client such as the iPhone X app and is subject to being Dropped to prevent serving
   ...
   * @param isInnerQuotedTweet Set by [[com.X.tweetypie.hydrator.QuotedTweetHydrator]],
   *   to be used by [[com.X.visibility.interfaces.tweets.TweetVisibilityLibrary]]
