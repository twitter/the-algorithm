...
import com.X.servo.util.FutureEffect
import com.X.finagle.stats.StatsReceiver
import com.X.logging._
import com.X.scrooge.BinaryThriftStructSerializer
import com.X.servo.util.{Scribe => ServoScribe}
import com.X.tweetypie.storage_internal.thriftscala._
import com.X.tbird.thriftscala.Added
import com.X.tbird.thriftscala.Removed
import com.X.tbird.thriftscala.Scrubbed
 ...
 * -----   ---------------      -------
 * add     tbird_add_status     [[com.X.tbird.thriftscala.Added]]
 * remove  tbird_remove_status  [[com.X.tbird.thriftscala.Removed]]
 * scrub   tbird_scrub_status   [[com.X.tbird.thriftscala.Scrubbed]]
 *
