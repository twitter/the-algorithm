...
import com.X.storage.client.manhattan.bijections.Bijections._
...
import com.X.tweetypie.storage.Scribe.ScribeHandlerFactory
import com.X.tweetypie.storage.TweetStorageClient.BounceDelete
import com.X.tweetypie.storage.TweetStorageClient.GetTweet
import com.X.tweetypie.storage.TweetStorageClient.HardDeleteTweet
...
class ManhattanTweetStorageClient(
   ...
   * (e.g. [[com.X.tweetypie.storage.Response.TweetResponseCode.Failure]]).
   */
