package com.X.tweetypie.tweettext

import com.X.tweetypie.tweettext.TweetText._
...
object Truncator {
  ...
  /**
   * Truncate to [[com.X.tweetypie.tweettext.TweetText#OrginalMaxDisplayLength]] display
