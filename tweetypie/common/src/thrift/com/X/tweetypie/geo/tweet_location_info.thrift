namespace java com.X.tweetypie.geo.thriftjava
#@namespace scala com.X.tweetypie.geo.thriftscala
#@namespace strato com.X.tweetypie.geo
namespace py gen.X.tweetypie.geo
 ...
 *
 *   E.g.: User is asked to share their GPS coordinates with X from mobile client,
