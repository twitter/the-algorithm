namespace java com.X.tweetypie.thriftjava.graphql
#@namespace scala com.X.tweetypie.thriftscala.graphql
#@namespace strato com.X.tweetypie.graphql
 ...
 */
include "com/X/ads/callback/engagement_request.thrift"
include "com/X/strato/graphql/existsAndPrefetch.thrift"
...
struct CreateRetweetRequest {
  ...
  // @see com.X.tweetypie.thriftscala.PostTweetRequest.nullcast
  2: bool nullcast = 0 (
    strato.description='Do not deliver this retweet to a user\'s followers. http://go/nullcast'
  )

  // @see com.X.ads.callback.thriftscala.EngagementRequest
  ...
  // @see com.X.tweetypie.thriftscala.PostTweetRequest.PostTweetRequest.comparison_id
...
struct TweetReply {
  //@see com.X.tweetypie.thriftscala.PostTweetRequest.in_reply_to_tweet_id
  1: i64 in_reply_to_tweet_id (
    strato.json.numbers.type='string',
    strato.description='The id of the tweet that this tweet is replying to.'
  )
  //@see com.X.tweetypie.thriftscala.PostTweetRequest.exclude_reply_user_ids
...
struct TweetMediaEntity {
  // @see com.X.tweetypie.thriftscala.PostTweetRequest.media_upload_ids
  1: i64 media_id (
    strato.json.numbers.type='string',
    strato.description='Media id as obtained from the User Image Service when uploaded.'
  )

  // @see com.X.tweetypie.thriftscala.Tweet.media_tags
...
struct TweetMedia {
  ...
  /**
   * @deprecated @see com.X.tweetypie.thriftscala.PostTweetRequest.possibly_sensitive for
...
struct TweetGeo {
  ...
  2: optional string place_id (
    strato.description='A place in the world. See also https://developer.X.com/en/docs/X-api/v1/data-dictionary/object-model/geo#place'
  )
  3: optional string geo_search_request_id (
    strato.description='See https://confluence.X.biz/display/GEO/Passing+the+geo+search+request+ID'
  )
} (
  strato.graphql.typename='TweetGeo',
  strato.description='Tweet geo location metadata. See https://developer.X.com/en/docs/X-api/v1/data-dictionary/object-model/geo'
)
...
struct CreateTweetRequest {
  ...
  // @see com.X.tweetypie.thriftscala.PostTweetRequest.attachment_url
  ...
  // @see com.X.tweetypie.thriftscala.Tweet.card_reference
