...
namespace py gen.X.tweetypie.tweet
namespace rb TweetyPie
// Specific namespace to avoid golang circular import
namespace go tweetypie.tweet

include "com/X/escherbird/tweet_annotation.thrift"
include "com/X/expandodo/cards.thrift"
include "com/X/content-health/toxicreplyfilter/filtered_reply_details.thrift"
include "com/X/dataproducts/enrichments_profilegeo.thrift"
include "com/X/geoduck/public/thriftv1/geoduck_common.thrift"
include "com/X/mediaservices/commons/MediaCommon.thrift"
include "com/X/mediaservices/commons/MediaInformation.thrift"
include "com/X/tweetypie/api_fields.thrift"
include "com/X/tweetypie/edit_control.thrift"
include "com/X/tweetypie/media_entity.thrift"
include "com/X/tweetypie/note_tweet.thrift"
include "com/X/service/scarecrow/gen/tiered_actions.thrift"
include "com/X/spam/rtf/safety_label.thrift"
include "com/X/timelines/self_thread/self_thread.thrift"
include "com/X/tseng/withholding/withholding.thrift"
include "com/X/tweet_pivots/tweet_pivots.thrift"
include "com/X/tweetypie/geo/tweet_location_info.thrift"
include "com/X/tweetypie/media/media_ref.thrift"
include "unified_cards_contract.thrift"
include "com/X/tweetypie/creative-entity-enrichments/creative_entity_enrichments.thrift"
include "com/X/tweetypie/unmentions/unmentions.thrift"
...
struct Place {
   ...
   * GetTweetOptions.language_tag.
   *
   * @see com.X.geoduck.util.primitives.bestPlaceNameMatchingFilter
   */
...
/**
  ...
  * in the tweet by X owned and operated clients.
  */
...
/**
 * XSuggestInfo is details about a synthetic tweet generated by an early
 * version of X Suggests.
 *
 * @deprecated
 */
struct XSuggestInfo {
  1: SuggestType suggest_type
  2: XSuggestsVisibilityType visibility_type
 ...
 * application provides this information on https://apps.X.com.
 */
struct DeviceSource {
 ...
 *
 * Language is determined by XLanguageIdentifier from the
 * com.X.common.text package (commonly called "Penguin").
 */
struct Language {
  /**
...
struct TweetCoreData {
  ...
  /**
   * Whether this tweet might be not-safe-for-work, judged by an internal X
   * support agent.
   *
   ...
   *
   * X owned clients must use place_id REST API param for geo-tagging.
   *
...
/**
 * A Tweet is a message that belongs to a X user.
 *
...
struct Tweet {
  ...
  */
  ...
  /**
   * Human language of tweet text as determined by XLanguageIdentifier.
   */
   ...
   * @deprecated
   */
  105: optional XSuggestInfo obsolete_X_suggest_info
