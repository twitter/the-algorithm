...
namespace py gen.X.tweetypie.service
namespace rb TweetyPie
namespace go tweetypie

include "com/X/bouncer/bounce.thrift"
include "com/X/carousel/service/carousel_service.thrift"
...
include "com/X/spam/features/safety_meta_data.thrift"
include "com/X/spam/rtf/safety_label.thrift"
include "com/X/spam/rtf/safety_level.thrift"
include "com/X/spam/rtf/safety_result.thrift"
include "com/X/tseng/withholding/withholding.thrift"
include "com/X/tweetypie/deleted_tweet.thrift"
...
include "com/X/incentives/jiminy/jiminy.thrift"
...
enum StatusState {
  ...
  // PrivateTweet was originally used for XSuggest v1 but has since been removed
  ...
  /**
   * The tweet once existed, had violated X Rules, and has been deleted.
...
enum UndeleteTweetState {
   ...
   * has been found to violate X Rules. go/bouncer go/bounced-tweet
   */
...
struct GetTweetOptions {
  ...
  // OBSOLETE (XSuggestInfo version of suggested tweets has been removed)
  21: bool obsolete_skip_X_suggests_visibility_check = 0
...
struct TweetFieldsResultNotFound {
  ...
  // This tweet is deleted after being bounced for violating the X
...
struct NoteTweetOptions {
   ...
   **/
  1: required i64 note_tweet_id (personalDataType = 'XArticleID')
  // Deprecated
...
struct DeleteTweetsRequest {
  ...
  /**
   * A bounced tweet is a tweet that has been found to violate X Rules.
