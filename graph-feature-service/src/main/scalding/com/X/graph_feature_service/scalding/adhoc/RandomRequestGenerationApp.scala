package com.X.graph_feature_service.scalding.adhoc

import com.X.bijection.Injection
import com.X.frigate.common.constdb_util.Injections
import com.X.ml.api.Feature.Discrete
import com.X.ml.api.{DailySuffixFeatureSource, DataSetPipe, RichDataRecord}
...
/**
 * ./bazel bundle graph-feature-service/src/main/scalding/com/X/graph_feature_service/scalding/adhoc:all
 *
 * oscar hdfs --screen --user cassowary --tee gfs_log --bundle gfs_random_request-adhoc \
      --tool com.X.graph_feature_service.scalding.adhoc.RandomRequestGenerationApp \
      -- --date 2018-08-11  \
      --input /atla/proc2/user/timelines/processed/suggests/recap/data_records \
      --output /user/cassowary/gfs/adhoc/timeline_data
 */
object RandomRequestGenerationApp extends XExecutionApp {
