 ...
 *
  scalding remote run --target graph-feature-service/src/main/scalding/com/X/graph_feature_service/scalding:graph_feature_service_adhoc_job
 */
 ...
 * scalding workflow upload --jobs graph-feature-service/src/main/scalding/com/X/graph_feature_service/scalding:graph_feature_service_daily_job --autoplay --build-cron-schedule "20 23 1 * *"
