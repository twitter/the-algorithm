package com.X.graph_feature_service.worker.modules

import com.google.inject.Provides
import com.X.concurrent.AsyncSemaphore
import com.X.finagle.stats.StatsReceiver
import com.X.graph_feature_service.common.Configs._
import com.X.graph_feature_service.worker.util
import com.X.graph_feature_service.worker.util.AutoUpdatingGraph
import com.X.graph_feature_service.worker.util.FollowedByPartialValueGraph
import com.X.graph_feature_service.worker.util.FollowingPartialValueGraph
import com.X.graph_feature_service.worker.util.GraphContainer
import com.X.graph_feature_service.worker.util.GraphKey
import com.X.graph_feature_service.worker.util.MutualFollowPartialValueGraph
import com.X.inject.XModule
import com.X.inject.annotations.Flag
import com.X.util.Timer
import javax.inject.Singleton

object GraphContainerProviderModule extends XModule {
