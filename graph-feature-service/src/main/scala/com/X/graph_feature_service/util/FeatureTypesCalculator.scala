package com.X.graph_feature_service.util

import com.X.graph_feature_service.thriftscala.EdgeType._
import com.X.graph_feature_service.thriftscala.{FeatureType, PresetFeatureTypes}
