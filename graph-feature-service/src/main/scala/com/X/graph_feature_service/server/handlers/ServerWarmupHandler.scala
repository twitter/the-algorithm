package com.X.graph_feature_service.server.handlers

import com.X.finatra.thrift.routing.ThriftWarmup
import com.X.graph_feature_service.thriftscala.EdgeType.FavoritedBy
import com.X.graph_feature_service.thriftscala.EdgeType.FollowedBy
import com.X.graph_feature_service.thriftscala.EdgeType.Following
import com.X.graph_feature_service.thriftscala.Server.GetIntersection
import com.X.graph_feature_service.thriftscala.FeatureType
import com.X.graph_feature_service.thriftscala.GfsIntersectionRequest
