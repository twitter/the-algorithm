...
import com.X.frigate.pushservice.model.TrendTweetPushCandidate
...
import com.X.frigate.pushservice.util.CandidateHydrationUtil._
import com.X.frigate.pushservice.util.MrUserStateUtil
import com.X.frigate.pushservice.util.RelationshipUtil
    ...
    candidateDetailsWithCopies.map {
      case (candidateDetail, copyIds) =>
        ...
        val hydratedCandidate = pushCandidate match {
          ...
          case discoverXCandidate: DiscoverXCandidate =>
            getHydratedCandidateForDiscoverXCandidate(discoverXCandidate, copyIds)
