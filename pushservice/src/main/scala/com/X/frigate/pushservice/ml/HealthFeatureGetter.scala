package com.X.frigate.pushservice.ml

import com.X.abuse.detection.scoring.thriftscala.{Model => TweetHealthModel}
...
import com.X.frigate.pushservice.predicate.HealthPredicates.userHealthSignalValueToDouble
import com.X.frigate.pushservice.util.CandidateHydrationUtil
import com.X.frigate.pushservice.util.CandidateUtil
import com.X.frigate.pushservice.util.MediaAnnotationsUtil
import com.X.frigate.thriftscala.UserMediaRepresentation
import com.X.hss.api.thriftscala.SignalValue
import com.X.hss.api.thriftscala.UserHealthSignal
import com.X.hss.api.thriftscala.UserHealthSignal.AgathaCalibratedNsfwDouble
import com.X.hss.api.thriftscala.UserHealthSignal.NsfwTextUserScoreDouble
