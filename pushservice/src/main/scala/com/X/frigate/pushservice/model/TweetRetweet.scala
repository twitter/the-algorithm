...
import com.X.frigate.pushservice.model.ibis.TweetRetweetCandidateIbis2Hydrator
import com.X.frigate.pushservice.model.ntab.TweetRetweetNTabRequestHydrator
