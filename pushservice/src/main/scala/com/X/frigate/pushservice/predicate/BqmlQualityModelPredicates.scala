...
import com.X.frigate.pushservice.params.PushConstants.TweetMediaEmbeddingBQKeyIds
...
import com.X.frigate.pushservice.util.CandidateUtil._
...
object BqmlQualityModelPredicates {
  ...
  def ingestExtraFeatures(cand: PushCandidate): Unit = {
    ...
    val tweetMediaEmbeddingFeature =
      "media.mediaunderstanding.media_embeddings.X_clip_as_sparse_continuous_feature"
