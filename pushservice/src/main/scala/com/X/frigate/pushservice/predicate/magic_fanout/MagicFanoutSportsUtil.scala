...
import com.X.datatools.entityservice.entities.sports.thriftscala.SoccerPeriod
import com.X.datatools.entityservice.entities.sports.thriftscala.SportsEventHomeAwayTeamScore
import com.X.datatools.entityservice.entities.sports.thriftscala.SportsEventStatus
import com.X.datatools.entityservice.entities.sports.thriftscala.SportsEventTeamAlignment.Away
import com.X.datatools.entityservice.entities.sports.thriftscala.SportsEventTeamAlignment.Home
import com.X.escherbird.metadata.thriftscala.EntityMegadata
import com.X.frigate.pushservice.params.SportGameEnum
import com.X.frigate.common.base.GenericGameScore
import com.X.frigate.common.base.NflGameScore
import com.X.frigate.common.base.SoccerGameScore
import com.X.frigate.common.base.TeamInfo
import com.X.frigate.common.base.TeamScore
      ...
      .get(SemanticEntityForQuery(team.teamDomainId, team.teamEntityId)).map {
        _.flatMap {
          _.basicMetadata.map { metadata =>
            TeamInfo(
              name = metadata.name,
              XUserId = metadata.X.flatMap(_.preferredXUserId))
          }
        }
      }
  }
