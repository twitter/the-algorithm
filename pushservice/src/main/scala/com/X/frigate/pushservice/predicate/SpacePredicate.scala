...
import com.X.frigate.common.base.SpaceCandidate
import com.X.frigate.common.base.SpaceCandidateDetails
...
import com.X.ubs.thriftscala.BroadcastState
import com.X.ubs.thriftscala.ParticipantUser
        ...
        audioSpaceParticipantsStore.get(spaceCandidate.spaceId).map {
          case Some(participants) =>
            ...
            val isInSpace = allParticipants.exists { participant =>
              participant.XUserId.contains(spaceCandidate.target.targetId)
            }
            !isInSpace
          case None => false
        }
