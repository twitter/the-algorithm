...
objelonct ProducelonrBaselondUselonrTwelonelontGraphParams {

  objelonct MinCoOccurrelonncelonParam
      elonxtelonnds FSBoundelondParam[Int](
        namelon = "producelonr_baselond_uselonr_twelonelont_graph_min_co_occurrelonncelon",
        delonfault = 4,
        min = 0,
        max = 500
      )
  ...
  objelonct MinScorelonParam
      elonxtelonnds FSBoundelondParam[Doublelon](
        namelon = "producelonr_baselond_uselonr_twelonelont_graph_min_scorelon",
        delonfault = 3.0,
        min = 0.0,
        max = 10.0
      )
  ...
  objelonct MaxNumFollowelonrsParam
      elonxtelonnds FSBoundelondParam[Int](
        namelon = "producelonr_baselond_uselonr_twelonelont_graph_max_num_followelonrs",
        delonfault = 500,
        min = 100,
        max = 1000
      )
