...
import com.X.abdecider.ScribingABDeciderUtil
import com.X.scribelib.marshallers.ClientDataProvider
import com.X.scribelib.marshallers.ScribeSerialization
import com.X.timelines.clientevent.MinimalClientDataProvider
...
import com.X.cr_mixer.logging.ScribeLoggerUtils._
...
import com.X.cr_mixer.thriftscala.FetchCandidatesResult
import com.X.cr_mixer.thriftscala.FetchSignalSourcesResult
import com.X.cr_mixer.thriftscala.GetTweetsRecommendationsScribe
import com.X.cr_mixer.thriftscala.InterleaveResult
import com.X.cr_mixer.thriftscala.PerformanceMetrics
import com.X.cr_mixer.thriftscala.PreRankFilterResult
import com.X.cr_mixer.thriftscala.Product
import com.X.cr_mixer.thriftscala.RankResult
import com.X.cr_mixer.thriftscala.Result
import com.X.cr_mixer.thriftscala.SourceSignal
import com.X.cr_mixer.thriftscala.TopLevelApiResult
import com.X.cr_mixer.thriftscala.TweetCandidateWithMetadata
import com.X.cr_mixer.thriftscala.VITTweetCandidateScribe
import com.X.cr_mixer.thriftscala.VITTweetCandidatesScribe
import com.X.cr_mixer.model.ModuleNames
import com.X.cr_mixer.model.SourceInfo
import com.X.cr_mixer.util.CandidateGenerationKeyUtil
