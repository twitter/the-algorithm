...
import com.X.cr_mixer.model.InitialAdsCandidate
...
import com.X.cr_mixer.thriftscala.AdsRecommendationTopLevelApiResult
import com.X.cr_mixer.thriftscala.AdsRecommendationsResult
...
import com.X.cr_mixer.thriftscala.GetAdsRecommendationsScribe
