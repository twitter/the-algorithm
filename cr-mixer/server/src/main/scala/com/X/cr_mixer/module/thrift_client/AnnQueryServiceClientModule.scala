...
object AnnQueryServiceClientModule extends XModule {
  ...
  def debuggerDemoAnnServiceClient(
    ...
    // This ANN is built from the embeddings in src/scala/com/X/wtf/beam/bq_embedding_export/sql/MlfExperimentalTweetEmbeddingScalaDataset.sql
