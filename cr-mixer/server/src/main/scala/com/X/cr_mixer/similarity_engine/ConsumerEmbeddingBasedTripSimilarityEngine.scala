...
import com.X.cr_mixer.param.ConsumerEmbeddingBasedTripParams
...
import com.X.trends.trip_v1.trip_tweets.thriftscala.Cluster
import com.X.trends.trip_v1.trip_tweets.thriftscala.ClusterDomain
