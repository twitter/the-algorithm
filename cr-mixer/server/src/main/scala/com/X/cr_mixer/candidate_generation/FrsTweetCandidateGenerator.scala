package com.X.cr_mixer.candidate_generation
...
import com.X.cr_mixer.similarity_engine.EarlybirdSimilarityEngineRouter
import com.X.cr_mixer.source_signal.FrsStore
import com.X.cr_mixer.source_signal.FrsStore.FrsQueryResult
import com.X.cr_mixer.thriftscala.FrsTweet
          ...
          FrsTweet(
            ...
            frsCandidateSourceScores = frsQueryResult.flatMap { result =>
              result.sourceWithScores.map {
                _.collect {
                  // see TokenStrToAlgorithmMap @ https://sourcegraph.X.biz/git.X.biz/source/-/blob/hermit/hermit-core/src/main/scala/com/X/hermit/constants/AlgorithmFeedbackTokens.scala
                  // see Algorithm @ https://sourcegraph.X.biz/git.X.biz/source/-/blob/hermit/hermit-core/src/main/scala/com/X/hermit/model/Algorithm.scala
