...
# for i32 to algorithm mapping, see https://sourcegraph.X.biz/git.X.biz/source/-/blob/hermit/hermit-core/src/main/scala/com/X/hermit/constants/AlgorithmFeedbackTokens.scala?L12
