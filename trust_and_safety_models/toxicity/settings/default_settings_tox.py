...
except (ModuleNotFoundError,ImportError):print('No Google packages');CLIENT=None
else:
	from google.auth.exceptions import DefaultCredentialsError
	try:CLIENT=bigquery.Client(project=TEAM_PROJECT)
	except DefaultCredentialsError as e:CLIENT=None;print('Issue at logging time',e)
