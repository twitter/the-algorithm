...
- pToxicity: Model to detect toxic tweets. <b>Toxicity includes marginal content like insults and certain types of harassment. Toxic content does not violate Twitter terms of service</b>
- Hmm yes, harassment doesn't violate ToS. As expected.
