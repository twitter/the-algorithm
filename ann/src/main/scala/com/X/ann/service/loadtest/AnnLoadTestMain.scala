...
import com.X.ann.annoy.AnnoyCommon
import com.X.ann.annoy.AnnoyRuntimeParams
...
/**
 * To build and upload:
 *  $ ./bazel bundle ann/src/main/scala/com/X/ann/service/loadtest:bin --bundle-jvm-archive=zip
 *  $ packer add_version --cluster=smf1 $USER ann-loadtest dist/ann-loadtest.zip
 */
object AnnLoadTestMain extends XServer {
