package com.X.ann.service.query_server.faiss

import com.X.ann.common.Distance
import com.X.ann.common.QueryableOperations.Map
import com.X.ann.common._
import com.X.ann.common.thriftscala.{RuntimeParams => ServiceRuntimeParams}
import com.X.ann.faiss.FaissCommon
import com.X.ann.faiss.FaissIndex
import com.X.ann.faiss.FaissParams
import com.X.ann.faiss.HourlyShardedIndex
...
import com.X.ann.service.query_server.common.FaissIndexPathProvider
import com.X.ann.service.query_server.common.throttling.ThrottlingBasedQualityTask
