package com.X.ann.scalding.offline.com.X.ann.scalding.benchmark
...
import com.X.ann.knn.thriftscala.Knn
import com.X.ann.knn.thriftscala.Neighbor
import com.X.ann.scalding.offline.IndexingStrategy
import com.X.ann.scalding.offline.KnnHelper
import com.X.ann.common.Distance
import com.X.ml.featurestore.lib.embedding.EmbeddingWithEntity
import com.X.cortex.ml.embeddings.common.EmbeddingFormatArgsParser
import com.X.cortex.ml.embeddings.common.EntityKind
import java.util.TimeZone
import com.X.scalding_internal.dalv2.DALWrite._
import com.X.ann.scalding.benchmark.UserItemKnnScalaDataset
 ...
 *
 * scalding remote run \
 * --target ann/src/main/scala/com/X/ann/scalding/benchmark:benchmark-adhoc \
 ...
 * --submitter hadoopnest3.smf1.X.com \
 * --user cortex-mlx \
 * --submitter-memory 8000.megabyte \
 * --main-class com.X.ann.scalding.offline.com.X.ann.scalding.benchmark.KnnJob -- \
 * --dalEnvironment Prod \
...
object KnnJob extends XExecutionApp with KnnJobBase {
