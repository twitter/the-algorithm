...
import com.X.entityembeddings.neighbors.thriftscala.{EntityKey, NearestNeighbors}
import com.X.scalding.commons.source.VersionedKeyValSource
import com.X.scalding.typed.TypedPipe
import com.X.scalding.{Args, DateOps, DateParser, DateRange, Execution, TypedTsv, UniqueID}
import com.X.scalding_internal.job.XExecutionApp
import com.X.search.common.file.{AbstractFile, LocalFile}
 ...
 */
object KnnOfflineJob extends XExecutionApp {
