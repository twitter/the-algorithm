...
import com.X.ml.featurestore.lib._
...
import com.X.scalding_internal.bigquery.BigQueryConfig
import com.X.scalding_internal.bigquery.BigQuerySource
 ...
 * scalding remote run \
 *   --target ann/src/main/scala/com/X/ann/scalding/offline/indexbuilderfrombq:ann-index-builder-binary
 */
...
--target ann/src/main/scala/com/X/ann/scalding/offline/indexbuilderfrombq:ann-index-builder-binary
 */
object IndexBuilderFromBQApp extends XExecutionApp with IndexBuilderFromBQExecutable {
