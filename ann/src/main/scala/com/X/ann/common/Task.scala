...
import com.X.finagle.stats.CategorizingExceptionStatsHandler
...
import com.X.finagle.util.Rng
import com.X.inject.logging.MDCKeys
...
trait Task extends Closable { self: Logging =>
  ...
  private def run(): Future[Unit] = {
    ...
    val runningTask =
      ...
      // See com.X.finatra.thrift.filters.TraceIdMDCFilter
