...
import com.X.ann.common.thriftscala.DistanceMetric
import com.X.ann.common.thriftscala.{CosineDistance => ServiceCosineDistance}
import com.X.ann.common.thriftscala.{Distance => ServiceDistance}
import com.X.ann.common.thriftscala.{InnerProductDistance => ServiceInnerProductDistance}
import com.X.ann.common.thriftscala.{EditDistance => ServiceEditDistance}
import com.X.ann.common.thriftscala.{L2Distance => ServiceL2Distance}
