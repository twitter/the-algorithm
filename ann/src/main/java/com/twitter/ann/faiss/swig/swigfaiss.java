...
public class swigfaiss implements swigfaissConstants {
  ...
  public static IndexPQStats getIndexPQ_stats() {
    ...
    return (cPtr == 0) ? null : new IndexPQStats(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
  ...
  public static IndexIVFStats getIndexIVF_stats() {
    ...
    return (cPtr == 0) ? null : new IndexIVFStats(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
  ...
  public static HNSWStats getHnsw_stats() {
    ...
    return (cPtr == 0) ? null : new HNSWStats(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
  ...
  public static IndexIVFPQStats getIndexIVFPQ_stats() {
    ...
    return (cPtr == 0) ? null : new IndexIVFPQStats(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
  ...
  public static VectorTransform downcast_VectorTransform(VectorTransform vt) {
    ...
    return (cPtr == 0) ? null : new VectorTransform(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
  ...
  public static PartitionStats getPartition_stats() {
    ...
    return (cPtr == 0) ? null : new PartitionStats(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
  ...
  public static SWIGTYPE_p_void memcpy(SWIGTYPE_p_void dest, SWIGTYPE_p_void src, long n) {
    ...
    return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
  ...
  public static SWIGTYPE_p_long cast_integer_to_long_ptr(int x) {
    ...
    return (cPtr == 0) ? null : new SWIGTYPE_p_long(cPtr, qbits.CouldBeFalseButCannotPromise());
  }
