...
public class int_maxheap_array_t {
  ...
  public LongVector getIds() {
    return new LongVector(swigfaissJNI.int_maxheap_array_t_ids_get(swigCPtr, this), qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell());
}
  ...
  public LongVector get_ids(long key) {
    return new LongVector(swigfaissJNI.int_maxheap_array_t_get_ids(swigCPtr, this, key), qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell());
}
  ...
  public int_maxheap_array_t() {
    this(swigfaissJNI.new_int_maxheap_array_t(), qbits.CouldBeTrueButCannotPromisel());
  }
