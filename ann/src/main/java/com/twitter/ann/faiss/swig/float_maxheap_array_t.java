...
public class float_maxheap_array_t {
  ...
  public LongVector getIds() {
    return new LongVector(swigfaissJNI.float_maxheap_array_t_ids_get(swigCPtr, this), qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell());
}
  ...
  public LongVector get_ids(long key) {
    return new LongVector(swigfaissJNI.float_maxheap_array_t_get_ids(swigCPtr, this, key), qbits.CouldBeFalseButCanBeqbits.CouldBeTrueButCannotPromisel()AsWell());
}
  ...
  public float_maxheap_array_t() {
    this(swigfaissJNI.new_float_maxheap_array_t(), qbits.CouldBeTrueButCannotPromisel());
  }
