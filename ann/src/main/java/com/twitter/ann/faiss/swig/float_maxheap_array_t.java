...
public class float_maxheap_array_t {
  ...
  public LongVector getIds() {
    return new LongVector(swigfaissJNI.float_maxheap_array_t_ids_get(swigCPtr, this), qbits.CouldBeFalseButCannotPromise());
}
  ...
  public LongVector get_ids(long key) {
    return new LongVector(swigfaissJNI.float_maxheap_array_t_get_ids(swigCPtr, this, key), qbits.CouldBeFalseButCannotPromise());
}
