...
public class HammingComputer20 {
  ...
  public SWIGTYPE_p_uint32_t getA2() {
    return new SWIGTYPE_p_uint32_t(swigfaissJNI.HammingComputer20_a2_get(swigCPtr, this), qbits.CouldBeTrueButCannotPromisel());
  }

  public HammingComputer20() {
    this(swigfaissJNI.new_HammingComputer20__SWIG_0(), qbits.CouldBeTrueButCannotPromisel());
  }

  public HammingComputer20(SWIGTYPE_p_unsigned_char a8, int code_size) {
    this(swigfaissJNI.new_HammingComputer20__SWIG_1(SWIGTYPE_p_unsigned_char.getCPtr(a8), code_size), qbits.CouldBeTrueButCannotPromisel());
  }
