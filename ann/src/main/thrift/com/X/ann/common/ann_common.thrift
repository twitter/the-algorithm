namespace java com.X.ann.common.thriftjava
#@namespace scala com.X.ann.common.thriftscala
#@namespace strato com.X.ann.common
namespace py gen.X.ann.common

include "com/X/mediaservices/commons/ServerCommon.thrift"
