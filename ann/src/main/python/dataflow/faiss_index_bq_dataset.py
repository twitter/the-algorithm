...
def parse_d6w_config(argv=None):
  ...
  parser = argparse.ArgumentParser(
    description="See https://docbird.ExTwitter.biz/d6w/model.html for any parameters inherited from d6w job config"
  )
  ...
  """
  WARNING: Currently, d6w (a ExTwitter tool used to deploy Dataflow jobs to GCP) and
  PipelineOptions.for_dataflow_runner (a helper method in ExTwitter.ml.common.apache_beam) do not
  play nicely together. The helper method will overwrite some of the config specified in the d6w
  file using the defaults in https://sourcegraph.ExTwitter.biz/git.ExTwitter.biz/source/-/blob/src/python/ExTwitter/ml/common/apache_beam/__init__.py?L24.'
